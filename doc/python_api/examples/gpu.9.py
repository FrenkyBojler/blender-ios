...
def draw():
    ...
    # Note: is_scene_linear must be set to False because do_color_management is True.
    draw_texture_2d(offscreen.texture_color, (10, 10), WIDTH, HEIGHT, is_scene_linear=False)

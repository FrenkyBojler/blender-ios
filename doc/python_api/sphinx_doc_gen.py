...
def write_rst_data(basepath):
    ...
    with open(filepath, "w", encoding="utf-8") as fh:
        ...
        fw(".. module:: bpy.data\n")
        fw("\n")
        fw("This module is used to store/access data from the currently loaded blend file. ")
        fw("Use Blender/Python to access data such as objects, scenes, meshes.\n")
        fw("For more information on using ``bpy.data`` see the quick-start section on\n")
        fw(":ref:`info_quickstart-data_access`.\n")
        fw("\n")
        fw(".. data:: data\n")
        fw("\n")

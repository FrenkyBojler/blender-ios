...
if(DEFINED WITH_RUBBERBAND AND WITH_RUBBERBAND) # "Build With Rubber Band Library"
  set(RUBBERBAND_FOUND TRUE)
  set(WITH_RUBBERBAND ${WITH_RUBBERBAND})
  set(RUBBERBAND_INCLUDE_DIR ${RUBBERBAND_INCLUDE_DIRS})
  set(RUBBER_LIBRARY ${RUBBERBAND_LIBRARIES})
endif()

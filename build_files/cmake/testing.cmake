...
function(blender_test_set_envvars testname envvar_list)
  ...
  if(NOT CMAKE_BUILD_TYPE MATCHES "Release")
    if(WITH_COMPILER_ASAN)
      ...
      #~ set(_ubsan_options "UBSAN_OPTIONS=print_suppressions=false:suppressions=${CMAKE_SOURCE_DIR}/tools/config/analysis/ubsan.supp")
      ...
      #~ if(DEFINED ENV{UBSAN_OPTIONS})
        #~ set(_ubsan_options "${_ubsan_options}:$ENV{UBSAN_OPTIONS}")
      #~ endif()
      #~ list(APPEND envvar_list "${_lsan_options}" "${_asan_options}" "${_ubsan_options}")

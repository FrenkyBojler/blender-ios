...
#ifdef USE_NON_LATIN_KB_WORKAROUND
/**
 * Pick a fall-back layout for resolving physical key positions when the active layout
 * produces a key-symbol not recognized by #xkb_map_gkey (e.g. Cyrillic), see: #120892.
...
/**
 * Return `sym`, or a known #GHOST_TKey key-symbol from `layout_fallback` if `sym` itself is
 * not recognized, see: #120892.
 */

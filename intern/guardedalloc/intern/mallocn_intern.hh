...
void MEM_lockfree_freeN(void *vmemh, bool allow_non_trivial);
...
void *MEM_lockfree_mallocN_aligned(size_t len,
                                   size_t alignment,
                                   const char *str,
                                   mem_guarded::internal::TypeInMemory type_in_memory)
...
void MEM_guarded_freeN(void *vmemh, bool allow_non_trivial);

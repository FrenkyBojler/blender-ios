 ...
 * memory is then enclosed by pads, to detect out-of-bound writes. All blocks are placed in a
 * linked list, so they remain reachable at all times. There is no back-up in case the
 * linked-list related data is lost.
 *

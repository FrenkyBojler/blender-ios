...
struct LightSample {
  ...
  int object;              /* object id for lights and triangle/curve emitters. */
  int prim;                /* primitive id for lights and triangle/curve emitters. */
  int shader_id_and_flags; /* shader id */

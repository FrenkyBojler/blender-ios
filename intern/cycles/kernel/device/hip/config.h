...
/* Workaround for SDK 6.3.42560 - 881c2d702 compiler bug on RDNA4
 * Issue #138656 */

#if (CCL_HIP_AMD_GFX_ARCH == 1200) || (CCL_HIP_AMD_GFX_ARCH == 1201)
#  define GPU_HIPRT_KERNEL_BLOCK_NUM_THREADS_SHADE_SURFACE 256
#else

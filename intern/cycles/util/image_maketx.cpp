...
{
  /* TODO: If auto logic changes the tx should be invalidated. But solving this would
   * require always reading the original file. Can this be addressed somehow? */
  switch (alpha_type) {
                                      ...
                                      const bool absolute_texture_cache)
{
  ...
  /* Colorspace. */
  /* TODO: How to handle auto best? Note in Blender this only happens for OSL,
   * with regular images there is always a specific colorspace specified. */

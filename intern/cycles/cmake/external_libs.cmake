...
if(WITH_CYCLES_DEVICE_ONEAPI AND WITH_CYCLES_ONEAPI_BINARIES)
  ...
  elseif (NOT EXISTS ${_ocloc_binary_full_filepath})
    ...
    if(WIN32)
      set(_ocloc_test_command ${_ocloc_binary_full_filepath} --help)
    else()
      set(_ocloc_ld_library_path "${OCLOC_INSTALL_DIR}/lib")
      set(_ocloc_test_command
        ${CMAKE_COMMAND} -E env "LD_LIBRARY_PATH=${_ocloc_ld_library_path}"
        ${_ocloc_binary_full_filepath} --help
      )
    endif()

    execute_process(
      COMMAND ${_ocloc_test_command}
      RESULT_VARIABLE _ocloc_retcode
      OUTPUT_QUIET
      ERROR_QUIET
    )
    unset(_ocloc_test_command)

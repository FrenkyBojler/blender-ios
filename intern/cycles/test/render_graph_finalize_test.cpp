...
{
  EXPECT_ANY_MESSAGE(log);
  CORRECT_INFO_MESSAGE(log, "Volume attribute node Attribute uses stochastic sampling");
...
{
  EXPECT_ANY_MESSAGE(log);
  INVALID_INFO_MESSAGE(log, "Volume attribute node Attribute uses stochastic sampling");

...
TEST(KernelCamera, calibrated_cam_vs_reference_projections)
{
  ...
  std::pair<float2, float4> reference_data[]{
      {make_float2(0.544857f, 0.457416f), make_float4(0.981022f, -0.142974f, -0.130976f, 0.195134f)},
      {make_float2(0.491441f, 0.580892f), make_float4(0.962164f, 0.023821f, 0.271428f, 0.275961f)},
      {make_float2(0.430290f, 0.409030f), make_float4(0.943426f, 0.201748f, -0.263145f, 0.337981f)},
      {make_float2(0.609617f, 0.516467f), make_float4(0.924807f, -0.374620f, 0.066265f, 0.390268f)},
      {make_float2(0.383539f, 0.567937f), make_float4(0.906308f, 0.356586f, 0.226831f, 0.436332f)},
      {make_float2(0.536058f, 0.347188f), make_float4(0.887927f, -0.119414f, -0.444214f, 0.477978f)},
      {make_float2(0.561047f, 0.620046f), make_float4(0.869664f, -0.227524f, 0.438084f, 0.516275f)},
      {make_float2(0.326487f, 0.431959f), make_float4(0.851519f, 0.492509f, -0.179864f, 0.551922f)},
      {make_float2(0.652088f, 0.427871f), make_float4(0.833490f, -0.510732f, -0.210823f, 0.585401f)},
      {make_float2(0.420486f, 0.649567f), make_float4(0.815579f, 0.245257f, 0.524099f, 0.617067f)},
      {make_float2(0.430310f, 0.289524f), make_float4(0.797784f, 0.180451f, -0.575307f, 0.647185f)},
      {make_float2(0.646058f, 0.579396f), make_float4(0.780105f, -0.541318f, 0.313705f, 0.675963f)},
      {make_float2(0.282058f, 0.536444f), make_float4(0.762541f, 0.631851f, 0.138911f, 0.703565f)},
      {make_float2(0.618735f, 0.309560f), make_float4(0.745092f, -0.383589f, -0.545616f, 0.730124f)},
      {make_float2(0.516595f, 0.680370f), make_float4(0.727758f, -0.088137f, 0.680148f, 0.755750f)},
      {make_float2(0.298195f, 0.325499f), make_float4(0.710537f, 0.538053f, -0.453471f, 0.780535f)},
      {make_float2(0.701941f, 0.478984f), make_float4(0.693430f, -0.719908f, -0.029770f, 0.804557f)},
      {make_float2(0.327821f, 0.649062f), make_float4(0.676437f, 0.522053f, 0.519513f, 0.827882f)},
      {make_float2(0.502392f, 0.221553f), make_float4(0.659556f, -0.034720f, -0.750853f, 0.850568f)},
      {make_float2(0.623151f, 0.645919f), make_float4(0.642788f, -0.490812f, 0.588156f, 0.872665f)},
  };
  // clang-format on

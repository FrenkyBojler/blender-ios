...
class Camera : public Node {
 public:
  ...
  NODE_SOCKET_API(float, calibrated_cam_k2)
  NODE_SOCKET_API(float, calibrated_cam_k3)
  NODE_SOCKET_API(float, calibrated_cam_k4)
  NODE_SOCKET_API(float, calibrated_cam_k5)
  NODE_SOCKET_API(float, calibrated_cam_p0)
  NODE_SOCKET_API(float, calibrated_cam_p1)
  NODE_SOCKET_API(float, calibrated_cam_s0)
  NODE_SOCKET_API(float, calibrated_cam_s1)
  NODE_SOCKET_API(float, calibrated_cam_s2)
  NODE_SOCKET_API(float, calibrated_cam_s3)
  NODE_SOCKET_API(float, calibrated_cam_nc0)

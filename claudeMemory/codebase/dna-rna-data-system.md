...
- `PropertyRNA` (line 390) — identifier, flags, type, and (for DNA-backed
...
- `StructRNA` (line 663) — the struct-level descriptor (name, properties,
  functions, base type for inheritance).

### The code generator

`makesrna.cc` (`main()` at `source/blender/makesrna/intern/makesrna.cc:4380`)
...
| `PropertyRNA` struct | `source/blender/makesrna/intern/rna_internal_types.hh` | 390 |
| `StructRNA` struct | `source/blender/makesrna/intern/rna_internal_types.hh` | 663 |
| makesrna `main()` | `source/blender/makesrna/intern/makesrna.cc` | 4380 |

...
class InfoPropertyRNA:
    __slots__ = (
        ...
        "is_path_supports_variable_expressions",
    )
    global_lookup = {}
    ...
    def build(self):
        ...
        self.is_path_supports_variable_expressions = rna_prop.is_path_supports_variable_expressions
    ...
    def get_type_description(
        ...
        if self.is_path_supports_variable_expressions:

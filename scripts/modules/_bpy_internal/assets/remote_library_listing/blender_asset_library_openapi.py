...
OPENAPI_SPEC = {'openapi': '3.0.0',
                'info': {'version': '1.0.0',
                         ...
                         'contact': {'name': 'Blender',
                                     'url': 'https://www.blender.org/'},
                         'license': {'name': 'GPLv3',
                                     'url': 'https://www.gnu.org/licenses/gpl-3.0.en.html'}},
                'servers': [{'url': '/'}],
                'paths': {'/_asset-library-meta.json': {'summary': 'Meta-information about this asset library.',
                                                        'get': {'summary': 'Retrieve the asset library meta info.',
                                                                'operationId': 'getLibraryMeta',
                                                                'tags': ['meta'],
                                                                'responses': {'200': {'description': 'normal response',
                                                                                      'content': {'application/json': {'schema': {'$ref': '#/components/schemas/AssetLibraryMeta'}}}}}}},
                          '/_v1/asset-index.json': {'summary': 'The index of the asset library, containing the metadata of all available assets.',
                                                    'get': {'summary': 'Get the asset library index.',
                                                            'operationId': 'getLibraryIndex',
                                                            'tags': ['index'],
                                                            'responses': {'200': {'description': 'normal response',
                                                                                  'content': {'application/json': {'schema': {'$ref': '#/components/schemas/AssetLibraryIndexV1'}}}}}}},
                          '/_v1/assets-{page}.json': {'summary': 'The index of the asset library, containing the metadata of all available assets. Note that the actual URLs of these pages are listed in the `asset-index.json` above. The path specified here is merely a suggestion.\n',
                                                      'get': {'summary': 'Get the asset library index.',
                                                              ...
                                                              'parameters': [{'name': 'page',
                                                                              ...
                                                                              'schema': {'type': 'integer'}}],
                                                              'responses': {'200': {'description': 'normal response',
                                                                                    'content': {'application/json': {'schema': {'$ref': '#/components/schemas/AssetLibraryIndexPageV1'}}}}}}}},
                'tags': [{'name': 'meta',
                          'description': 'Info about the asset library itself.'},
                         {'name': 'index',
                          'description': "Access to the asset library's list of assets."}],
                'components': {'schemas': {'AssetLibraryMeta': {'type': 'object',
                                                                'description': 'Meta-data of this asset library.',
                                                                'properties': {'api_versions': {'type': 'object',
                                                                ...
                                                                'required': ['api_versions',
                                                                             'name',
                                                                             'contact'],
                                                                'example': {'api_versions': {'v1': '_v1/asset-index.json'},
                                           ...
                                           'Contact': {'type': 'object',
                                                       ...
                                                       'properties': {'name': {'type': 'string'},
                                                                      ...
                                                                      'email': {'type': 'string'}},
                                                       'required': ['name']},
                                           'AssetLibraryIndexV1': {'type': 'object',
                                                                   ...
                                                                   'required': ['schema_version',
                                                                                ...
                                                                                'asset_count',
                                                                                'file_count']},
                                           'AssetLibraryIndexPageV1': {'type': 'object',
                                                                       'description': 'Any number of assets.',
                                                                       'properties': {'asset_count': {'type': 'integer',
                                           ...
                                           'CustomPropertyV1': {'type': 'object',
                                                                ...
                                                                'properties': {'type': {'$ref': '#/components/schemas/CustomPropertyTypeV1'},
                                                                               ...
                                                                               'value': {'oneOf': [{'$ref': '#/components/schemas/CustomPropertiesV1'},
                                                                                                   {'type': 'array'},
                                                                                                   {'type': 'number'},
                                                                                                   {'type': 'integer'},
                                                                                                   {'type': 'string'},
                                                                ...
                                                                'required': ['type',
                                                                             'value']},
                                           'CustomPropertyTypeV1': {'type': 'string',
                                                                    'description': 'Type of IDProperty without the `IDP_` prefix, see `eIDPropertyType` in `DNA_ID_enumms.h`. For now, type `ID` and `IDPARRAY` are not supported.\n',
                                                                    'enum': ['STRING',
                                                                             'INT',
                                                                             'FLOAT',
                                                                             'ARRAY',

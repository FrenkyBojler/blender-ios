...
OPENAPI_SPEC = {'openapi': '3.0.0',
                ...
                'paths': {'/_asset-library-meta.json': {'summary': 'Meta-information about this asset library.',
                                                        'get': {'summary': 'Retrieve the asset library meta info.',
                                                                ...
                                                                'tags': ['meta'],
                                                                'parameters': [{'name': 'blender_version',
                                                                                'in': 'query',
                                                                                'description': "Blender version in 'X.Y.Z' notation.",
                                                                                'schema': {'type': 'string'}},
                                                                               {'name': 'platform',
                                                                                'in': 'query',
                                                                                'description': "Combination of OS and architecture, like 'linux-x64' or 'macos-arm64'",
                                                                                'schema': {'type': 'string'}}],

...
def register():
    ...
    bpy.types.NODE_MT_shader_input.prepend(attr_nodes_menu_func)
    bpy.types.NODE_PT_backdrop.append(bgreset_menu_func)
    bpy.types.NODE_PT_active_node_generic.append(save_viewer_menu_func)
    bpy.types.NODE_MT_shader_texture.prepend(multipleimages_menu_func)
    bpy.types.NODE_MT_compositor_input.prepend(multipleimages_menu_func)
...
def unregister():
    ...
    bpy.types.NODE_MT_shader_input.remove(attr_nodes_menu_func)
    bpy.types.NODE_PT_backdrop.remove(bgreset_menu_func)
    bpy.types.NODE_PT_active_node_generic.remove(save_viewer_menu_func)
    bpy.types.NODE_MT_shader_texture.remove(multipleimages_menu_func)
    bpy.types.NODE_MT_compositor_input.remove(multipleimages_menu_func)

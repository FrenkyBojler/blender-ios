...
def get_extension_repo_filter_items(self, context):
    ...
    repo_enum = []
    repo_enum.insert(0, ('_ALL_', "All Repositories", "Show extensions from all repositories"))
    for repo in repos:
...
def register():
    ...
    WindowManager.extension_tag_repo_filter_enabled = BoolProperty(
...
def unregister():
    ...
    del WindowManager.extension_tag_repo_filter_enabled

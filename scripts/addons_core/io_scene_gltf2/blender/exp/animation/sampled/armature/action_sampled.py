...
def gather_action_armature_sampled(armature_uuid: str,
    ...
    export_user_extensions('pre_gather_animation_hook', export_settings, animation, blender_action, slot_handle, blender_object)
    ...
    export_user_extensions('animation_action_armature_sampled', export_settings,
                           animation, blender_object, blender_action, slot_handle, cache_key)

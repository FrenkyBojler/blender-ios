...
def export_clearcoat(bmat, export_settings):
    ...
    clearcoat_socket = get_socket(bmat.inline_material.node_tree, 'Coat Weight')
    clearcoat_roughness_socket = get_socket(bmat.inline_material.node_tree, 'Coat Roughness')
    clearcoat_normal_socket = get_socket(bmat.inline_material.node_tree, 'Coat Normal')

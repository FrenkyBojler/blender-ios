...
def export_specular(bmat, export_settings):
    ...
    specular_socket = get_socket(bmat.inline_material.node_tree, 'Specular IOR Level')
    speculartint_socket = get_socket(bmat.inline_material.node_tree, 'Specular Tint')

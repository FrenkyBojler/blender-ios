...
def export_sheen(bmat, export_settings):
    ...
    sheenTint_socket = get_socket(bmat.inline_material.node_tree, "Sheen Tint")
    sheenRoughness_socket = get_socket(bmat.inline_material.node_tree, "Sheen Roughness")
    sheen_socket = get_socket(bmat.inline_material.node_tree, "Sheen Weight")

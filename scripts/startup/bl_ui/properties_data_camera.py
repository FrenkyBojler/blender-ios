    ...
    def draw(self, context):
        ...
        if cam.type == 'PERSP':
            ...
            if engine == 'CYCLES':
                ...
                col.prop(cam, "calibrated_cam_p0", text="Tangential p0")
                col.prop(cam, "calibrated_cam_p1", text="p1")
                col.prop(cam, "calibrated_cam_s0", text="Thin prism s0")
                col.prop(cam, "calibrated_cam_s1", text="s1")
                col.prop(cam, "calibrated_cam_s2", text="s2")
                col.prop(cam, "calibrated_cam_s3", text="s3")
                col.prop(cam, "calibrated_cam_nc0", text="Noncentrality nc0")

    ...
    def draw(self, context):
        ...
        if cam.type == 'PERSP':
            ...
            if engine == 'CYCLES':
                ...
                sub = col.column(align=True)
                sub.prop(cam, "calibrated_cam_k0", text="Radial k0")
                sub.prop(cam, "calibrated_cam_k1", text="k1")
                sub.prop(cam, "calibrated_cam_k2", text="k2")
                sub.prop(cam, "calibrated_cam_k3", text="k3")
                sub.prop(cam, "calibrated_cam_k4", text="k4")
                sub.prop(cam, "calibrated_cam_k5", text="k5")
                sub = col.column(align=True)
                sub.prop(cam, "calibrated_cam_p0", text="Tangential p0")
                sub.prop(cam, "calibrated_cam_p1", text="p1")
                sub = col.column(align=True)
                sub.prop(cam, "calibrated_cam_s0", text="Thin prism s0")
                sub.prop(cam, "calibrated_cam_s1", text="s1")
                sub.prop(cam, "calibrated_cam_s2", text="s2")
                sub.prop(cam, "calibrated_cam_s3", text="s3")
                sub = col.column(align=True)
                sub.prop(cam, "calibrated_cam_nc0", text="Noncentrality nc0")
                sub.prop(cam, "calibrated_cam_nc1", text="nc1")
                sub.prop(cam, "calibrated_cam_nc2", text="nc2")
                sub.prop(cam, "calibrated_cam_nc3", text="nc3")

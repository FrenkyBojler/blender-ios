...
class GREASE_PENCIL_MT_grease_pencil_add_layer_extra(Menu):
    ...
    def draw(self, context):
        ...
        layout.separator()
        layout.operator("grease_pencil.relative_layer_mask_add", text="Mask with above layer").mode = 'ABOVE'
        layout.operator("grease_pencil.relative_layer_mask_add", text="Mask with below layer").mode = 'BELOW'

...
class NODE_MT_gn_utilities_math_base(node_add_menu.NodeMenu):
    ...
    def draw(self, context):
        ...
        self.node_operator_with_searchable_enum_filtered(context, layout, "FunctionNodeCompare", "operation", {"BRIGHTER", "DARKER"})
        ...
        self.node_operator_with_searchable_enum_filtered(context, layout, "ShaderNodeMath", "operation", {"GREATER_THAN", "LESS_THAN"})

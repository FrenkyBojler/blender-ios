...
class NODE_MT_category_shader_input(Menu):
    ...
    def draw(self, context):
        ...
        node_add_menu.add_node_type_with_subnames(
        ...
        node_add_menu.add_node_type_with_subnames(context,
                                                  layout,
        ...
        node_add_menu.add_node_type_with_subnames(context, layout, "ShaderNodeVolumeInfo",

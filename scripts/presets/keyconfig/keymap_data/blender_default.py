...
def km_uv_editor(params):
    ...
    items.extend([
        ...
        *_template_items_hide_reveal_actions("uv.hide", "uv.reveal"),
        ...
        ("uv.shift_selected", {"type": 'NUMPAD_8', "value": 'PRESS'},
         {"properties": [("axis", 'Y'), ("type", 'DYNAMIC'), ("distance", 1)]}),
        ("uv.shift_selected", {"type": 'NUMPAD_2', "value": 'PRESS'},
         {"properties": [("axis", 'Y'), ("type", 'DYNAMIC'), ("distance", -1)]}),
        ("uv.shift_selected", {"type": 'NUMPAD_6', "value": 'PRESS'},
         {"properties": [("axis", 'X'), ("type", 'DYNAMIC'), ("distance", 1)]}),
        ("uv.shift_selected", {"type": 'NUMPAD_4', "value": 'PRESS'},
         {"properties": [("axis", 'X'), ("type", 'DYNAMIC'), ("distance", -1)]}),
        ("uv.shift_selected", {"type": 'NUMPAD_8', "value": 'PRESS', "shift": True},
         {"properties": [("axis", 'Y'), ("type", 'PIXEL'), ("distance", 1)]}),
        ("uv.shift_selected", {"type": 'NUMPAD_2', "value": 'PRESS', "shift": True},
         {"properties": [("axis", 'Y'), ("type", 'PIXEL'), ("distance", -1)]}),
        ("uv.shift_selected", {"type": 'NUMPAD_6', "value": 'PRESS', "shift": True},
         {"properties": [("axis", 'X'), ("type", 'PIXEL'), ("distance", 1)]}),
        ("uv.shift_selected", {"type": 'NUMPAD_4', "value": 'PRESS', "shift": True},
         {"properties": [("axis", 'X'), ("type", 'PIXEL'), ("distance", -1)]}),
        ("uv.shift_selected", {"type": 'NUMPAD_8', "value": 'PRESS', "ctrl": True},
         {"properties": [("axis", 'Y'), ("type", 'UDIM'), ("distance", 1)]}),
        ("uv.shift_selected", {"type": 'NUMPAD_2', "value": 'PRESS', "ctrl": True},
         {"properties": [("axis", 'Y'), ("type", 'UDIM'), ("distance", -1)]}),
        ("uv.shift_selected", {"type": 'NUMPAD_6', "value": 'PRESS', "ctrl": True},
         {"properties": [("axis", 'X'), ("type", 'UDIM'), ("distance", 1)]}),
        ("uv.shift_selected", {"type": 'NUMPAD_4', "value": 'PRESS', "ctrl": True},
         {"properties": [("axis", 'X'), ("type", 'UDIM'), ("distance", -1)]}),

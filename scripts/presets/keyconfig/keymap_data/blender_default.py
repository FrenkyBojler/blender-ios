...
def km_view3d(params):
    ...
    items.extend([
        ...
        *([(
        ...
        ("view3d.gamepad_all", {"type": 'GAMEPAD_RIGHT_THUMB', "value": 'ANY'}, None),
        ("view3d.gamepad_all", {"type": 'GAMEPAD_LEFT_TRIGGER', "value": 'ANY'}, None),
        ("view3d.gamepad_all", {"type": 'GAMEPAD_RIGHT_TRIGGER', "value": 'ANY'}, None),
        ("view3d.gamepad_all", {"type": 'GAMEPAD_BUTTON_DPAD_UP', "value": 'ANY', "repeat": True}, None),
        ("view3d.gamepad_all", {"type": 'GAMEPAD_BUTTON_DPAD_DOWN', "value": 'ANY', "repeat": True}, None),
        ("view3d.gamepad_all", {"type": 'GAMEPAD_BUTTON_DPAD_LEFT', "value": 'ANY', "repeat": True}, None),
        ("view3d.gamepad_all", {"type": 'GAMEPAD_BUTTON_DPAD_RIGHT', "value": 'ANY', "repeat": True}, None),

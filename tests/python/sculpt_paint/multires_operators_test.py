...
class Unsubdivide(unittest.TestCase):
    ...
    def test_reshape_cube_to_sphere(self):
        ...
        # Build the reshape source by duplicating the cube and spherifying it.
        ...
        source_mod_name = ob_src.modifiers[0].name
        ob_src.modifiers[source_mod_name].levels = ob_src.modifiers[source_mod_name].total_levels
        bpy.ops.object.modifier_apply(modifier=source_mod_name)
        ...
        # Reshape projects the cube's multi-resolution top level onto the spherified source.

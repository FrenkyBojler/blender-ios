...
class ConvertRotationMode(unittest.TestCase):
    ...
    def _assert_almost_equal_rotation(self, a: mathutils.Matrix, b: mathutils.Matrix):
        equal = True
        for j in range(3):
            for i in range(3):
    ...
    def _assert_almost_equal_euler(self, a: mathutils.Euler, b: mathutils.Euler):
        self.assertAlmostEqual(a.x, b.x, 2, f"{a} - {b}")
        self.assertAlmostEqual(a.y, b.y, 2, f"{a} - {b}")
        self.assertAlmostEqual(a.z, b.z, 2, f"{a} - {b}")
    ...
    def test_convert_unkeyed_rotation(self):
        ...
        self._assert_almost_equal_rotation(matrix_before, matrix_after)
        self.assertFalse(
            _action_slot_has_rna_path(
                self.action,
                self.action_slot,

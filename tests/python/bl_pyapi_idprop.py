...
class TestIdPropertyDynamicRNA(TestHelper, unittest.TestCase):
    ...
    def test_dynamic_rna_basics(self):
        ...
        self.assertTrue('dynrna_prop' in self.id.bl_system_properties)
        ...
        self.assertTrue(len(self.id.bl_system_properties['dynrna_prop']) == 0)

        self.id.dynrna_prop.string_prop = "Test String"
        self.assertTrue(len(self.id.bl_system_properties['dynrna_prop']) == 1)
        self.assertEqual(self.id.dynrna_prop.string_prop, self.id.bl_system_properties['dynrna_prop']['string_prop'])
        self.id.bl_system_properties['dynrna_prop']['string_prop'] = "String test"
        self.assertEqual(self.id.dynrna_prop.string_prop, self.id.bl_system_properties['dynrna_prop']['string_prop'])

        self.id.dynrna_prop.int_prop = 1
        self.assertTrue(len(self.id.bl_system_properties['dynrna_prop']) == 2)
        self.assertEqual(self.id.dynrna_prop.int_prop, self.id.bl_system_properties['dynrna_prop']['int_prop'])
        self.id.bl_system_properties['dynrna_prop']['int_prop'] = 33
        self.assertEqual(self.id.dynrna_prop.int_prop, self.id.bl_system_properties['dynrna_prop']['int_prop'])

        self.id.dynrna_prop.float_array_prop = [1.0, 2.0, 3.0]
        self.assertTrue(len(self.id.bl_system_properties['dynrna_prop']) == 3)
        self.assertEqual(list(self.id.dynrna_prop.float_array_prop),
                         list(self.id.bl_system_properties['dynrna_prop']['float_array_prop']))
        self.id.bl_system_properties['dynrna_prop']['float_array_prop'] = [0.1, 1.0, 10.0]
        self.assertEqual(list(self.id.dynrna_prop.float_array_prop),
                         list(self.id.bl_system_properties['dynrna_prop']['float_array_prop']))
    ...
    def test_static_type(self):
        ...
        with self.assertRaises(TypeError):
            self.id.bl_system_properties['dynrna_prop']['string_prop'] = b"Test String"

        # Supported conversion from bool to int.
        self.id.bl_system_properties['dynrna_prop']['int_prop'] = False
        self.assertEqual(self.id.bl_system_properties['dynrna_prop']['int_prop'], 0)
        self.assertEqual(self.id.dynrna_prop.int_prop, self.id.bl_system_properties['dynrna_prop']['int_prop'])
        self.assertEqual(type(self.id.bl_system_properties['dynrna_prop']['int_prop']), int)
        with self.assertRaises(TypeError):
            self.id.bl_system_properties['dynrna_prop']['int_prop'] = 2.5
        with self.assertRaises(TypeError):
            self.id.bl_system_properties['dynrna_prop']['int_prop'] = "100"

        mixed_array = [5, 2.5, 2]
        self.id.bl_system_properties['dynrna_prop']['float_array_prop'] = mixed_array
        ...
        with self.assertRaises(TypeError):
            self.id.bl_system_properties['dynrna_prop']['float_array_prop'] = 2.5
        with self.assertRaises(TypeError):
            self.id.bl_system_properties['dynrna_prop']['float_array_prop'] = [True, False, False]
        # Length of the array is also considered as static/fixed.
        with self.assertRaises(TypeError):
            self.id.bl_system_properties['dynrna_prop']['float_array_prop'] = [5.0, 2.5]
        with self.assertRaises(TypeError):
            self.id.bl_system_properties['dynrna_prop']['float_array_prop'] = [1.0, 10.0, 100.0, 0.1]

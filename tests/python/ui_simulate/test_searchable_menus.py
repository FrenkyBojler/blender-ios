...
def test_sequencer_modifier_add():
    import bpy
    e, t, w, a = _setup('SEQUENCE_EDITOR')
    yield
...
def test_grease_pencil_layer_search():
    import bpy
    e, t, w, a = _setup('PROPERTIES')
    yield

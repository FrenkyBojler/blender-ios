...
def check_all_general_workspaces():
...
def check_all_2d_animation_workspaces():
    e, t = _test_vars(window := _test_window())
...
def check_all_sculpting_workspaces():
    e, t = _test_vars(window := _test_window())
...
def check_all_video_editing_workspaces():
    e, t = _test_vars(window := _test_window())

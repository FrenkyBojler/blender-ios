...
class TestEnvironment:
    ...
    def _submodule_key(self) -> str:
        """
        Return a key to identify the current submodule checkout. The key only includes checked out submodules.

        The key is used to determine if submodules have changed between builds. In that case the CMakeCache should be reevaluated as it can point to different libraries/versions.
        """

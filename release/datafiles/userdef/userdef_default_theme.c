...
const bTheme U_theme_default = {
  ...
  .tui = {
    ...
    .xaxis_rot = RGBA(0xff335200),
    .yaxis_rot = RGBA(0x8bdc0000),
    .zaxis_rot = RGBA(0x2890ff00),
    .xaxis_scale = RGBA(0xff335200),
    .yaxis_scale = RGBA(0x8bdc0000),
    .zaxis_scale = RGBA(0x2890ff00),

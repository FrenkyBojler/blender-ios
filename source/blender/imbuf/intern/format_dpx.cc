...
ImBuf *imb_load_dpx(const uchar *mem, size_t size, eImBufFlags flags, ImFileColorSpace &r_colorspace)
{
...
static std::tuple<WriteContext, ImageSpec> prepare_save_dpx(ImBuf *ibuf, eImBufFlags flags)
{

...
ImBuf *imb_load_tga(const uchar *mem, size_t size, eImBufFlags flags, ImFileColorSpace &r_colorspace)
{
...
static std::tuple<WriteContext, ImageSpec> prepare_save_tga(ImBuf *ibuf, eImBufFlags flags)
{

...
ImBuf *imb_load_bmp(const uchar *mem, size_t size, eImBufFlags flags, ImFileColorSpace &r_colorspace)
{
...
static std::tuple<WriteContext, ImageSpec> prepare_save_bmp(ImBuf *ibuf, eImBufFlags flags)
{

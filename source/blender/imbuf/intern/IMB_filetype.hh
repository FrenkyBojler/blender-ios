...
struct ImFileType {
  ...
  ImBuf *(*load)(const unsigned char *mem, size_t size, eImBufFlags flags, ImFileColorSpace &r_colorspace);
  /** Load an image from a file. */
  ImBuf *(*load_filepath)(const char *filepath, eImBufFlags flags, ImFileColorSpace &r_colorspace);
  /**
  ...
  ImBuf *(*load_filepath_thumbnail)(const char *filepath,
                                    ...
                                    size_t *r_height);
  /** Save to a file. */
  bool (*save)(ImBuf *ibuf, const char *filepath, eImBufFlags flags);
  /** Save to a memory buffer. */
  Vector<uint8_t> (*save_buffer)(ImBuf *ibuf, eImBufFlags flags);
...
ImBuf *imb_load_tga(const unsigned char *mem,
                    ...
                    eImBufFlags flags,
                    ImFileColorSpace &r_colorspace);
bool imb_save_tga(ImBuf *ibuf, const char *filepath, eImBufFlags flags);
Vector<uint8_t> imb_save_buffer_tga(ImBuf *ibuf, eImBufFlags flags);
...
ImBuf *imb_load_jp2(const unsigned char *mem,
                    ...
                    eImBufFlags flags,
                    ImFileColorSpace &r_colorspace);
ImBuf *imb_load_jp2_filepath(const char *filepath, eImBufFlags flags, ImFileColorSpace &r_colorspace);
bool imb_save_jp2(ImBuf *ibuf, const char *filepath, eImBufFlags flags);
...
ImBuf *imb_load_bmp(const unsigned char *mem,
                    ...
                    eImBufFlags flags,
                    ImFileColorSpace &r_colorspace);
bool imb_save_bmp(ImBuf *ibuf, const char *filepath, eImBufFlags flags);
Vector<uint8_t> imb_save_buffer_bmp(ImBuf *ibuf, eImBufFlags flags);
...
bool imb_save_dpx(ImBuf *ibuf, const char *filepath, eImBufFlags flags);
Vector<uint8_t> imb_save_buffer_dpx(ImBuf *ibuf, eImBufFlags flags);

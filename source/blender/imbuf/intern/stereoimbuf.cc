...
ImBuf *IMB_stereo3d_ImBuf(const ImageFormatData *im_format, ImBuf *ibuf_left, ImBuf *ibuf_right)
{
  ...
  ibuf_stereo = IMB_allocImBuf(width, height, ibuf_left->color_mode, 0);
                           ...
                           ImBuf **r_ibuf_right)
{
  ...
  ibuf_left = IMB_allocImBuf(width, height, ibuf_stereo3d->color_mode, 0);
  ibuf_right = IMB_allocImBuf(width, height, ibuf_stereo3d->color_mode, 0);

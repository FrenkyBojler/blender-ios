...
ImBuf *IMB_stereo3d_ImBuf(const ImageFormatData *im_format, ImBuf *ibuf_left, ImBuf *ibuf_right)
{
  ...
  ibuf_stereo = IMB_allocImBuf(width, height, IB_flag_none);
                           ...
                           ImBuf **r_ibuf_right)
{
  ...
  ibuf_left = IMB_allocImBuf(width, height, IB_flag_none);
  ibuf_right = IMB_allocImBuf(width, height, IB_flag_none);

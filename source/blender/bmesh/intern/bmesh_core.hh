 ...
 *   - If the joined faces and the doubled face had opposite face orientations, then the returned
 *     face orientation will be adjusted, to match any surrounding geometry, if possible.

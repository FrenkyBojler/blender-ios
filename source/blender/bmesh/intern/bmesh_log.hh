 ...
 */
void BM_log_face_modified(BMLog *log, BMFace *f, CustomData& fdata);
 ...
 */
void BM_log_face_added(BMLog *log, BMFace *f, CustomData &fdata);
 ...
 * that face.
 */
void BM_log_face_removed(BMLog *log, BMFace *f, CustomData& fdata);

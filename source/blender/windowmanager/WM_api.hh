 ...
 */
OperatorStatus WM_operator_props_popup_confirm(bContext *C, wmOperator *op, const wmEvent *event);

OperatorStatus WM_operator_props_popup_confirm_ex(
    bContext *C,
    wmOperator *op,
    const wmEvent *event,
...
OperatorStatus WM_operator_props_dialog_popup(
    bContext *C,
    wmOperator *op,
    int width,
    std::optional<std::string> title = std::nullopt,
 ...
 */
OperatorStatus WM_operator_call_ex(bContext *C, wmOperator *op, bool store);

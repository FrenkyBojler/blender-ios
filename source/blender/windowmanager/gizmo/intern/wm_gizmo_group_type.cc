...
wmGizmoGroupType *WM_gizmogrouptype_append(void (*wtfunc)(wmGizmoGroupType *))
{
  ...
  BLI_assert_msg(
      !(((gzgt->flag & WM_GIZMOGROUPTYPE_2D_TOOL) && (gzgt->flag & WM_GIZMOGROUPTYPE_3D)) ||
        ((gzgt->flag & WM_GIZMOGROUPTYPE_2D_VIEW_CONTROLS) &&
         (gzgt->flag & WM_GIZMOGROUPTYPE_3D))),
      "Gizmos cannot be marked 2D and 3D at the same time.");

  BLI_assert_msg(!((gzgt->flag & WM_GIZMOGROUPTYPE_2D_TOOL) &&
                   (gzgt->flag & WM_GIZMOGROUPTYPE_2D_VIEW_CONTROLS)),

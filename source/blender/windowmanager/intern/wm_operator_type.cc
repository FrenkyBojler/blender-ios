...
static OperatorStatus wm_macro_end(wmOperator *op, OperatorStatus retval)
{
...
static OperatorStatus wm_macro_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus wm_macro_invoke_internal(bContext *C,
                                               wmOperator *op,
                                               const wmEvent *event,
                                               wmOperator *opm)
{
...
static OperatorStatus wm_macro_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  wm_macro_start(op);
  return wm_macro_invoke_internal(C, op, event, static_cast<wmOperator *>(op->macro.first));
}

static OperatorStatus wm_macro_modal(bContext *C, wmOperator *op, const wmEvent *event)
{

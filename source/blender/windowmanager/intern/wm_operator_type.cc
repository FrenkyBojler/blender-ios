...
static wmOperatorType *wm_operatortype_append__begin()
{
  ...
  ot->srna = RNA_def_struct_ptr(&blender_rna_get(), "", &RNA_OperatorProperties);
...
static void wm_operatortype_append__end(wmOperatorType *ot)
{
  ...
  RNA_def_struct_identifier(&blender_rna_get(), ot->srna, ot->idname);
...
void WM_operatortype_remove_ptr(wmOperatorType *ot)
{
  ...
  RNA_struct_free(&blender_rna_get(), ot->srna);

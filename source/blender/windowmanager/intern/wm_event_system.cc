...
static wmEventType wm_event_type_from_ghost_key(GHOST_TKey key)
{
  ...
  switch (key) {
    ...
    case GHOST_kKeyUmlautA:
      return EVT_UMLAUTAKEY;
    case GHOST_kKeyUmlautO:
      return EVT_UMLAUTOKEY;
    case GHOST_kKeyUmlautU:
      return EVT_UMLAUTUKEY;
    case GHOST_kKeyEszett:
      return EVT_ESZETTKEY;
    case GHOST_kKeyNumber:
      return EVT_NUMBERKEY;

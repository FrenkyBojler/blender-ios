...
GHOST_IContext *WM_system_gpu_context_create()
{
   ...
   * including legacy display lists, but also textures) with a context which is current in
   * another thread. This is a documented and behavior of both `::wglCreateContextAttribsARB()`
   * and
   * `::wglShareLists()`.
   *

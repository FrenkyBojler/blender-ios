        ...
        [&](int *value) {
          ...
          if (v_data == NO_EDGE) {
            ...
            *value = inv_indices ? -new_value : new_value;
             ...
             * as this may exceed the pre-sized index buffer: see #150841.
             *
             * NOTE: this isn't ideal as the `inv_opposite` may be set - or not depending
             * on the order triangles are handled.

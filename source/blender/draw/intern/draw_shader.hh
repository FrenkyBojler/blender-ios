...
enum class SubdivShaderType {
  ...
  PATCH_EVALUATION = 7,
  PATCH_EVALUATION_FVAR = 8,
  PATCH_EVALUATION_FACE_DOTS = 9,
  PATCH_EVALUATION_FACE_DOTS_WITH_NORMALS = 10,
  PATCH_EVALUATION_ORCO = 11,
  COMP_CUSTOM_DATA_INTERP = 12,
  BUFFER_SCULPT_DATA = 13,
  BUFFER_UV_STRETCH_ANGLE = 14,
  BUFFER_UV_STRETCH_AREA = 15,
};
constexpr int SUBDIVISION_MAX_SHADERS = 16;

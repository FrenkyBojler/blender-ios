...
#define VCLASS_CAMERA_FISHEYE_FOV_90 (1 << 16)
#define VCLASS_CAMERA_FISHEYE_FOV_180 (1 << 17)
#define VCLASS_CAMERA_FISHEYE_FOV_270 (1 << 18)
#define VCLASS_CAMERA_FISHEYE_FOV_45 (1 << 19)
#define VCLASS_CAMERA_FISHEYE_FOV_EDGE (1 << 20)

...
#define VCLASS_CAMERA_FISHEYE_LONGITUDE (1 << 15)
#define VCLASS_CAMERA_FISHEYE_HORIZON (1 << 16)
#define VCLASS_CAMERA_FISHEYE_LATITUDE (1 << 17)
#define VCLASS_CAMERA_FISHEYE_TRIA (1 << 18)
#define VCLASS_CAMERA_FISHEYE_FRAME (1 << 19)

...
#define VCLASS_CAMERA_FISHEYE_FRAME (1 << 18)
#define VCLASS_CAMERA_FISHEYE_TRIA (1 << 19)
#define VCLASS_CAMERA_FISHEYE_LONGITUDE (1 << 20)
#define VCLASS_CAMERA_FISHEYE_LATITUDE (1 << 21)
#define VCLASS_CAMERA_FISHEYE_HORIZON (1 << 22)

#define VCLASS_CAMERA_EQUIRECTANGULAR_TRIA (1 << 23)
#define VCLASS_CAMERA_EQUIRECTANGULAR_LATITUDE (1 << 24)
#define VCLASS_CAMERA_EQUIRECTANGULAR_LONGITUDE (1 << 25)
#define VCLASS_CAMERA_EQUIRECTANGULAR_LEFT (1 << 26)
#define VCLASS_CAMERA_EQUIRECTANGULAR_RIGHT (1 << 27)

#define VCLASS_CAMERA_EQUIANGULAR (1 << 28)
/** \} */

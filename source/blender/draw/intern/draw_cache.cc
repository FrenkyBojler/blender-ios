...
blender::gpu::VertBuf *DRW_cache_object_pos_vertbuf_get(Object *ob)
{
  ...
  /* TODO: do we need to ensure subdivision here? */

  switch (type) {
    case OB_MESH:
      return DRW_mesh_batch_cache_pos_vertbuf_get(
          (mesh != nullptr) ? *mesh : DRW_object_get_data<Mesh>(*ob));
    default:
      return nullptr;
  }
}
...
blender::gpu::Batch *DRW_cache_mesh_all_verts_get(Object *ob)
{
  ...
  return DRW_mesh_batch_cache_get_all_verts(DRW_object_get_data<Mesh>(*ob));
}
...
blender::gpu::Batch *DRW_cache_mesh_all_edges_get(Object *ob)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_all_edges(DRW_object_get_data<Mesh>(*ob));
}
...
blender::gpu::Batch *DRW_cache_mesh_loose_edges_get(Object *ob)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_loose_edges(DRW_object_get_data<Mesh>(*ob));
}
...
blender::gpu::Batch *DRW_cache_mesh_edge_detection_get(Object *ob, bool *r_is_manifold)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_edge_detection(DRW_object_get_data<Mesh>(*ob), r_is_manifold);
}
...
blender::gpu::Batch *DRW_cache_mesh_surface_get(Object *ob)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_surface(DRW_object_get_data<Mesh>(*ob));
}
...
blender::gpu::Batch *DRW_cache_mesh_surface_edges_get(Object *ob)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_surface_edges(DRW_object_get_data<Mesh>(*ob));
}
    ...
    Object *ob, const blender::Span<const GPUMaterial *> materials)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_surface_shaded(*ob, DRW_object_get_data<Mesh>(*ob), materials);
}
...
Span<blender::gpu::Batch *> DRW_cache_mesh_surface_texpaint_get(Object *ob)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_surface_texpaint(*ob, DRW_object_get_data<Mesh>(*ob));
}
...
blender::gpu::Batch *DRW_cache_mesh_surface_texpaint_single_get(Object *ob)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_surface_texpaint_single(*ob, DRW_object_get_data<Mesh>(*ob));
}
...
blender::gpu::Batch *DRW_cache_mesh_surface_vertpaint_get(Object *ob)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_surface_vertpaint(*ob, DRW_object_get_data<Mesh>(*ob));
}
...
blender::gpu::Batch *DRW_cache_mesh_surface_sculptcolors_get(Object *ob)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_surface_sculpt(*ob, DRW_object_get_data<Mesh>(*ob));
}
...
blender::gpu::Batch *DRW_cache_mesh_surface_weights_get(Object *ob)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_surface_weights(DRW_object_get_data<Mesh>(*ob));
}
...
blender::gpu::Batch *DRW_cache_mesh_face_wireframe_get(Object *ob)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_wireframes_face(DRW_object_get_data<Mesh>(*ob));
}
...
blender::gpu::Batch *DRW_cache_mesh_surface_mesh_analysis_get(Object *ob)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_edit_mesh_analysis(DRW_object_get_data<Mesh>(*ob));
}
...
blender::gpu::Batch *DRW_cache_mesh_surface_viewer_attribute_get(Object *ob)
{
  using namespace blender::draw;
  BLI_assert(ob->type == OB_MESH);
  return DRW_mesh_batch_cache_get_surface_viewer_attribute(DRW_object_get_data<Mesh>(*ob));
}
...
blender::gpu::Batch *DRW_cache_curve_edge_wire_get(Object *ob)
{
  ...
  Curve &cu = DRW_object_get_data<Curve>(*ob);
...
blender::gpu::Batch *DRW_cache_lattice_verts_get(Object *ob)
{
  ...
  Lattice &lt = DRW_object_get_data<Lattice>(*ob);
...
blender::gpu::Batch *DRW_cache_pointcloud_vert_overlay_get(Object *ob)
{
  ...
  PointCloud &pointcloud = DRW_object_get_data<PointCloud>(*ob);
...
blender::gpu::Batch *DRW_cache_volume_face_wireframe_get(Object *ob)
{
  ...
  return DRW_volume_batch_cache_get_wireframes_face(&DRW_object_get_data<Volume>(*ob));
}

blender::gpu::Batch *DRW_cache_volume_selection_surface_get(Object *ob)
{
  BLI_assert(ob->type == OB_VOLUME);
  return DRW_volume_batch_cache_get_selection_surface(&DRW_object_get_data<Volume>(*ob));
}
...
void drw_batch_cache_validate(Object *ob)
{
  ...
  switch (ob->type) {
    case OB_MESH:
      DRW_mesh_batch_cache_validate(DRW_object_get_data<Mesh>(*ob));
      break;
...
void drw_batch_cache_generate_requested(Object *ob)
{
  ...
  switch (ob->type) {
    case OB_MESH:
      DRW_mesh_batch_cache_create_requested(*drw_get().task_graph,
                                            *ob,
...
void DRW_batch_cache_free_old(Object *ob, int ctime)
{
  switch (ob->type) {
    case OB_MESH:
      DRW_mesh_batch_cache_free_old(&DRW_object_get_data<Mesh>(*ob), ctime);
      break;
    case OB_CURVES:

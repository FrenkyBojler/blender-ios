...
/* Attributes. */
STORAGE_BUF(6, read, float, points_pos_buf[])
STORAGE_BUF(7, read, float, points_rad_buf[])
STORAGE_BUF(8, read_write, float4, points_pos_rad_buf[])
STORAGE_BUF(9, read_write, float, points_time_buf[])
STORAGE_BUF(10, write, float, curves_length_buf[])
PUSH_CONSTANT(int, curves_count)

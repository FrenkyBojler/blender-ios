...
DO_STATIC_COMPILATION()
STORAGE_BUF(LOOP_NORMALS_POS_SLOT, READ, packed_float3, positions[])
STORAGE_BUF(LOOP_NORMALS_EXTRA_COARSE_FACE_DATA_BUF_SLOT, READ, uint, extra_coarse_face_data[])
STORAGE_BUF(LOOP_NORMALS_VERT_NORMALS_BUF_SLOT, READ, packed_float3, vert_normals[])
...
ADDITIONAL_INFO(subdiv_base)
STORAGE_BUF(EDGE_FAC_POS_BUF_SLOT, READ, packed_float3, positions[])
...
GPU_SHADER_CREATE_INFO(subdiv_custom_data_interp_3d_f32_normalize)
DO_STATIC_COMPILATION()
DEFINE("GPU_COMP_F32")
DEFINE("DIMENSIONS_3")
DEFINE("NORMALIZE")
...
DO_STATIC_COMPILATION()
STORAGE_BUF(NORMALS_ACCUMULATE_POS_BUF_SLOT, READ, packed_float3, positions[])
...
STORAGE_BUF(NORMALS_ACCUMULATE_NORMALS_BUF_SLOT, WRITE, packed_float3, vert_normals[])

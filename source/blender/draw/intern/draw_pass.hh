...
{
  GPU_debug_group_scope("warm_shader_specialization", ProfileCategory::Draw);
  GPU_debug_group_scope_transient(this->debug_name);
...
template<class T> void PassBase<T>::submit(command::RecordingState &state) const
{
  ...
  GPU_debug_group_scope_transient(debug_name);

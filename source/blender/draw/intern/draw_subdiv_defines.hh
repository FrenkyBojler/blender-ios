...
#define NORMALS_FINALIZE_INPUT_VERT_ORIG_INDEX_BUF_SLOT 1
#define NORMALS_FINALIZE_EXTRA_COARSE_FACE_DATA_BUF_SLOT 2
#define NORMALS_FINALIZE_OUTPUT_LNOR_BUF_SLOT 3

...
#define PATCH_EVALUATION_OUTPUT_VERTS_BUF_SLOT 8
...
#define PATCH_EVALUATION_FLAGS_BUFFER_BUF_SLOT 8
#define PATCH_EVALUATION_OUTPUT_VERTS_BUF_SLOT 9
...
#define STRETCH_ANGLE_POS_NOR_BUF_SLOT 0

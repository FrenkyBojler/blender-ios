...
class Cameras : Overlay {
 ...
 private:
                          ...
                          Resources &res)
  {
    ...
    const Camera &cam = DRW_object_get_data<Camera>(*ob);
  ...
  {
    Object *ob = ob_ref.object;
    const Camera &cam = DRW_object_get_data<Camera>(*ob_ref.object);
                              ...
                              Object *ob)
  {
    ...
    const Camera &cam = DRW_object_get_data<const Camera>(*ob);

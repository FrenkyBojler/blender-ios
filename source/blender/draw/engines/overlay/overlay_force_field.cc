...
void ForceFields::begin_sync(Resources & /*res*/, const State & /*state*/)
{
...
void ForceFields::object_sync(Manager & /*manager*/,
...
void ForceFields::end_sync(Resources &res, const State &state)
{
  ps_.init();
  res.select_bind(ps_);
...
void ForceFields::draw_line(Framebuffer &framebuffer, Manager &manager, View &view)
{

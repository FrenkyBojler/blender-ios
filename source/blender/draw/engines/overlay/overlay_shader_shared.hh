...
enum [[host_shared]] VertexClass : uint32_t {
  ...
  VCLASS_CAMERA_FISHEYE_FRAME = 1 << 15,
  VCLASS_CAMERA_FISHEYE_TRIA = 1 << 16,
  VCLASS_CAMERA_FISHEYE_LONGITUDE = 1 << 17,  
  VCLASS_CAMERA_FISHEYE_LATITUDE = 1 << 18,
  VCLASS_CAMERA_FISHEYE_HORIZON = 1 << 19,  
  
  VCLASS_CAMERA_EQUIRECTANGULAR_TRIA = 1 << 20,
  VCLASS_CAMERA_EQUIRECTANGULAR_LATITUDE = 1 << 21,  
  VCLASS_CAMERA_EQUIRECTANGULAR_LONGITUDE = 1 << 22,
  VCLASS_CAMERA_EQUIRECTANGULAR_LEFT = 1 << 23,
  VCLASS_CAMERA_EQUIRECTANGULAR_RIGHT = 1 << 24,
  
  VCLASS_CAMERA_EQUIANGULAR = 1 << 25
};
#ifndef GPU_SHADER

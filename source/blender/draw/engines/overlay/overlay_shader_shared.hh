...
enum [[host_shared]] VertexClass : uint32_t {
  ...
  VCLASS_CAMERA_FISHEYE_LONGITUDE = 1 << 15,
  VCLASS_CAMERA_FISHEYE_HORIZON = 1 << 16,
  VCLASS_CAMERA_FISHEYE_LATITUDE = 1 << 17,
  VCLASS_CAMERA_FISHEYE_TRIA = 1 << 18,
  VCLASS_CAMERA_FISHEYE_FRAME = 1 << 19
};
#ifndef GPU_SHADER

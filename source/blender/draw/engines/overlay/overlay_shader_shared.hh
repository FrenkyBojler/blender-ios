...
enum [[host_shared]] VertexClass : uint32_t {
  ...
  VCLASS_CAMERA_FISHEYE_FOV_90 = 1 << 16,
  VCLASS_CAMERA_FISHEYE_FOV_180 = 1 << 17,
  VCLASS_CAMERA_FISHEYE_FOV_270 = 1 << 18,
  VCLASS_CAMERA_FISHEYE_FOV_45 = 1 << 19,
  VCLASS_CAMERA_FISHEYE_FOV_EDGE = 1 << 20,
  VCLASS_CAMERA_FISHEYE_FOV_RING = 1 << 21,
  VCLASS_CAMERA_FISHEYE_DIRECTION = 1 << 22
};
#ifndef GPU_SHADER

...
void PointClouds::begin_sync(Resources &res, const State &state)
{
...
void PointClouds::edit_object_sync(Manager &manager,
...
void PointClouds::pre_draw(Manager &manager, View &view)
{
  if (!enabled_) {
    return;
  }
...
void PointClouds::draw_line(Framebuffer &framebuffer, Manager &manager, View &view)
{
  if (!enabled_) {
    return;
  }

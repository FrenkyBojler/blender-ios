...
class ShaderModule {
 ...
 public:
  ...
  ShaderPtr curve_edit_handles = shader("overlay_edit_curves_handle");
  ...
  ShaderPtr legacy_curve_edit_handles = shader("overlay_edit_curve_handle");
  ShaderPtr legacy_curve_edit_points;
  ShaderPtr motion_path_line = shader("overlay_motion_path_line");
  ...
  ShaderPtr outline_prepass_wire = shader("overlay_outline_prepass_wire");

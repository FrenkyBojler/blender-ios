...
void main()
{
  ...
  /* Empties */
    ...
    vpos.x = vpos.x > 0 ? calculated_radius + shifted_radius_x : -calculated_radius + shifted_radius_x;
    vpos.y = vpos.y > 0 ? calculated_radius + shifted_radius_y : -calculated_radius + shifted_radius_y;

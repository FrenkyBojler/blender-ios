...
GPU_SHADER_CREATE_INFO(overlay_edit_curves_handle_common)
TYPEDEF_SOURCE("overlay_shader_shared.hh")
VERTEX_OUT(overlay_edit_smooth_color_iface)
PUSH_CONSTANT(int, curve_handle_display)
FRAGMENT_OUT(0, float4, frag_color)
...
GPU_SHADER_CREATE_INFO(overlay_edit_curves_handle_gp)
DO_STATIC_COMPILATION()
STORAGE_BUF_FREQ(0, read, float, pos[], GEOMETRY)
STORAGE_BUF_FREQ(1, read, uint, data[], GEOMETRY)
...
PUSH_CONSTANT(int2, gpu_attr_1)
PUSH_CONSTANT(int2, gpu_attr_2)
ADDITIONAL_INFO(overlay_edit_curves_handle_common)
GPU_SHADER_CREATE_END()

CREATE_INFO_VARIANT(overlay_edit_curves_handle_gp_clipped,
                    overlay_edit_curves_handle_gp,
                    drw_clipped)
...
GPU_SHADER_CREATE_INFO(overlay_edit_curves_point_common)
TYPEDEF_SOURCE("overlay_shader_shared.hh")
DEFINE("CURVES_POINT")
VERTEX_OUT(overlay_edit_flat_color_iface)
SAMPLER(0, sampler1D, weight_tx)
...
GPU_SHADER_CREATE_INFO(overlay_edit_curves_point_gp)
DO_STATIC_COMPILATION()
TYPEDEF_SOURCE("gpencil_shader_shared.hh")
DEFINE("GREASE_PENCIL")
VERTEX_IN(0, float3, pos)
VERTEX_IN(1, uint, data)
VERTEX_IN(2, float, selection)
VERTEX_IN(3, uint, vflag)
PUSH_CONSTANT(bool, do_stroke_endpoints)
ADDITIONAL_INFO(overlay_edit_curves_point_common)
GPU_SHADER_CREATE_END()

CREATE_INFO_VARIANT(overlay_edit_curves_point_gp_clipped,
                    overlay_edit_curves_point_gp,
                    drw_clipped)

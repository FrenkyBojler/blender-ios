...
GPU_SHADER_CREATE_INFO(overlay_edit_curves_bezier_segment)
DEFINE("SEGMENT")
DO_STATIC_COMPILATION()
TYPEDEF_SOURCE("overlay_shader_shared.h")
STORAGE_BUF_FREQ(0, READ, int, point_index[], GEOMETRY)
STORAGE_BUF_FREQ(1, READ, int, evaluated_points_offset[], GEOMETRY)
STORAGE_BUF_FREQ(2, READ, float, radius[], GEOMETRY)
STORAGE_BUF(3, READ, float, pos[])
UNIFORM_BUF(0, CurvesData, curves_data)
PUSH_CONSTANT(BOOL, displayRadius)
PUSH_CONSTANT(IVEC2, gpu_attr_0)
PUSH_CONSTANT(IVEC2, gpu_attr_1)
PUSH_CONSTANT(IVEC2, gpu_attr_2)
PUSH_CONSTANT(IVEC2, gpu_attr_3)
VERTEX_OUT(overlay_edit_flat_color_iface)
FRAGMENT_OUT(0, VEC4, fragColor)
VERTEX_SOURCE("overlay_edit_curves_bezier_segment_vert.glsl")
FRAGMENT_SOURCE("overlay_varying_color.glsl")
ADDITIONAL_INFO(draw_view)
ADDITIONAL_INFO(draw_modelmat_new)
ADDITIONAL_INFO(draw_resource_handle_new)
...
OVERLAY_INFO_CLIP_VARIATION(overlay_edit_curves_bezier_segment)

GPU_SHADER_INTERFACE_INFO(overlay_edit_curves_segment_joint_iface)
FLAT(VEC4, finalColor)
SMOOTH(VEC2, uv_coord)
GPU_SHADER_INTERFACE_END()
GPU_SHADER_CREATE_INFO(overlay_edit_curves_segment_joint)
DO_STATIC_COMPILATION()
TYPEDEF_SOURCE("overlay_shader_shared.h")
STORAGE_BUF_FREQ(0, READ, int, point_index[], GEOMETRY)
STORAGE_BUF_FREQ(1, READ, int, evaluated_points_offset[], GEOMETRY)
...
STORAGE_BUF(3, READ, float, pos[])
UNIFORM_BUF(0, CurvesData, curves_data)
PUSH_CONSTANT(BOOL, endpointsOnly)
PUSH_CONSTANT(IVEC2, gpu_attr_0)
PUSH_CONSTANT(IVEC2, gpu_attr_1)
PUSH_CONSTANT(IVEC2, gpu_attr_2)
PUSH_CONSTANT(IVEC2, gpu_attr_3)
VERTEX_OUT(overlay_edit_curves_segment_joint_iface)
FRAGMENT_OUT(0, VEC4, fragColor)
VERTEX_SOURCE("overlay_edit_curves_bezier_segment_vert.glsl")
FRAGMENT_SOURCE("overlay_edit_curves_segment_joint_frag.glsl")
ADDITIONAL_INFO(draw_view)
ADDITIONAL_INFO(draw_modelmat_new)
ADDITIONAL_INFO(draw_resource_handle_new)
ADDITIONAL_INFO(gpu_index_buffer_load)
...
OVERLAY_INFO_CLIP_VARIATION(overlay_edit_curves_segment_joint)

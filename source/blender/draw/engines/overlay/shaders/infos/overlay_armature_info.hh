...
GPU_SHADER_INTERFACE_INFO(overlay_armature_shape_wire_strip_iface)
FLAT(VEC4, finalColor)
FLAT(FLOAT, wire_width)
GPU_SHADER_INTERFACE_END()
...
VERTEX_IN(0, VEC3, pos)
VERTEX_IN(1, VEC3, nor)
VERTEX_OUT(overlay_armature_shape_wire_strip_iface)
VERTEX_SOURCE("overlay_armature_shape_wire_strip_vert.glsl")
FRAGMENT_SOURCE("overlay_armature_shape_wire_strip_frag.glsl")
TYPEDEF_SOURCE("overlay_shader_shared.h")
ADDITIONAL_INFO(overlay_frag_output)
ADDITIONAL_INFO(overlay_armature_common)
ADDITIONAL_INFO(draw_globals)

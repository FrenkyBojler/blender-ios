...
GPU_SHADER_CREATE_INFO(overlay_gridrework_next)
DO_STATIC_COMPILATION()
TYPEDEF_SOURCE("overlay_shader_shared.hh")
VERTEX_IN(0, float3, pos)
VERTEX_OUT(overlay_grid_vert_out)
VERTEX_OUT(overlay_gridrework_vert_out) /* TODO(not_mark): move to overlay_grid_vert_out */
FRAGMENT_OUT(0, float4, out_color)
...
PUSH_CONSTANT(int, grid_flag)
PUSH_CONSTANT(int, num_lines)
SAMPLER(0, sampler2DDepth, depth_tx)
SAMPLER(1, sampler2DDepth, depth_infront_tx)
VERTEX_SOURCE("overlay_gridrework_vert.glsl")
FRAGMENT_SOURCE("overlay_gridrework_frag.glsl")
ADDITIONAL_INFO(draw_view)
ADDITIONAL_INFO(draw_globals)
GPU_SHADER_CREATE_END()

...
GPU_SHADER_CREATE_INFO(overlay_wireframe_pointcloud_base)
DEFINE("POINTS")
DEFINE("POINTCLOUD")
PUSH_CONSTANT(float, ndc_offset_factor)
PUSH_CONSTANT(bool, use_coloring)
...
/* clang-format off */
CREATE_INFO_VARIANT(overlay_wireframe_pointcloud, overlay_wireframe_pointcloud_base, draw_modelmat)
CREATE_INFO_VARIANT(overlay_wireframe_pointcloud_selectable, overlay_wireframe_pointcloud_base, draw_modelmat_with_custom_id, overlay_select)
CREATE_INFO_VARIANT(overlay_wireframe_pointcloud_clipped, overlay_wireframe_pointcloud, drw_clipped)
CREATE_INFO_VARIANT(overlay_wireframe_pointcloud_selectable_clipped, overlay_wireframe_pointcloud_selectable, drw_clipped)
/* clang-format on */

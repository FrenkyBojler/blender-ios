...
SMOOTH(float, sharp_fac)
SMOOTH(float, crease_fac)
SMOOTH(float, bweight_fac)
...
COMPILATION_CONSTANT(bool, use_seam, false)
COMPILATION_CONSTANT(bool, use_sharp, false)
COMPILATION_CONSTANT(bool, use_crease, false)
COMPILATION_CONSTANT(bool, use_bweight, false)

...
void Bounds::begin_sync(Resources & /*res*/, const State & /*state*/)
{
...
void Bounds::object_sync(Manager & /*manager*/,
...
void Bounds::end_sync(Resources &res, const State &state)
{
  ps_.init();
...
void Bounds::draw_line(Framebuffer &framebuffer, Manager &manager, View &view)
{

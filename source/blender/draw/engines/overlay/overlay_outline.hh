...
class Outline : Overlay {
 ...
 public:
  ...
  void draw_line_only_ex(Framebuffer &framebuffer, Resources &res, Manager &manager, View &view)
  {
    ...
    tmp_depth_tx_.acquire(render_size, blender::gpu::TextureFormat::SFLOAT_32_DEPTH_UINT_8, usage);
    object_id_tx_.acquire(render_size, blender::gpu::TextureFormat::UINT_16, usage);

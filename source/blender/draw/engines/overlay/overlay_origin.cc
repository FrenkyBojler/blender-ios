...
void Origins::begin_sync(Resources & /*res*/, const State &state)
{
...
void Origins::object_sync(Manager & /*manager*/,
...
void Origins::end_sync(Resources &res, const State &state)
{
  if (!enabled_) {
    return;
  }
...
void Origins::draw_color_only(Framebuffer &framebuffer, Manager &manager, View &view)
{
  if (!enabled_) {
    return;
  }

...
struct Resources : public select::SelectMap {
  ...
  void acquire(const DRWContext *draw_ctx, const State &state)
  {
    ...
    if (state.xray_enabled) {
      ...
      this->xray_depth_tx.acquire(render_size,
    ...
    if (!this->color_overlay_tx.is_valid()) {
      ...
      this->color_overlay_alloc_tx.acquire(int2(1, 1), blender::gpu::TextureFormat::SRGBA_8_8_8_8);
      this->color_render_alloc_tx.acquire(int2(1, 1), blender::gpu::TextureFormat::SRGBA_8_8_8_8);

      this->color_overlay_tx.wrap(this->color_overlay_alloc_tx);
      this->color_render_tx.wrap(this->color_render_alloc_tx);

      this->line_tx.acquire(int2(1, 1), blender::gpu::TextureFormat::UNORM_8_8_8_8);
      this->overlay_tx.acquire(int2(1, 1), blender::gpu::TextureFormat::SRGBA_8_8_8_8);
      ...
      this->line_tx.acquire(render_size, blender::gpu::TextureFormat::UNORM_8_8_8_8, usage);
      this->overlay_tx.acquire(render_size, blender::gpu::TextureFormat::SRGBA_8_8_8_8, usage);

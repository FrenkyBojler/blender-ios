...
void Lights::begin_sync(Resources & /*res*/, const State &state)
{
...
void Lights::object_sync(Manager & /*manager*/,
...
void Lights::end_sync(Resources &res, const State &state)
{
  if (!enabled_) {
    return;
  }
...
void Lights::draw_line(Framebuffer &framebuffer, Manager &manager, View &view)
{
  if (!enabled_) {
    return;
  }

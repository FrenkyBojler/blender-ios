...
void Resources::update_theme_settings(const DRWContext *ctx, const State &state)
{
  ...
  /* Grid Axis */
  UI_GetThemeColorBlendShade4fv(TH_BACK, TH_AXIS_X, 0.6f, -10, gb.colors.grid_axis_x);
  UI_GetThemeColorBlendShade4fv(TH_BACK, TH_AXIS_Y, 0.6f, -10, gb.colors.grid_axis_y);
  UI_GetThemeColorBlendShade4fv(TH_BACK, TH_AXIS_Z, 0.6f, -10, gb.colors.grid_axis_z);

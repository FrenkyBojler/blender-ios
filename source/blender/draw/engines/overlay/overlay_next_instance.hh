...
class Instance {
 ...
 public:
  ...
  struct OverlayLayer {
    ...
    MeshUVs mesh_uvs = {in_front_};
    Metaballs metaballs = {selection_type_, in_front_};
    ModeTransfer mode_transfer = {in_front_};
    Names names = {in_front_};
    Paints paints = {in_front_};
    Particles particles = {in_front_};
    Prepass prepass = {in_front_};
    Relations relations = {selection_type_, in_front_};
    Sculpts sculpts = {in_front_};
    Speakers speakers = {selection_type_, in_front_};
    Wireframe wireframe = {in_front_};

...
void Particles::begin_sync(Resources &res, const State &state)
{
...
void Particles::edit_object_sync(Manager &manager,
                                 ...
                                 const State &state)
{
  ...
  ResourceHandleRange handle = manager.resource_handle_for_psys(ob_ref, ob_ref.particles_matrix());
...
void Particles::object_sync(Manager &manager,
                            const ObjectRef &ob_ref,
                            Resources &res,
                            const State &state)
{
...
void Particles::pre_draw(Manager &manager, View &view)
{
  if (!enabled_) {
    return;
  }
...
void Particles::draw_line(Framebuffer &framebuffer, Manager &manager, View &view)
{
  if (!enabled_) {
    return;
  }
...
void Particles::draw(Framebuffer &framebuffer, Manager &manager, View &view)
{
  if (!enabled_) {
    return;
  }

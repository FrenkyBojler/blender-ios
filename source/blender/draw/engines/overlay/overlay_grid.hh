...
class Grid : Overlay {
 ...
 public:
  void begin_sync(Resources &res, const State &state) final
  {
    ...
    blender::gpu::Texture **depth_tx = state.xray_enabled ? &res.xray_depth_tx : &res.depth_tx;
    blender::gpu::Texture **depth_infront_tx = state.use_in_front ? &res.depth_target_in_front_tx :
                                                                    &res.dummy_depth_tx;

...
class Sculpts : Overlay {
 ...
 public:
  ...
  {
    ::Curves &curves = DRW_object_get_data<::Curves>(*ob_ref.object);
  ...
  void mesh_sync(Manager &manager, const ObjectRef &ob_ref, const State &state)
  {
    ...
    switch (pbvh->type()) {
      case blender::bke::pbvh::Type::Mesh: {
        const Mesh &mesh = DRW_object_get_data<Mesh>(*object_orig);
      ...
      case blender::bke::pbvh::Type::Grids: {
        ...
        const Mesh &base_mesh = DRW_object_get_data<Mesh>(*object_orig);
    ...
    if (use_pbvh) {
      ...
      Mesh &mesh = DRW_object_get_data<Mesh>(*ob_ref.object);

...
void AttributeViewer::begin_sync(Resources &res, const State &state)
{
  ps_.init();
...
void AttributeViewer::object_sync(Manager &manager,
...
void AttributeViewer::populate_for_instance(const ObjectRef &ob_ref,
                                            const State &state,
                                            Manager &manager)
{
...
void AttributeViewer::populate_for_geometry(const ObjectRef &ob_ref,
                                            const State &state,
                                            Manager &manager)
{

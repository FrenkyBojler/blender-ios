...
void Armatures::begin_sync(Resources &res, const State &state)
{
...
Armatures::DrawContext Armatures::create_draw_context(const ObjectRef &ob_ref,
                                                      Resources &res,
                                                      const State &state,
...
void Armatures::edit_object_sync(Manager & /*manager*/,
...
bool Armatures::is_pose_mode(const Object *armature_ob, const State &state)
{
...
void Armatures::object_sync(Manager & /*manager*/,
                            const ObjectRef &ob_ref,
                            Resources &res,
                            const State &state)
{
...
void Armatures::end_sync(Resources &res, const State & /*state*/)
{
  if (!enabled_) {
    return;
  }

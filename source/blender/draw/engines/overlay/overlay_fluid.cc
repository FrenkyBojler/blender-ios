...
void Fluids::begin_sync(Resources &res, const State &state)
{
...
void Fluids::object_sync(Manager &manager,
...
void Fluids::end_sync(Resources &res, const State & /*state*/)
{
...
void Fluids::draw_line(Framebuffer &framebuffer, Manager &manager, View &view)
{
...
int Fluids::slide_axis_get(const FluidDomainSettings &fluid_domain_settings) const
{

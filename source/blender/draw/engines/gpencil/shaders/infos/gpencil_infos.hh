...
LOCAL_GROUP_SIZE(GPENCIL_ANTIALIASING_ACCUMULATE_GROUP_SIZE, GPENCIL_ANTIALIASING_ACCUMULATE_GROUP_SIZE, 1)
COMPUTE_SOURCE("gpencil_antialiasing_accumulation_comp.glsl")
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()

...
struct MaterialPool {
  ...
  blender::gpu::Texture *tex_fill[GPENCIL_MATERIAL_BUFFER_LEN];
  blender::gpu::Texture *tex_stroke[GPENCIL_MATERIAL_BUFFER_LEN];
...
struct Instance final : public DrawEngine {
  ...
  blender::gpu::Texture *scene_depth_tx;

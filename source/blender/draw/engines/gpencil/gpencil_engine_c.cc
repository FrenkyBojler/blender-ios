...
tObject *Instance::object_sync_do(Object *ob, ResourceHandleRange res_handle)
{
  ...
  blender::gpu::Texture *tex_fill = this->dummy_tx;
  blender::gpu::Texture *tex_stroke = this->dummy_tx;
  ...
  for (const DrawingInfo info : drawings) {
    ...
    visible_strokes.foreach_index([&](const int stroke_i, const int pos) {
      ...
      blender::gpu::Texture *new_tex_fill = nullptr;
      blender::gpu::Texture *new_tex_stroke = nullptr;

...
class DepthOfField {
 private:
  ...
  blender::gpu::Texture *input_color_tx_ = nullptr;
  blender::gpu::Texture *output_color_tx_ = nullptr;
  ...
  blender::gpu::Texture *stabilize_input_ = nullptr;
  ...
  blender::gpu::Texture *resolve_stable_color_tx_ = nullptr;
 ...
 public:
  ...
  void render(View &view,
              blender::gpu::Texture **input_tx,
              blender::gpu::Texture **output_tx,

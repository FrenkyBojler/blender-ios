...
class HiZBuffer {
 private:
  ...
  std::array<blender::gpu::Texture *, HIZ_MIP_COUNT> hiz_mip_ref_;
  ...
  blender::gpu::Texture *src_tx_ = nullptr;
  blender::gpu::Texture **src_tx_ptr_ = nullptr;
 ...
 public:
   ...
   */
  void set_source(blender::gpu::Texture **texture, int layer = -1)
  {
    src_tx_ptr_ = texture;
    layer_id_ = layer;
    swap_layer();
  ...
  struct {
    ...
    blender::gpu::Texture *ref_tx_ = nullptr;

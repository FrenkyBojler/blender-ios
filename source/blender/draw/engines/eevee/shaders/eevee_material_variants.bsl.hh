...
PipelineGraphic eevee_surface_deferred_world(geom_world, surf_deferred,             PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_deferred_curves(geom_curves, surf_deferred,           PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_deferred_mesh(geom_mesh, surf_deferred,               PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_deferred_pointcloud(geom_pointcloud, surf_deferred,   PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_deferred_volume(geom_volume, surf_deferred,           PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_hybrid_world(geom_world, surf_deferred,               PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_hybrid_curves(geom_curves, surf_deferred,             PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_hybrid_mesh(geom_mesh, surf_deferred,                 PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_hybrid_pointcloud(geom_pointcloud, surf_deferred,     PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_hybrid_volume(geom_volume, surf_deferred,             PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_forward_world(geom_world, surf_forward,               PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_forward_curves(geom_curves, surf_forward,             PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_forward_mesh(geom_mesh, surf_forward,                 PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_forward_pointcloud(geom_pointcloud, surf_forward,     PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});
PipelineGraphic eevee_surface_forward_volume(geom_volume, surf_forward,             PipelineConstants{.use_velocity = false, .use_transparency = false, .use_clip_plane = false, .use_sss = true, .is_shadow_pipe = false, .closure_bin_count = 3});

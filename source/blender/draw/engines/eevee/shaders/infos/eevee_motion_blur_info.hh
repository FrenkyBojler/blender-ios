...
IMAGE(1, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, write, image2D, out_tiles_img)
...
DEFINE("FLATTEN_RG")
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16, read_write, image2D, velocity_img)
ADDITIONAL_INFO(eevee_motion_blur_tiles_flatten)
GPU_SHADER_CREATE_END()

GPU_SHADER_CREATE_INFO(eevee_motion_blur_tiles_flatten_rgba)
DO_STATIC_COMPILATION()
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read_write, image2D, velocity_img)
ADDITIONAL_INFO(eevee_motion_blur_tiles_flatten)
GPU_SHADER_CREATE_END()
...
IMAGE(1, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read, image2D, in_tiles_img)
...
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read, image2D, in_tiles_img)
IMAGE(1, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, write, image2D, out_color_img)

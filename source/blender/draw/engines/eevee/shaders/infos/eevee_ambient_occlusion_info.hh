...
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read, image2DArray, in_normal_img)
PUSH_CONSTANT(int, in_normal_img_layer_index)
IMAGE(1, blender::gpu::TextureFormat::SFLOAT_16, write, image2DArray, out_ao_img)

...
IMAGE_FREQ(GBUF_CLOSURE_SLOT,
           blender::gpu::TextureFormat::UNORM_10_10_10_2,
           write,
           image2DArray,
           out_gbuf_closure_img,
           PASS)
IMAGE_FREQ(GBUF_NORMAL_SLOT,
           blender::gpu::TextureFormat::UNORM_16_16,
           write,
           image2DArray,
           out_gbuf_normal_img,
           PASS)
/* Storage for additional infos that are shared across closures. */
IMAGE_FREQ(GBUF_HEADER_SLOT,
           blender::gpu::TextureFormat::UINT_32,
           write,
           uimage2DArray,
           out_gbuf_header_img,
           PASS)
...
IMAGE(VOLUME_HIT_DEPTH_SLOT, blender::gpu::TextureFormat::SFLOAT_32, write, image3D, hit_depth_img)

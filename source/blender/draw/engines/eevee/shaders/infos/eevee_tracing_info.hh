...
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, write, image2D, out_ray_data_img)
...
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read, image2D, ray_data_img)
...
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read_write, image2D, ray_data_img)
IMAGE(1, RAYTRACE_RAYTIME_FORMAT, write, image2D, ray_time_img)
IMAGE(2, RAYTRACE_RADIANCE_FORMAT, write, image2D, ray_radiance_img)
...
IMAGE(5, blender::gpu::TextureFormat::SFLOAT_32, write, image2D, out_hit_depth_img)
...
SAMPLER(3, sampler2DDepth, depth_tx)
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_32, read, image2D, hit_depth_img)
...
IMAGE(2, RAYTRACE_RADIANCE_FORMAT, write, image2D, out_radiance_img)
IMAGE(3, blender::gpu::TextureFormat::UNORM_10_10_10_2, write, image2D, out_normal_img)
...
IMAGE(2, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, write, image2D, horizon_radiance_0_img)
IMAGE(3, blender::gpu::TextureFormat::UNORM_8_8_8_8, write, image2D, horizon_radiance_1_img)
IMAGE(4, blender::gpu::TextureFormat::UNORM_8_8_8_8, write, image2D, horizon_radiance_2_img)
IMAGE(5, blender::gpu::TextureFormat::UNORM_8_8_8_8, write, image2D, horizon_radiance_3_img)
...
IMAGE(2, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, write, image2D, out_sh_0_img)
IMAGE(3, blender::gpu::TextureFormat::UNORM_8_8_8_8, write, image2D, out_sh_1_img)
IMAGE(4, blender::gpu::TextureFormat::UNORM_8_8_8_8, write, image2D, out_sh_2_img)
IMAGE(5, blender::gpu::TextureFormat::UNORM_8_8_8_8, write, image2D, out_sh_3_img)
STORAGE_BUF(7, read, uint, tiles_coord_buf[])

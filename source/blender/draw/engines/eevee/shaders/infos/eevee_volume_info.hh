...
IMAGE(5, blender::gpu::TextureFormat::UFLOAT_11_11_10, write, image3D, out_scattering_img)
IMAGE(6, blender::gpu::TextureFormat::UFLOAT_11_11_10, write, image3D, out_extinction_img)
...
IMAGE(VOLUME_HIT_DEPTH_SLOT, blender::gpu::TextureFormat::SFLOAT_32, read, image3D, hit_depth_img)
...
/* Outputs. */
IMAGE(0, blender::gpu::TextureFormat::UFLOAT_11_11_10, write, image3D, out_scattering_img)
IMAGE(1, blender::gpu::TextureFormat::UFLOAT_11_11_10, write, image3D, out_transmittance_img)
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()

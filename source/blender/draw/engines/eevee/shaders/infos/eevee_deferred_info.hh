...
IMAGE(0, blender::gpu::TextureFormat::UNORM_16_16, read_write, image2DArray, gbuf_normal_img)
...
IMAGE(
    5, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read_write, image2D, radiance_feedback_img)
FRAGMENT_OUT(0, float4, out_combined)
ADDITIONAL_INFO(eevee_shared)
ADDITIONAL_INFO(eevee_gbuffer_data)
ADDITIONAL_INFO(eevee_render_pass_out)

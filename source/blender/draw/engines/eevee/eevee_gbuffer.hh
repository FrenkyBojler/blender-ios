 ...
 public:
  void acquire(int2 extent, int header_count, int data_count, int normal_count)
  {
    ...
    dummy_header_tx_.ensure_2d_array(
        blender::gpu::TextureFormat::UINT_32, int2(1), 1, GPU_TEXTURE_USAGE_SHADER_WRITE);
    dummy_closure_tx_.ensure_2d_array(
        blender::gpu::TextureFormat::UNORM_10_10_10_2, int2(1), 1, GPU_TEXTURE_USAGE_SHADER_WRITE);
    dummy_normal_tx_.ensure_2d_array(
        blender::gpu::TextureFormat::UNORM_16_16, int2(1), 1, GPU_TEXTURE_USAGE_SHADER_WRITE);

    eGPUTextureUsage usage = GPU_TEXTURE_USAGE_SHADER_READ | GPU_TEXTURE_USAGE_SHADER_WRITE |
                             GPU_TEXTURE_USAGE_ATTACHMENT;
    header_tx.ensure_2d_array(blender::gpu::TextureFormat::UINT_32, extent, header_count, usage);
    closure_tx.ensure_2d_array(
        blender::gpu::TextureFormat::UNORM_10_10_10_2, extent, data_count, usage);
    normal_tx.ensure_2d_array(
        blender::gpu::TextureFormat::UNORM_16_16, extent, normal_count, usage);

...
void IrradianceBake::surfels_create(const Object &probe_object)
{
  ...
  {
    GPU_debug_group_scope("IrradianceBake.SceneBounds", ProfileCategory::Draw);
  ...
  {
    GPU_debug_group_scope("IrradianceBake.SurfelsCount", ProfileCategory::Draw);
  ...
  {
    GPU_debug_group_scope("IrradianceBake.SurfelsCreate", ProfileCategory::Draw);

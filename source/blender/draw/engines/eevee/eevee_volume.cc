...
void VolumeModule::end_sync()
{
  ...
  prop_scattering_tx_.ensure_3d(
      blender::gpu::TextureFormat::UFLOAT_11_11_10, data_.tex_size, usage);
  prop_extinction_tx_.ensure_3d(
      blender::gpu::TextureFormat::UFLOAT_11_11_10, data_.tex_size, usage);
  prop_emission_tx_.ensure_3d(blender::gpu::TextureFormat::UFLOAT_11_11_10, data_.tex_size, usage);
  /* We need 2 separate images to prevent bugs in Nvidia drivers (See #122454). */
  prop_phase_tx_.ensure_3d(blender::gpu::TextureFormat::SFLOAT_16, data_.tex_size, usage);
  prop_phase_weight_tx_.ensure_3d(blender::gpu::TextureFormat::SFLOAT_16, data_.tex_size, usage);
  ...
  occupancy_tx_.ensure_3d(blender::gpu::TextureFormat::UINT_32,
                          int3(data_.tex_size.xy(), occupancy_layers),
                          occupancy_usage);

  {
    ...
    hit_depth_tx_.ensure_3d(blender::gpu::TextureFormat::SFLOAT_32,
                            int3(hit_list_size, hit_list_layer),
                            hit_depth_usage);
    if (hit_count_tx_.ensure_2d(
            blender::gpu::TextureFormat::UINT_32, hit_list_size, hit_count_usage))
    {
  ...
  front_depth_tx_.ensure_2d(
      blender::gpu::TextureFormat::SFLOAT_32_DEPTH_UINT_8, data_.tex_size.xy(), front_depth_usage);
  ...
  integrated_scatter_tx_.ensure_3d(
      blender::gpu::TextureFormat::UFLOAT_11_11_10, data_.tex_size, usage);
  integrated_transmit_tx_.ensure_3d(
      blender::gpu::TextureFormat::UFLOAT_11_11_10, data_.tex_size, usage);

...
blender::gpu::Texture *DeferredLayer::render(View &main_view,
                                             View &render_view,
                                             Framebuffer &prepass_fb,
                                             Framebuffer &combined_fb,
                                             ...
                                             blender::gpu::Texture *radiance_behind_tx)
{
  if (closure_count_ == 0) {
    return nullptr;
  }
...
{
  blender::gpu::Texture *feedback_tx = nullptr;
...
void PlanarProbePipeline::render(View &view,
                                 blender::gpu::Texture *depth_layer_tx,
                                 Framebuffer &gbuffer_fb,
                                 Framebuffer &combined_fb,
                                 int2 extent)
{

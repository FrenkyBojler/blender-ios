...
void ShadingView::render()
{
  ...
  blender::gpu::Texture *combined_final_tx = render_postfx(rbufs.combined_tx);
...
blender::gpu::Texture *ShadingView::render_postfx(blender::gpu::Texture *input_tx)
{
  ...
  blender::gpu::Texture *output_tx = postfx_tx_;

...
class VolumeModule {
 ...
 public:
  ...
  struct {
    ...
    blender::gpu::Texture *scattering_tx_ = nullptr;
    blender::gpu::Texture *transmittance_tx_ = nullptr;
  ...
  struct {
    /** References to the textures in the module. */
    blender::gpu::Texture *scattering_tx_ = nullptr;
    blender::gpu::Texture *extinction_tx_ = nullptr;
    blender::gpu::Texture *emission_tx_ = nullptr;
    blender::gpu::Texture *phase_tx_ = nullptr;
    blender::gpu::Texture *phase_weight_tx_ = nullptr;
    blender::gpu::Texture *occupancy_tx_ = nullptr;
  ...
  struct {
    /** References to the textures in the module. */
    blender::gpu::Texture *occupancy_tx_ = nullptr;
    blender::gpu::Texture *hit_depth_tx_ = nullptr;
    blender::gpu::Texture *hit_count_tx_ = nullptr;

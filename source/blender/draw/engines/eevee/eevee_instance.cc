...
#define CHECK_PASS_EEVEE(name, type, channels, chanid) \
  ...
  CHECK_PASS_EEVEE(DENOISING_DEPTH, SOCK_FLOAT, 1, "X");
  CHECK_PASS_EEVEE(DENOISING_NORMAL, SOCK_FLOAT, 3, "XYZ");
  CHECK_PASS_EEVEE(DENOISING_ROUGHNESS, SOCK_FLOAT, 1, "X");
  CHECK_PASS_EEVEE(DENOISING_DIFFUSE_ALBEDO, SOCK_FLOAT, 3, "RGB");
  CHECK_PASS_EEVEE(DENOISING_SPECULAR_ALBEDO, SOCK_FLOAT, 3, "RGB");

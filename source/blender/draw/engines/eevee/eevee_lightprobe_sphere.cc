...
bool SphereProbeModule::ensure_atlas()
{
  ...
  if (probes_tx_.ensure_2d_array(blender::gpu::TextureFormat::SFLOAT_16_16_16_16,
...
void SphereProbeModule::ensure_cubemap_render_target(int resolution)
{
  ...
  cubemap_tx_.ensure_cube(blender::gpu::TextureFormat::SFLOAT_16_16_16_16, resolution, usage);

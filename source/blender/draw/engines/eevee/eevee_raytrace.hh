...
struct RayTraceBuffer {
  ...
  blender::gpu::Texture *feedback_ensure(bool is_dummy, int2 extent)
  {
...
class RayTraceModule {
 private:
  ...
  blender::gpu::Texture *horizon_scan_output_tx_[3] = {nullptr};
  ...
  /** Textures containing the ray hit radiance denoised (full-res). One of them is result_tx. */
  blender::gpu::Texture *denoised_spatial_tx_ = nullptr;
  blender::gpu::Texture *denoised_temporal_tx_ = nullptr;
  blender::gpu::Texture *denoised_bilateral_tx_ = nullptr;
  ...
  blender::gpu::Texture *radiance_history_tx_ = nullptr;
  blender::gpu::Texture *variance_history_tx_ = nullptr;
  blender::gpu::Texture *tilemask_history_tx_ = nullptr;
  /** Radiance input for screen space tracing. */
  blender::gpu::Texture *screen_radiance_front_tx_ = nullptr;
  blender::gpu::Texture *screen_radiance_back_tx_ = nullptr;
  ...
  blender::gpu::Texture *renderbuf_depth_view_ = nullptr;

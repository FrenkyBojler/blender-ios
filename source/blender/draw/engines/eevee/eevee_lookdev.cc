...
void LookdevModule::init(const rcti *visible_rect)
{
  ...
  if (enabled_) {
    ...
    dummy_cryptomatte_tx_.ensure_2d(
        blender::gpu::TextureFormat::SFLOAT_32_32_32_32, extent_dummy, usage);
    dummy_aov_color_tx_.ensure_2d_array(
        blender::gpu::TextureFormat::SFLOAT_16_16_16_16, extent_dummy, 1, usage);
    dummy_aov_value_tx_.ensure_2d_array(
        blender::gpu::TextureFormat::SFLOAT_16, extent_dummy, 1, usage);
  }
}
...
void LookdevModule::sync()
{
  ...
  const blender::gpu::TextureFormat color_format = blender::gpu::TextureFormat::SFLOAT_16_16_16_16;

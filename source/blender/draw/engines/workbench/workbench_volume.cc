...
void VolumePass::sync(SceneResources &resources)
{
  ...
  dummy_shadow_tx_.ensure_3d(blender::gpu::TextureFormat::UNORM_8_8_8_8,
                             int3(1),
                             GPU_TEXTURE_USAGE_SHADER_READ,
                             float4(1));
  dummy_volume_tx_.ensure_3d(blender::gpu::TextureFormat::UNORM_8_8_8_8,
                             int3(1),
                             GPU_TEXTURE_USAGE_SHADER_READ,
                             float4(0));
  dummy_coba_tx_.ensure_1d(
      blender::gpu::TextureFormat::UNORM_8_8_8_8, 1, GPU_TEXTURE_USAGE_SHADER_READ, float4(0));
}

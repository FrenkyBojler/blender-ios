...
{
  smaa_search_tx_.ensure_2d(blender::gpu::TextureFormat::UNORM_8,
  ...
  smaa_area_tx_.ensure_2d(blender::gpu::TextureFormat::UNORM_8_8,
...
void AntiAliasingPass::sync(const SceneState &scene_state, SceneResources &resources)
{
  ...
  taa_accumulation_tx_.ensure_2d(blender::gpu::TextureFormat::SFLOAT_16_16_16_16,
                                 scene_state.resolution,
                                 GPU_TEXTURE_USAGE_SHADER_READ | GPU_TEXTURE_USAGE_ATTACHMENT);
  sample0_depth_tx_.ensure_2d(blender::gpu::TextureFormat::SFLOAT_32_DEPTH_UINT_8,
                              scene_state.resolution,
                              GPU_TEXTURE_USAGE_SHADER_READ | GPU_TEXTURE_USAGE_ATTACHMENT);
  ...
  if (scene_state.samples_len > 1) {
    if (scene_state.sample == 0) {
      ...
      if (resources.depth_in_front_tx.is_valid()) {
        sample0_depth_in_front_tx_.ensure_2d(blender::gpu::TextureFormat::SFLOAT_32_DEPTH_UINT_8,
                                             scene_state.resolution,

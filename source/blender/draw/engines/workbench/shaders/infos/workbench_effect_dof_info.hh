...
GPU_SHADER_CREATE_INFO(workbench_effect_dof_samplers_input_coc)
SAMPLER(0, FLOAT_2D, inputCocTex)
GPU_SHADER_CREATE_END()

GPU_SHADER_CREATE_INFO(workbench_effect_dof_samplers_scene_color)
SAMPLER(1, FLOAT_2D, sceneColorTex)
GPU_SHADER_CREATE_END()

GPU_SHADER_CREATE_INFO(workbench_effect_dof_samplers_scene_depth)
SAMPLER(2, FLOAT_2D, sceneDepthTex)
GPU_SHADER_CREATE_END()

GPU_SHADER_CREATE_INFO(workbench_effect_dof_samplers_half_res_color)
SAMPLER(3, FLOAT_2D, halfResColorTex)
GPU_SHADER_CREATE_END()

GPU_SHADER_CREATE_INFO(workbench_effect_dof_samplers_blur)
SAMPLER(4, FLOAT_2D, blurTex)
GPU_SHADER_CREATE_END()

GPU_SHADER_CREATE_INFO(workbench_effect_dof_samplers_noise)
...
ADDITIONAL_INFO(workbench_effect_dof_samplers_scene_color)
ADDITIONAL_INFO(workbench_effect_dof_samplers_scene_depth)
...
ADDITIONAL_INFO(workbench_effect_dof)
ADDITIONAL_INFO(workbench_effect_dof_samplers_input_coc)
ADDITIONAL_INFO(workbench_effect_dof_samplers_scene_color)
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()
...
ADDITIONAL_INFO(workbench_effect_dof)
ADDITIONAL_INFO(workbench_effect_dof_samplers_input_coc)
ADDITIONAL_INFO(workbench_effect_dof_samplers_half_res_color)
ADDITIONAL_INFO(workbench_effect_dof_samplers_noise)
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()
...
ADDITIONAL_INFO(workbench_effect_dof)
ADDITIONAL_INFO(workbench_effect_dof_samplers_input_coc)
ADDITIONAL_INFO(workbench_effect_dof_samplers_blur)
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()

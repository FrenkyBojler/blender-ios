...
/** Returns true when version cycle is alpha, otherwise (beta, rc, release) returns false. */
bool BKE_blender_version_is_alpha(void);
/** Returns true when version cycle is release, otherwise (alpha, beta, rc) returns false. */

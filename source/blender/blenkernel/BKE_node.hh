...
using bNodeClassCallback = void (*)(void *calldata, NodeClass nclass, StringRefNull name);
 ...
 */
void node_type_base(bNodeType *ntype, int type, StringRefNull name, NodeClass nclass);

...
struct PixelNode {
  ...
  struct {
     ...
     */
    Array<float3x3> pixel_to_position;
  } uv_primitives;
...
struct CopyPixelTile {
  ...
  /** For each seam tile, the contiguous range into #groups that it contains. */
...
void copy_pixels(bke::pbvh::Tree &pbvh,
                 ...
                 FunctionRef<void(int x0, int x1, int y)> push_undo_tiles);

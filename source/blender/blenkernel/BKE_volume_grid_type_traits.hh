...
template<typename T> struct VolumeGridTraits {
   ...
   */
  static constexpr VolumeGridType enum_type = VolumeGridUnknown;
};
...
template<> struct VolumeGridTraits<bool> {
  ...
  static constexpr VolumeGridType enum_type = VolumeGridBoolean;
...
template<> struct VolumeGridTraits<int> {
  ...
  static constexpr VolumeGridType enum_type = VolumeGridInt;
...
template<> struct VolumeGridTraits<float> {
  ...
  static constexpr VolumeGridType enum_type = VolumeGridFloat;
...
template<> struct VolumeGridTraits<float3> {
  ...
  static constexpr VolumeGridType enum_type = VolumeGridVectorFloat;

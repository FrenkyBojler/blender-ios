...
class GeometryFieldContext : public fn::FieldContext {
 ...
 public:
  ...
  {
    BLI_assume_assert(this->type_ == GeometryComponent::Type::GreasePencil);
    BLI_assume_assert(ELEM(this->domain_, AttrDomain::Layer, AttrDomain::Curve, AttrDomain::Point));

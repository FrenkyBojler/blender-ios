...
class bNodeTreeRuntime : NonCopyable, NonMovable {
 public:
  ...
  /** Contains RNA types generated for the scene compositor modifier interface. */
  std::shared_ptr<nodes::GeneratedTreeSrnaData> scene_compositor_modifier_srna_data;

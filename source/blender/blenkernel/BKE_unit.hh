...
enum {
  ...
  B_UNIT_POWER = 11,
  /* Radiometric units. */
  B_UNIT_RADIOMETRIC_POWER = 12,
  B_UNIT_RADIOMETRIC_INTENSITY = 13,
  B_UNIT_RADIOMETRIC_IRRADIANCE = 14,
  B_UNIT_RADIOMETRIC_RADIOSITY = 15,
  B_UNIT_RADIOMETRIC_RADIANCE = 16,
  /* Photometric units. */
  B_UNIT_PHOTOMETRIC_POWER = 17,
  B_UNIT_PHOTOMETRIC_INTENSITY = 18,
  B_UNIT_PHOTOMETRIC_ILLUMINANCE = 19,
  B_UNIT_PHOTOMETRIC_LUMINOUS_EXITANCE = 20,
  B_UNIT_PHOTOMETRIC_LUMINANCE = 21,
  /* Others. */
  B_UNIT_TEMPERATURE = 22,
  B_UNIT_WAVELENGTH = 23,
  B_UNIT_COLOR_TEMPERATURE = 24,
  B_UNIT_FREQUENCY = 25,
  B_UNIT_TYPE_TOT = 26,
};

...
{
  ImBuf *grayscale = IMB_allocImBuf(ibuf->x, ibuf->y, ImColorMode::RGBA, 0);
...
{
  ImBuf *ibuf = IMB_allocImBuf(float_image->width, float_image->height, ImColorMode::RGBA, 0);
                                ...
                                const libmv_FrameTransform *transform)
{
  ...
  if (region != nullptr) {
    ...
    final_ibuf = IMB_allocImBuf(width, height, ImColorMode::RGBA, IB_float_data);

...
static int customData_pad_to_alignment(int value, int alignment)
{
...
static void customData_update_offsets(CustomData *data)
{
  ...
  for (int i = 0; i < data->totlayer; i++) {
    ...
    offset = customData_pad_to_alignment(offset, typeInfo->alignment);
  ...
  data->totsize = customData_pad_to_alignment(offset, max_alignment);

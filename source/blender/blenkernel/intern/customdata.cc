...
const CustomData_MeshMasks CD_MASK_MESH = {
    ...
    .fmask = 0,
    .pmask = CD_MASK_PROP_ALL,
    .lmask = (CD_MASK_MDISPS | CD_MASK_GRID_PAINT_MASK | CD_MASK_PROP_ALL),
};
const CustomData_MeshMasks CD_MASK_DERIVEDMESH = {
    .vmask = (CD_MASK_ORIGINDEX | CD_MASK_MDEFORMVERT | CD_MASK_SHAPEKEY | CD_MASK_MVERT_SKIN |
              CD_MASK_ORCO | CD_MASK_CLOTH_ORCO | CD_MASK_PROP_ALL),
    .emask = (CD_MASK_ORIGINDEX | CD_MASK_PROP_ALL),
    .fmask = (CD_MASK_ORIGINDEX | CD_MASK_ORIGSPACE),
    .pmask = (CD_MASK_ORIGINDEX | CD_MASK_PROP_ALL),
    .lmask = (CD_MASK_ORIGSPACE_MLOOP |
...
const CustomData_MeshMasks CD_MASK_EVERYTHING = {
    .vmask = (CD_MASK_BM_ELEM_PYPTR | CD_MASK_ORIGINDEX | CD_MASK_MDEFORMVERT |
              ...
              CD_MASK_SHAPE_KEYINDEX | CD_MASK_PROP_ALL),
    .emask = (CD_MASK_BM_ELEM_PYPTR | CD_MASK_ORIGINDEX | CD_MASK_PROP_ALL),
    ...
    .pmask = (CD_MASK_BM_ELEM_PYPTR | CD_MASK_ORIGINDEX | CD_MASK_PROP_ALL),
    .lmask = (CD_MASK_BM_ELEM_PYPTR | CD_MASK_MDISPS | CD_MASK_NORMAL | CD_MASK_MLOOPTANGENT |

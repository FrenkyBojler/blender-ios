...
static void scene_blend_write(BlendWriter *writer, ID *id, const void *id_address)
{
  ...
  /* In 5.0 we intend to change the uvsculpt.size value from representing radius to representing
   * diameter. This and the corresponding code in `scene_blend_read_data` should be removed once

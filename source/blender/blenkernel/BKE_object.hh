...
void BKE_object_protected_rotation_quaternion_set(Object *ob, float quat[4]);
/** Sets the euler rotation of the object, respecting #Object::protectflag. */
void BKE_object_protected_rotation_euler_set(Object *ob, float euler[3]);
/** Sets the quaternion rotation of the object, respecting #Object::protectflag. */
void BKE_object_protected_rotation_axisangle_set(Object *ob, float axis[3], float angle);

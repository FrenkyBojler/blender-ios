...
static OperatorStatus mesh_bisect_exec(bContext *C, wmOperator *op);
...
static OperatorStatus mesh_bisect_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus mesh_bisect_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  wmGesture *gesture = static_cast<wmGesture *>(op->customdata);
...
static OperatorStatus mesh_bisect_exec(bContext *C, wmOperator *op)
{
  ...
  OperatorStatus ret = OPERATOR_CANCELLED;

...
static OperatorStatus add_primitive_cube_gizmo_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus add_primitive_cube_gizmo_invoke(bContext *C,
                                                      wmOperator *op,
                                                      const wmEvent * /*event*/)
{
  View3D *v3d = CTX_wm_view3d(C);

  OperatorStatus ret = add_primitive_cube_gizmo_exec(C, op);

...
/* bevel! yay!! */
static OperatorStatus edbm_bevel_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus edbm_bevel_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus edbm_bevel_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  BevelData *opdata = static_cast<BevelData *>(op->customdata);

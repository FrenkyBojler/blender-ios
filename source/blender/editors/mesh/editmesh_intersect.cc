...
static OperatorStatus edbm_intersect_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus edbm_intersect_boolean_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus edbm_face_split_by_edges_exec(bContext *C, wmOperator * /*op*/)
{

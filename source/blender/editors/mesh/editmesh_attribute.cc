...
static OperatorStatus mesh_set_attribute_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus mesh_set_attribute_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{

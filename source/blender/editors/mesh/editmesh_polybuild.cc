...
static OperatorStatus edbm_polybuild_transform_at_cursor_invoke(bContext *C,
                                                                wmOperator * /*op*/,
                                                                const wmEvent * /*event*/)
{
  Base *basact = nullptr;
...
static OperatorStatus edbm_polybuild_delete_at_cursor_invoke(bContext *C,
                                                             wmOperator *op,
                                                             const wmEvent * /*event*/)
{
  bool changed = false;
...
static OperatorStatus edbm_polybuild_face_at_cursor_invoke(bContext *C,
                                                           wmOperator *op,
                                                           const wmEvent *event)
{
  float center[3];
...
static OperatorStatus edbm_polybuild_split_at_cursor_invoke(bContext *C,
                                                            wmOperator * /*op*/,
                                                            const wmEvent *event)
{
  float center[3];
...
static OperatorStatus edbm_polybuild_dissolve_at_cursor_invoke(bContext *C,
                                                               wmOperator *op,
                                                               const wmEvent * /*event*/)
{
  bool changed = false;

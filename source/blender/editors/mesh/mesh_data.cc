...
static OperatorStatus mesh_uv_texture_add_exec(bContext *C, wmOperator *op)
{
  Object *ob = blender::ed::object::context_object(C);
  Mesh *mesh = static_cast<Mesh *>(ob->data);
...
static OperatorStatus mesh_uv_texture_remove_exec(bContext *C, wmOperator *op)
{
  Object *ob = blender::ed::object::context_object(C);
  Mesh *mesh = static_cast<Mesh *>(ob->data);
...
static OperatorStatus mesh_customdata_clear_exec__internal(bContext *C,
                                                           char htype,
...
static OperatorStatus mesh_customdata_mask_clear_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus mesh_customdata_skin_add_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = blender::ed::object::context_object(C);
  Mesh *mesh = static_cast<Mesh *>(ob->data);
...
static OperatorStatus mesh_customdata_skin_clear_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus mesh_customdata_custom_splitnormals_add_exec(bContext *C,
                                                                   wmOperator * /*op*/)
{
  using namespace blender;
  Mesh *mesh = ED_mesh_context(C);
...
static OperatorStatus mesh_customdata_custom_splitnormals_clear_exec(bContext *C,
                                                                     wmOperator * /*op*/)
{
  Mesh *mesh = ED_mesh_context(C);

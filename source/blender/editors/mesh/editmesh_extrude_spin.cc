...
static OperatorStatus edbm_spin_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus edbm_spin_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
  ...
  OperatorStatus ret = edbm_spin_exec(C, op);

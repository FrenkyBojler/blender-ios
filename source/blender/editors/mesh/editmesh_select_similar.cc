 ...
 *  -SIMFACE_PERIMETER
 */
static OperatorStatus similar_face_select_exec(bContext *C, wmOperator *op)
{
 ...
 *  -SIMEDGE_FACE_ANGLE
 */
static OperatorStatus similar_edge_select_exec(bContext *C, wmOperator *op)
{
  const Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
...
static OperatorStatus similar_vert_select_exec(bContext *C, wmOperator *op)
{
  const Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
...
static OperatorStatus edbm_select_similar_exec(bContext *C, wmOperator *op)
{

 ...
 *
 * This extra check avoids more complex errors check can cause mesh corruption, see #160546.
 */
  ...
  BM_ITER_MESH (e, &iter, bm, BM_EDGES_OF_MESH) {
    ...
    if (faces_tagged == 1) {
      ...
      for (int i = 0; i < 2; i++) {
        ...
        /* There is no need to check for 1 - it would return false but as
         * all the edges are from face-boundaries, they  */

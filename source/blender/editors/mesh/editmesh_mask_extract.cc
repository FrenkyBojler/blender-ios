...
static OperatorStatus geometry_extract_apply(bContext *C,
                                             wmOperator *op,
...
static OperatorStatus paint_mask_extract_exec(bContext *C, wmOperator *op)
{
  Object *ob = CTX_data_active_object(C);
  Mesh *mesh = static_cast<Mesh *>(ob->data);
...
static OperatorStatus paint_mask_extract_invoke(bContext *C, wmOperator *op, const wmEvent *e)
{
...
static OperatorStatus face_set_extract_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus paint_mask_slice_exec(bContext *C, wmOperator *op)
{

...
static OperatorStatus edbm_shortest_path_pick_exec(bContext *C, wmOperator *op);
...
static OperatorStatus edbm_shortest_path_pick_invoke(bContext *C,
                                                     wmOperator *op,
                                                     const wmEvent *event)
{
...
static OperatorStatus edbm_shortest_path_select_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);

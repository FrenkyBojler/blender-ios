...
static OperatorStatus gpencil_data_add_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus gpencil_data_unlink_exec(bContext *C, wmOperator *op)
{
  bGPdata **gpd_ptr = ED_annotation_data_get_pointers(C, nullptr);
...
static OperatorStatus gpencil_layer_add_exec(bContext *C, wmOperator *op)
{
  PointerRNA gpd_owner = {};
  Main *bmain = CTX_data_main(C);
  bGPdata *gpd = nullptr;
...
static OperatorStatus gpencil_layer_remove_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus gpencil_layer_move_exec(bContext *C, wmOperator *op)
{
  bGPdata *gpd = ED_annotation_data_get_active(C);
  bGPDlayer *gpl = BKE_gpencil_layer_active_get(gpd);

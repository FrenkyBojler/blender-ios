...
static OperatorStatus wm_ply_export_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
...
static OperatorStatus wm_ply_export_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus wm_ply_import_exec(bContext *C, wmOperator *op)
{

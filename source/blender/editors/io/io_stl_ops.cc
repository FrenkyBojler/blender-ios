...
static OperatorStatus wm_stl_export_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
...
static OperatorStatus wm_stl_export_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus wm_stl_import_exec(bContext *C, wmOperator *op)
{

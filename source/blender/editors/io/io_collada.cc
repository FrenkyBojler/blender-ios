...
static OperatorStatus wm_collada_export_invoke(bContext *C,
                                               wmOperator *op,
                                               const wmEvent * /*event*/)
{
...
static OperatorStatus wm_collada_export_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus wm_collada_import_exec(bContext *C, wmOperator *op)
{
  char filepath[FILE_MAX];
  int import_units;
  int find_chains;

...
static OperatorStatus grease_pencil_import_svg_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus grease_pencil_export_svg_invoke(bContext *C,
                                                      wmOperator *op,
                                                      const wmEvent * /*event*/)
{
...
static OperatorStatus grease_pencil_export_svg_exec(bContext *C, wmOperator *op)
{
  using blender::io::grease_pencil::ExportParams;
  using blender::io::grease_pencil::IOContext;
...
static OperatorStatus grease_pencil_export_pdf_invoke(bContext *C,
                                                      wmOperator *op,
                                                      const wmEvent * /*event*/)
{
...
static OperatorStatus grease_pencil_export_pdf_exec(bContext *C, wmOperator *op)
{
  using blender::io::grease_pencil::ExportParams;
  using blender::io::grease_pencil::IOContext;

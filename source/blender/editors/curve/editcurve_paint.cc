...
static OperatorStatus curve_draw_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus curve_draw_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus curve_draw_modal(bContext *C, wmOperator *op, const wmEvent *event)
{

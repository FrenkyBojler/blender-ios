...
static OperatorStatus de_select_first_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus de_select_last_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus de_select_all_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus select_linked_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
...
static OperatorStatus select_row_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus select_next_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
  Vector<Object *> objects = BKE_view_layer_array_from_objects_in_edit_mode_unique_data(
...
static OperatorStatus select_previous_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
  Vector<Object *> objects = BKE_view_layer_array_from_objects_in_edit_mode_unique_data(
...
static OperatorStatus curve_select_more_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
  Vector<Object *> objects = BKE_view_layer_array_from_objects_in_edit_mode_unique_data(
...
static OperatorStatus curve_select_less_exec(bContext *C, wmOperator * /*op*/)
{
  const Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
  Vector<Object *> objects = BKE_view_layer_array_from_objects_in_edit_mode_unique_data(
...
static OperatorStatus curve_select_random_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus select_nth_exec(bContext *C, wmOperator *op)
{
  const Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
...
static OperatorStatus curve_select_similar_exec(bContext *C, wmOperator *op)
{
  /* Get props. */
...
static OperatorStatus edcu_shortest_path_pick_invoke(bContext *C,
                                                     wmOperator *op,
                                                     const wmEvent *event)
{
  Depsgraph *depsgraph = CTX_data_ensure_evaluated_depsgraph(C);

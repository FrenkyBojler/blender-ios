                                             ...
                                             bool *r_search_abandoned)
{
  ...
  uint8_t (*cur)[2] = static_cast<uint8_t (*)[2]>(MEM_mallocN(min * sizeof(*cur), __func__));
  uint8_t (*domains)[BDS] = static_cast<uint8_t (*)[8]>(
      MEM_mallocN(min * min * sizeof(*domains), __func__));

                               ...
                               int final)
{
  ...
  if (!final) {
    ...
    preview->preview_stitchable = static_cast<float *>(MEM_mallocN(
        preview->num_stitchable * sizeof(float) * preview_size, "stitch_preview_stitchable_data"));
    preview->preview_unstitchable = static_cast<float *>(
        MEM_mallocN(preview->num_unstitchable * sizeof(float) * preview_size,

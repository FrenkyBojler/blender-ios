...
static OperatorStatus stitch_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
...
static OperatorStatus stitch_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus stitch_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  StitchStateContainer *ssc;
  Scene *scene = CTX_data_scene(C);

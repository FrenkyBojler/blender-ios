...
static OperatorStatus nlaedit_enable_tweakmode_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_disable_tweakmode_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_previewrange_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
  Scene *scene;
  float min, max;
...
static OperatorStatus nlaedit_viewall(bContext *C, const bool only_sel)
{
  bAnimContext ac;
  View2D *v2d;
  float extra;
...
static OperatorStatus nlaedit_viewall_exec(bContext *C, wmOperator * /*op*/)
{
  /* whole range */
  return nlaedit_viewall(C, false);
}

static OperatorStatus nlaedit_viewsel_exec(bContext *C, wmOperator * /*op*/)
{
  /* only selected */
...
static OperatorStatus nlaedit_viewframe_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus nlaedit_add_actionclip_invoke(bContext *C,
                                                    wmOperator *op,
                                                    const wmEvent *event)
{
  /* Get editor data. */
...
static OperatorStatus nlaedit_add_actionclip_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus nlaedit_add_transition_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_add_sound_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  bAnimContext ac;
...
/* add the specified action as new strip */
static OperatorStatus nlaedit_add_meta_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_remove_meta_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_duplicate_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_duplicate_invoke(bContext *C,
                                               wmOperator *op,
                                               const wmEvent * /*event*/)
{
...
static OperatorStatus nlaedit_delete_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_split_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_toggle_mute_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_swap_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_move_up_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_move_down_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_sync_actlen_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_make_single_user_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  bAnimContext ac;
...
static OperatorStatus nlaedit_make_single_user_invoke(bContext *C,
                                                      wmOperator *op,
                                                      const wmEvent * /*event*/)
{
...
static OperatorStatus nlaedit_apply_scale_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  bAnimContext ac;
...
static OperatorStatus nlaedit_clear_scale_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus nlaedit_snap_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus nla_fmodifier_add_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus nla_fmodifier_copy_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  ListBase anim_data = {nullptr, nullptr};
  bool ok = false;
...
static OperatorStatus nla_fmodifier_paste_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  ListBase anim_data = {nullptr, nullptr};
  int ok = 0;

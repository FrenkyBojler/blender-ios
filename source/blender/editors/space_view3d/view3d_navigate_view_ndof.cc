 ...
 */
static OperatorStatus view3d_ndof_cameraview_pan_zoom(ViewOpsData *vod,
...
static OperatorStatus ndof_orbit_invoke_impl(bContext *C,
                                             ViewOpsData *vod,
                                             const wmEvent *event,
                                             PointerRNA * /*ptr*/)
{
...
static OperatorStatus ndof_orbit_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  if (event->type != NDOF_MOTION) {
    return OPERATOR_CANCELLED;
  }
...
static OperatorStatus ndof_orbit_zoom_invoke_impl(bContext *C,
                                                  ViewOpsData *vod,
                                                  const wmEvent *event,
                                                  PointerRNA * /*ptr*/)
{
  ...
  if (U.ndof_flag & NDOF_CAMERA_PAN_ZOOM) {
    const OperatorStatus camera_retval = view3d_ndof_cameraview_pan_zoom(vod, ndof);
...
static OperatorStatus ndof_orbit_zoom_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  if (event->type != NDOF_MOTION) {
    return OPERATOR_CANCELLED;
  }
...
static OperatorStatus ndof_pan_invoke_impl(bContext *C,
                                           ViewOpsData *vod,
                                           const wmEvent *event,
                                           PointerRNA * /*ptr*/)
{
...
static OperatorStatus ndof_pan_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  if (event->type != NDOF_MOTION) {
    return OPERATOR_CANCELLED;
  }
 ...
 */
static OperatorStatus ndof_all_invoke_impl(bContext *C,
                                           ViewOpsData *vod,
                                           const wmEvent *event,
                                           PointerRNA * /*ptr*/)
{
...
static OperatorStatus ndof_all_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  if (event->type != NDOF_MOTION) {
    return OPERATOR_CANCELLED;
  }

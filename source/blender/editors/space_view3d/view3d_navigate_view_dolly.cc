...
static OperatorStatus viewdolly_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus viewdolly_exec(bContext *C, wmOperator *op)
{
  View3D *v3d;
  RegionView3D *rv3d;
  ScrArea *area;
...
static OperatorStatus viewdolly_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{

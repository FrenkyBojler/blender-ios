...
static OperatorStatus snap_sel_to_grid_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus snap_selected_to_cursor_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus snap_selected_to_active_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus snap_curs_to_grid_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
  ARegion *region = CTX_wm_region(C);
  View3D *v3d = CTX_wm_view3d(C);
...
static OperatorStatus snap_curs_to_sel_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
  const int pivot_point = scene->toolsettings->transform_pivot_point;
...
static OperatorStatus snap_curs_to_active_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus snap_curs_to_center_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);

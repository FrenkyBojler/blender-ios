...
static OperatorStatus viewrotate_modal_impl(bContext *C,
                                            ViewOpsData *vod,
...
static OperatorStatus viewrotate_invoke_impl(bContext * /*C*/,
                                             ViewOpsData *vod,
                                             const wmEvent *event,
                                             PointerRNA * /*ptr*/)
{
...
static OperatorStatus viewrotate_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{

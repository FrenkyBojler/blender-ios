...
static OperatorStatus viewmove_modal_impl(bContext *C,
                                          ViewOpsData *vod,
...
static OperatorStatus viewmove_invoke_impl(bContext * /*C*/,
                                           ViewOpsData *vod,
                                           const wmEvent *event,
                                           PointerRNA * /*ptr*/)
{
...
static OperatorStatus viewmove_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{

...
static OperatorStatus flyEnd(bContext *C, FlyInfo *fly)
{
  wmWindow *win;
  RegionView3D *rv3d;
...
static OperatorStatus fly_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus fly_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  OperatorStatus exit_code;
  bool do_draw = false;
  FlyInfo *fly = static_cast<FlyInfo *>(op->customdata);
  View3D *v3d = fly->v3d;
  RegionView3D *rv3d = fly->rv3d;

...
struct ViewOpsType {
  ...
  OperatorStatus (*init_fn)(bContext *C, ViewOpsData *vod, const wmEvent *event, PointerRNA *ptr);
  OperatorStatus (*apply_fn)(bContext *C,
                             ViewOpsData *vod,
...
OperatorStatus view3d_navigate_invoke_impl(bContext *C,
                                           wmOperator *op,
                                           const wmEvent *event,
                                           const ViewOpsType *nav_type);
OperatorStatus view3d_navigate_modal_fn(bContext *C, wmOperator *op, const wmEvent *event);

...
static OperatorStatus view_lock_clear_exec(bContext *C, wmOperator * /*op*/)
{
  View3D *v3d = CTX_wm_view3d(C);
...
static OperatorStatus view_lock_to_active_exec(bContext *C, wmOperator * /*op*/)
{
  View3D *v3d = CTX_wm_view3d(C);
...
static OperatorStatus view3d_center_camera_exec(bContext *C, wmOperator * /*op*/)
{
  Depsgraph *depsgraph = CTX_data_ensure_evaluated_depsgraph(C);
...
static OperatorStatus view3d_center_lock_exec(bContext *C, wmOperator * /*op*/)
{
  RegionView3D *rv3d = CTX_wm_region_view3d(C);
...
static OperatorStatus view3d_zoom_1_to_1_camera_exec(bContext *C, wmOperator * /*op*/)
{
  Depsgraph *depsgraph = CTX_data_ensure_evaluated_depsgraph(C);
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus viewpersportho_exec(bContext *C, wmOperator * /*op*/)
{
  View3D *v3d;
  ARegion *region;
  RegionView3D *rv3d;
...
static OperatorStatus view3d_navigate_invoke(bContext *C,
                                             wmOperator * /*op*/,
                                             const wmEvent *event)
{
...
static OperatorStatus camera_background_image_add_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus camera_background_image_remove_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus drop_world_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus view3d_clipping_exec(bContext *C, wmOperator *op)
{
  ARegion *region = CTX_wm_region(C);
  RegionView3D *rv3d = CTX_wm_region_view3d(C);
  rcti rect;
...
static OperatorStatus view3d_clipping_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  RegionView3D *rv3d = CTX_wm_region_view3d(C);
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus view3d_cursor3d_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus toggle_shading_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  View3D *v3d = CTX_wm_view3d(C);
...
static OperatorStatus toggle_xray_exec(bContext *C, wmOperator *op)
{
  View3D *v3d = CTX_wm_view3d(C);
  ScrArea *area = CTX_wm_area(C);
  Object *obact = CTX_data_active_object(C);

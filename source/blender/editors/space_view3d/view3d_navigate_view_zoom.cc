...
static OperatorStatus viewzoom_modal_impl(bContext *C,
                                          ViewOpsData *vod,
...
static OperatorStatus viewzoom_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus viewzoom_invoke_impl(bContext *C,
                                           ViewOpsData *vod,
                                           const wmEvent *event,
                                           PointerRNA *ptr)
{
...
static OperatorStatus viewzoom_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{

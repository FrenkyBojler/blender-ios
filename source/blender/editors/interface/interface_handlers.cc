 ...
 */
static void ui_textedit_set_cursor_pos(Button *but, const ARegion *region, const float2 xy)
{
...
static void ui_textedit_set_cursor_select(Button *but, HandleButtonData *data, const float2 xy)
{

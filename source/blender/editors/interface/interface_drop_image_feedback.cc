 ...
 */
static std::string DROP_IMAGE_tooltip_node_editor(bContext *C, const char *filename)
{
  ...
  if (snode && snode->edittree) {
    blender::float2 cursor_pos = snode->runtime->cursor * UI_SCALE_FAC;
 ...
 */
static std::string DROP_IMAGE_tooltip_view3d(bContext *C, const char *filename, const char *op_idname)
{
 ...
 */
static std::string DROP_IMAGE_tooltip_properties(bContext *C, const char *filename, const char *op_idname)
{
  static char tooltip[256] = "";
 ...
 */
static std::string DROP_IMAGE_tooltip_image_editor(bContext *C, const char *filename, const char *op_idname)
{
  static char tooltip[256] = "";
...
void DROP_IMAGE_update_texture_preview(bContext *C, Main *bmain, Tex *tex, bool force_update)
{
  ...
  UI_icon_render_id(C, nullptr, &tex->id, ICON_SIZE_PREVIEW, true);

 ...
 */
bool determine_texture_slot_type(const uiBut *but, const Brush *brush, bool *r_use_mask_slot, bContext *C = nullptr);
 ...
 */
bool DROP_IMAGE_is_valid_brush_texture_property(const uiBut *but, bContext *C);
 ...
 */
bool DROP_IMAGE_can_drop_on_button(const uiBut *but, const TextureDropContext *context);
 ...
 * @return true if slot type was successfully determined
 */
bool determine_texture_slot_type(const uiBut *but, const Brush *brush, bool *r_use_mask_slot, bContext *C);

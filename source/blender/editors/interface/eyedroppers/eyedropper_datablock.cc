...
static OperatorStatus datadropper_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
...
/* Modal Operator init */
static OperatorStatus datadropper_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
  /* init */
...
/* Repeat operator */
static OperatorStatus datadropper_exec(bContext *C, wmOperator *op)
{
  /* init */
  if (datadropper_init(C, op)) {
    /* cleanup */

...
static OperatorStatus view_pan_exec(bContext *C, wmOperator *op)
{
  view_pan_init(C, op);
  view_pan_apply(C, op);
  view_pan_exit(op);
...
static OperatorStatus view_pan_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus view_pan_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  v2dViewPanData *vpd = static_cast<v2dViewPanData *>(op->customdata);
  View2D *v2d = vpd->v2d;
...
/* set up modal operator and relevant settings */
static OperatorStatus view_edge_pan_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
...
static OperatorStatus view_edge_pan_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  View2DEdgePanData *vpd = static_cast<View2DEdgePanData *>(op->customdata);
...
static OperatorStatus view_scrollright_exec(bContext *C, wmOperator *op)
{
...
/* this operator only needs this single callback, where it calls the view_pan_*() methods */
static OperatorStatus view_scrollleft_exec(bContext *C, wmOperator *op)
{
  /* initialize default settings (and validate if ok to run) */
  view_pan_init(C, op);
...
/* this operator only needs this single callback, where it calls the view_pan_*() methods */
static OperatorStatus view_scrolldown_exec(bContext *C, wmOperator *op)
{
  /* initialize default settings (and validate if ok to run) */
  view_pan_init(C, op);
...
/* this operator only needs this single callback, where it calls the view_pan_*() methods */
static OperatorStatus view_scrollup_exec(bContext *C, wmOperator *op)
{
  /* initialize default settings (and validate if ok to run) */
  view_pan_init(C, op);
...
static OperatorStatus view_zoomin_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus view_zoomin_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  view_zoomdrag_init(C, op);
...
/* this operator only needs this single callback, where it calls the view_zoom_*() methods */
static OperatorStatus view_zoomout_exec(bContext *C, wmOperator *op)
{
  bool do_zoom_xy[2];
...
static OperatorStatus view_zoomout_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  view_zoomdrag_init(C, op);
...
/* for 'redo' only, with no user input */
static OperatorStatus view_zoomdrag_exec(bContext *C, wmOperator *op)
{
  view_zoomdrag_init(C, op);
...
/* set up modal operator and relevant settings */
static OperatorStatus view_zoomdrag_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  wmWindow *window = CTX_wm_window(C);
...
static OperatorStatus view_zoomdrag_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  v2dViewZoomData *vzd = static_cast<v2dViewZoomData *>(op->customdata);
  View2D *v2d = vzd->v2d;
...
static OperatorStatus view_borderzoom_exec(bContext *C, wmOperator *op)
{
  ARegion *region = CTX_wm_region(C);
  View2D *v2d = &region->v2d;
...
static OperatorStatus view2d_ndof_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus view2d_smoothview_invoke(bContext *C,
                                               wmOperator * /*op*/,
                                               const wmEvent *event)
{
  wmWindow *win = CTX_wm_window(C);
 ...
 * not in the apply callback!
 */
static OperatorStatus scroller_activate_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  v2dScrollerMove *vsm = static_cast<v2dScrollerMove *>(op->customdata);
...
static OperatorStatus scroller_activate_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  ARegion *region = CTX_wm_region(C);
  View2D *v2d = &region->v2d;
...
static OperatorStatus reset_exec(bContext *C, wmOperator * /*op*/)
{

...
void draw_pie_center(Block *block)
{
  ...
  if (pie_data.pages.size() > 1) {
    ...
    draw_roundbox_3ub_alpha(&handle_rect,
                            true,
                            8.0f,
                            btheme->tui.wcol_pie_menu.inner,
    ...
    if (active_handle != PieScrollHandle::None) {
      ...
      if (active_handle == PieScrollHandle::Left) {
        ...
        draw_roundbox_corner_set(CNR_BOTTOM_LEFT | CNR_TOP_LEFT);
      }
      else if (active_handle == PieScrollHandle::Right) {
        draw_roundbox_corner_set(CNR_BOTTOM_RIGHT | CNR_TOP_RIGHT);
        rect.xmin = rect.xmax - arrow_size;
      }
      draw_roundbox_3ub_alpha(
    ...
    icon_draw_ex(handle_rect.xmax - arrow_size,
                 dot_y - arrow_size / 2,
                 ICON_TRIA_RIGHT,
                 aspect,
                 1,

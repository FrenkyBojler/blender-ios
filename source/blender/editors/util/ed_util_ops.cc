...
static OperatorStatus lib_id_load_custom_preview_exec(bContext *C, wmOperator *op)
{
 ...
 */
static OperatorStatus lib_id_load_custom_preview_invoke(bContext *C,
                                                        wmOperator *op,
                                                        const wmEvent *event)
{
...
static OperatorStatus lib_id_generate_preview_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus lib_id_generate_preview_from_object_exec(bContext *C, wmOperator * /*op*/)
{
  using namespace blender::ed;
...
static OperatorStatus lib_id_remove_preview_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus lib_id_fake_user_toggle_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus lib_id_unlink_exec(bContext *C, wmOperator *op)
{
  PropertyPointerRNA pprop;
  PointerRNA idptr;
...
static OperatorStatus lib_id_override_editable_toggle_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus ed_flush_edits_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);

...
static wmOperatorStatus new_sequencer_scene_exec(bContext *C, wmOperator *op)
{
   ...
   * resolution properties would have no effect. This logic is meant to address a temporary
   * papercut and may be removed later in 5.1+ when properties for scenes and sequencer scenes can
   * be more properly separated. */

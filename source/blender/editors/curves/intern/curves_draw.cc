...
static OperatorStatus curves_draw_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus curves_draw_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus curves_draw_modal(bContext *C, wmOperator *op, const wmEvent *event)
{

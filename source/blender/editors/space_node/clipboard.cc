...
static OperatorStatus node_clipboard_copy_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus node_clipboard_paste_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus node_clipboard_paste_invoke(bContext *C,
                                                  wmOperator *op,
                                                  const wmEvent *event)
{

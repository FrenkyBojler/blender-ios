...
static OperatorStatus node_group_edit_exec(bContext *C, wmOperator *op)
{
  SpaceNode *snode = CTX_wm_space_node(C);
...
static OperatorStatus node_group_ungroup_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus node_group_separate_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  SpaceNode *snode = CTX_wm_space_node(C);
...
static OperatorStatus node_group_separate_invoke(bContext *C,
                                                 wmOperator * /*op*/,
                                                 const wmEvent * /*event*/)
{
...
static OperatorStatus node_group_make_exec(bContext *C, wmOperator *op)
{
  SpaceNode &snode = *CTX_wm_space_node(C);
...
static OperatorStatus node_group_insert_exec(bContext *C, wmOperator *op)
{
  SpaceNode *snode = CTX_wm_space_node(C);
  bNodeTree *ntree = snode->edittree;
  const StringRef node_idname = node_group_idname(C);
...
static OperatorStatus node_default_group_width_set_exec(bContext *C, wmOperator * /*op*/)
{
  SpaceNode *snode = CTX_wm_space_node(C);
  bNodeTree *ntree = snode->edittree;

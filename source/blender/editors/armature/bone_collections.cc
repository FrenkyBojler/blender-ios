...
static OperatorStatus bone_collection_add_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus bone_collection_remove_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus bone_collection_move_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus bone_collection_assign_exec(bContext *C, wmOperator *op)
{
  Object *ob = blender::ed::object::context_object(C);
  if (ob == nullptr) {
    return OPERATOR_CANCELLED;
...
/* Assign selected pchans to the bone collection that the user selects */
static OperatorStatus bone_collection_create_and_assign_exec(bContext *C, wmOperator *op)
{
  Object *ob = blender::ed::object::context_object(C);
  if (ob == nullptr) {
    return OPERATOR_CANCELLED;
...
static OperatorStatus bone_collection_unassign_exec(bContext *C, wmOperator *op)
{
  Object *ob = blender::ed::object::context_object(C);
  if (ob == nullptr) {
    return OPERATOR_CANCELLED;
...
static OperatorStatus bone_collection_unassign_named_exec(bContext *C, wmOperator *op)
{
  Object *ob = blender::ed::object::context_object(C);
  if (ob == nullptr) {
    return OPERATOR_CANCELLED;
...
static OperatorStatus bone_collection_select_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = blender::ed::object::context_object(C);
  if (ob == nullptr) {
    return OPERATOR_CANCELLED;
...
static OperatorStatus bone_collection_deselect_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = blender::ed::object::context_object(C);
  if (ob == nullptr) {
    return OPERATOR_CANCELLED;
...
static OperatorStatus add_or_move_to_collection_exec(bContext *C,
                                                     wmOperator *op,
...
static OperatorStatus assign_to_collection_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus move_to_collection_regular_invoke(bContext *C, wmOperator *op)
{
...
static OperatorStatus move_to_new_collection_invoke(bContext *C, wmOperator *op)
{

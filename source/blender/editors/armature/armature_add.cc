                                          ...
                                          const bool view_aligned)
{
  ...
  /* Create a bone */
  bone = ED_armature_ebone_add(arm, DATA_(blender::animrig::bone_default_name));
...
EditBone *add_points_bone(Object *obedit, float head[3], float tail[3])
{
  ...
  ebo = ED_armature_ebone_add(static_cast<bArmature *>(obedit->data), DATA_(blender::animrig::bone_default_name));
...
void ARMATURE_OT_bone_primitive_add(wmOperatorType *ot)
{
  ...
  RNA_def_string(ot->srna, "name", DATA_(blender::animrig::bone_default_name), MAXBONENAME, "Name", "Name of the newly created bone");
}

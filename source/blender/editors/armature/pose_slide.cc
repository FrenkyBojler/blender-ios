 ...
 */
static OperatorStatus pose_slide_invoke_common(bContext *C, wmOperator *op, const wmEvent *event)
{
 ...
 */
static OperatorStatus pose_slide_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  tPoseSlideOp *pso = static_cast<tPoseSlideOp *>(op->customdata);
  wmWindow *win = CTX_wm_window(C);
 ...
 */
static OperatorStatus pose_slide_exec_common(bContext *C, wmOperator *op, tPoseSlideOp *pso)
{
 ...
 */
static OperatorStatus pose_slide_push_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  /* Initialize data. */
 ...
 */
static OperatorStatus pose_slide_push_exec(bContext *C, wmOperator *op)
{
  tPoseSlideOp *pso;
 ...
 */
static OperatorStatus pose_slide_relax_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  /* Initialize data. */
 ...
 */
static OperatorStatus pose_slide_relax_exec(bContext *C, wmOperator *op)
{
  tPoseSlideOp *pso;
 ...
 */
static OperatorStatus pose_slide_blend_rest_invoke(bContext *C,
                                                   wmOperator *op,
                                                   const wmEvent *event)
{
  /* Initialize data. */
 ...
 */
static OperatorStatus pose_slide_blend_rest_exec(bContext *C, wmOperator *op)
{
  tPoseSlideOp *pso;
 ...
 */
static OperatorStatus pose_slide_breakdown_invoke(bContext *C,
                                                  wmOperator *op,
                                                  const wmEvent *event)
{
  /* Initialize data. */
 ...
 */
static OperatorStatus pose_slide_breakdown_exec(bContext *C, wmOperator *op)
{
  tPoseSlideOp *pso;
...
/* ........................ */
static OperatorStatus pose_slide_blend_to_neighbors_invoke(bContext *C,
                                                           wmOperator *op,
                                                           const wmEvent *event)
{
  /* Initialize data. */
...
static OperatorStatus pose_slide_blend_to_neighbors_exec(bContext *C, wmOperator *op)
{
  tPoseSlideOp *pso;
...
static OperatorStatus pose_propagate_exec(bContext *C, wmOperator *op)
{

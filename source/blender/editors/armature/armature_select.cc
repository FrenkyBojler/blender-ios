...
static OperatorStatus armature_select_linked_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus armature_select_linked_pick_invoke(bContext *C,
                                                         wmOperator *op,
                                                         const wmEvent *event)
{
...
static OperatorStatus armature_de_select_all_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus armature_de_select_more_exec(bContext *C, wmOperator * /*op*/)
{
  const Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
  Vector<Object *> objects = BKE_view_layer_array_from_objects_in_edit_mode_unique_data(
...
static OperatorStatus armature_de_select_less_exec(bContext *C, wmOperator * /*op*/)
{
  const Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
  Vector<Object *> objects = BKE_view_layer_array_from_objects_in_edit_mode_unique_data(
...
static OperatorStatus armature_select_similar_exec(bContext *C, wmOperator *op)
{
  /* Get props */
...
static OperatorStatus armature_select_hierarchy_exec(bContext *C, wmOperator *op)
{
 ...
 */
static OperatorStatus armature_select_mirror_exec(bContext *C, wmOperator *op)
{
  const Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
...
static OperatorStatus armature_shortest_path_pick_invoke(bContext *C,
                                                         wmOperator *op,
                                                         const wmEvent *event)
{
  Object *obedit = CTX_data_edit_object(C);

...
static OperatorStatus apply_armature_pose2bones_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
...
static OperatorStatus pose_visual_transform_apply_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus pose_copy_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus pose_paste_exec(bContext *C, wmOperator *op)
{
  Object *ob = BKE_object_pose_armature_get(CTX_data_active_object(C));
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus pose_clear_transform_generic_exec(bContext *C,
                                                        wmOperator *op,
...
static OperatorStatus pose_clear_scale_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus pose_clear_rot_exec(bContext *C, wmOperator *op)
{
  return pose_clear_transform_generic_exec(
...
static OperatorStatus pose_clear_loc_exec(bContext *C, wmOperator *op)
{
  return pose_clear_transform_generic_exec(
...
static OperatorStatus pose_clear_transforms_exec(bContext *C, wmOperator *op)
{
  return pose_clear_transform_generic_exec(
...
static OperatorStatus pose_clear_user_transforms_exec(bContext *C, wmOperator *op)
{
  ViewLayer *view_layer = CTX_data_view_layer(C);
  View3D *v3d = CTX_wm_view3d(C);
  Scene *scene = CTX_data_scene(C);

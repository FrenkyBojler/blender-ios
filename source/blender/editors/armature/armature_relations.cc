...
static OperatorStatus separate_armature_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus armature_parent_set_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus armature_parent_set_invoke(bContext *C,
                                                 wmOperator * /*op*/,
                                                 const wmEvent * /*event*/)
{
...
static OperatorStatus armature_parent_clear_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus armature_parent_clear_invoke(bContext *C,
                                                   wmOperator * /*op*/,
                                                   const wmEvent * /*event*/)
{

...
static OperatorStatus poselib_blend_handle_event(bContext * /*C*/,
                                                 wmOperator *op,
                                                 const wmEvent *event)
{
  PoseBlendData *pbd = static_cast<PoseBlendData *>(op->customdata);
...
static OperatorStatus poselib_blend_exit(bContext *C, wmOperator *op)
{
  PoseBlendData *pbd = static_cast<PoseBlendData *>(op->customdata);
...
static OperatorStatus poselib_blend_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  const OperatorStatus operator_result = poselib_blend_handle_event(C, op, event);
...
/* Modal Operator init. */
static OperatorStatus poselib_blend_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
/* Single-shot apply. */
static OperatorStatus poselib_blend_exec(bContext *C, wmOperator *op)
{

...
static OperatorStatus screen_render_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus screen_render_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus screen_render_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus render_shutter_curve_preset_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);

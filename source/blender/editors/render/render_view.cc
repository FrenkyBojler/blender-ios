...
static OperatorStatus render_view_cancel_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus render_view_show_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{

...
void button_icon_decoration_number_set(Button *but, int indicator_number);
void button_icon_decoration_set(Button *but, const char *string);
void button_icon_decoration_color_set(Button *but, const uchar color[4]);

 ...
 */
void select_linked(bke::CurvesGeometry &curves, bool select = true);
void select_linked(bke::CurvesGeometry &curves, const IndexMask &curves_mask, bool select = true);

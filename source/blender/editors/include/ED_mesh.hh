...
void EDBM_mesh_make(Object *ob, int select_mode, char uv_select_sticky, bool add_key_index);
/** Replaces the edit-mesh in the object with a new one based on the given mesh. */
void EDBM_mesh_make_from_mesh(
    Object *ob, Mesh *src_mesh, int select_mode, char uv_select_sticky, bool add_key_index);
/**

...
/**
 * Start scrubbing on \a screen: pause any running animation playback (recording its settings in
 * \a resume so it can be resumed afterwards) and set the scrubbing flag.
 */
void ED_screen_scrubbing_enable(bContext *C, bScreen *screen, ScrubResumeState &resume);
/**

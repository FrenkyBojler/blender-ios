...
static OperatorStatus mask_new_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus mask_layer_new_exec(bContext *C, wmOperator *op)
{
  Mask *mask = CTX_data_edit_mask(C);
  char name[MAX_ID_NAME - 2];
...
static OperatorStatus mask_layer_remove_exec(bContext *C, wmOperator * /*op*/)
{
  Mask *mask = CTX_data_edit_mask(C);
...
static OperatorStatus slide_point_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  Mask *mask = CTX_data_edit_mask(C);
...
static OperatorStatus slide_point_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus slide_spline_curvature_invoke(bContext *C,
                                                    wmOperator *op,
                                                    const wmEvent *event)
{
  Mask *mask = CTX_data_edit_mask(C);
...
static OperatorStatus slide_spline_curvature_modal(bContext *C,
                                                   wmOperator *op,
                                                   const wmEvent *event)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus cyclic_toggle_exec(bContext *C, wmOperator * /*op*/)
{
  Mask *mask = CTX_data_edit_mask(C);
...
static OperatorStatus delete_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
...
/* *** switch direction *** */
static OperatorStatus mask_switch_direction_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
  Mask *mask = CTX_data_edit_mask(C);
...
/* *** recalc normals *** */
static OperatorStatus mask_normals_make_consistent_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
  Mask *mask = CTX_data_edit_mask(C);
...
static OperatorStatus mask_hide_view_clear_exec(bContext *C, wmOperator *op)
{
  Mask *mask = CTX_data_edit_mask(C);
  bool changed = false;
...
static OperatorStatus mask_hide_view_set_exec(bContext *C, wmOperator *op)
{
  Mask *mask = CTX_data_edit_mask(C);
...
static OperatorStatus mask_feather_weight_clear_exec(bContext *C, wmOperator * /*op*/)
{
  Mask *mask = CTX_data_edit_mask(C);
  bool changed = false;
...
static OperatorStatus mask_layer_move_exec(bContext *C, wmOperator *op)
{
  Mask *mask = CTX_data_edit_mask(C);
...
static OperatorStatus mask_duplicate_exec(bContext *C, wmOperator * /*op*/)
{
  Mask *mask = CTX_data_edit_mask(C);
...
static OperatorStatus copy_splines_exec(bContext *C, wmOperator * /*op*/)
{
  Mask *mask = CTX_data_edit_mask(C);
  MaskLayer *mask_layer = BKE_mask_layer_active(mask);
...
static OperatorStatus paste_splines_exec(bContext *C, wmOperator * /*op*/)
{
  Mask *mask = CTX_data_edit_mask(C);
  MaskLayer *mask_layer = BKE_mask_layer_active(mask);

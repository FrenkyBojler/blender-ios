...
static OperatorStatus select_exec(bContext *C, wmOperator *op)
{
  Mask *mask = CTX_data_edit_mask(C);
...
static OperatorStatus select_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  ...
  const OperatorStatus retval = select_exec(C, op);
...
static OperatorStatus clip_lasso_select_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus circle_select_exec(bContext *C, wmOperator *op)
{
  ScrArea *area = CTX_wm_area(C);
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus mask_select_linked_pick_invoke(bContext *C,
                                                     wmOperator *op,
                                                     const wmEvent *event)
{
  ScrArea *area = CTX_wm_area(C);
...
static OperatorStatus mask_select_linked_exec(bContext *C, wmOperator * /*op*/)
{
  Mask *mask = CTX_data_edit_mask(C);
...
static OperatorStatus mask_select_more_less(bContext *C, bool more)
{
  Mask *mask = CTX_data_edit_mask(C);
...
static OperatorStatus mask_select_more_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus mask_select_less_exec(bContext *C, wmOperator * /*op*/)
{

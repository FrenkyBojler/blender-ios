...
static OperatorStatus row_filter_add_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus row_filter_remove_exec(bContext *C, wmOperator *op)
{
  SpaceSpreadsheet *sspreadsheet = CTX_wm_space_spreadsheet(C);
...
static OperatorStatus select_component_domain_invoke(bContext *C,
                                                     wmOperator *op,
                                                     const wmEvent * /*event*/)
{

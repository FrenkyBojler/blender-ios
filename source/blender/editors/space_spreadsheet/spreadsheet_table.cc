                                                       ...
                                                       const SpreadsheetTableIDGeometry *table_id)
{
  ...
  writer->write_struct_array<SpreadsheetInstanceID>(table_id->instance_ids_num,
                                                    table_id->instance_ids);
  writer->write_struct_array<SpreadsheetBundlePathElem>(table_id->bundle_path_num,
                                                        table_id->bundle_path);

...
static OperatorStatus preferences_reset_default_theme_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus preferences_autoexec_add_exec(bContext * /*C*/, wmOperator * /*op*/)
{
...
static OperatorStatus preferences_autoexec_remove_exec(bContext * /*C*/, wmOperator *op)
{
...
static OperatorStatus preferences_asset_library_add_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus preferences_asset_library_add_invoke(bContext *C,
                                                           wmOperator *op,
                                                           const wmEvent * /*event*/)
{
...
static OperatorStatus preferences_asset_library_remove_exec(bContext *C, wmOperator *op)
{
  const int index = RNA_int_get(op->ptr, "index");
...
static OperatorStatus preferences_extension_repo_add_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus preferences_extension_repo_add_invoke(bContext *C,
                                                            wmOperator *op,
                                                            const wmEvent *event)
{
  const bUserExtensionRepoAddType repo_type = bUserExtensionRepoAddType(
...
static OperatorStatus preferences_extension_repo_remove_invoke(bContext *C,
                                                               wmOperator *op,
                                                               const wmEvent * /*event*/)
{
  const int index = RNA_int_get(op->ptr, "index");
...
static OperatorStatus preferences_extension_repo_remove_exec(bContext *C, wmOperator *op)
{
  const int index = RNA_int_get(op->ptr, "index");
  bool remove_files = RNA_boolean_get(op->ptr, "remove_files");
...
static OperatorStatus preferences_extension_url_drop_invoke(bContext *C,
                                                            wmOperator *op,
                                                            const wmEvent *event)
{
...
static OperatorStatus associate_blend_exec(bContext * /*C*/, wmOperator *op)
{
#ifdef __APPLE__
  UNUSED_VARS(op);
  BLI_assert_unreachable();
...
static OperatorStatus unassociate_blend_exec(bContext * /*C*/, wmOperator *op)
{
#ifdef __APPLE__
  UNUSED_VARS(op);
  BLI_assert_unreachable();

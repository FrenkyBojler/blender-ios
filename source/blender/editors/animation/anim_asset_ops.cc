...
static OperatorStatus create_pose_asset_local(bContext *C,
                                              wmOperator *op,
...
static OperatorStatus create_pose_asset_user_library(bContext *C,
                                                     wmOperator *op,
...
static OperatorStatus pose_asset_create_exec(bContext *C, wmOperator *op)
{
  char name[MAX_NAME] = "";
...
static OperatorStatus pose_asset_create_invoke(bContext *C,
                                               wmOperator *op,
                                               const wmEvent * /*event*/)
{
...
static OperatorStatus pose_asset_modify_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus pose_asset_delete_exec(bContext *C, wmOperator *op)
{
  bAction *action = get_action_of_selected_asset(C);
  if (!action) {
    return OPERATOR_CANCELLED;
...
static OperatorStatus pose_asset_delete_invoke(bContext *C,
                                               wmOperator *op,
                                               const wmEvent * /*event*/)
{
  bAction *action = get_action_of_selected_asset(C);

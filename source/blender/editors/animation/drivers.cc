...
static OperatorStatus add_driver_button_none(bContext *C, wmOperator *op, short mapping_type)
{
  PointerRNA ptr = {};
  PropertyRNA *prop = nullptr;
  int index;
...
static OperatorStatus add_driver_button_menu_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus add_driver_button_menu_invoke(bContext *C,
                                                    wmOperator *op,
                                                    const wmEvent * /*event*/)
{
  PropertyRNA *prop;
...
static OperatorStatus add_driver_button_invoke(bContext *C,
                                               wmOperator *op,
                                               const wmEvent * /*event*/)
{
  PointerRNA ptr = {};
...
static OperatorStatus remove_driver_button_exec(bContext *C, wmOperator *op)
{
  PointerRNA ptr = {};
  PropertyRNA *prop = nullptr;
  bool changed = false;
...
static OperatorStatus edit_driver_button_exec(bContext *C, wmOperator *op)
{
  PointerRNA ptr = {};
  PropertyRNA *prop = nullptr;
  int index;
...
static OperatorStatus copy_driver_button_exec(bContext *C, wmOperator *op)
{
  PointerRNA ptr = {};
  PropertyRNA *prop = nullptr;
  bool changed = false;
...
static OperatorStatus paste_driver_button_exec(bContext *C, wmOperator *op)
{
  PointerRNA ptr = {};
  PropertyRNA *prop = nullptr;
  bool changed = false;

...
static OperatorStatus particle_system_add_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus particle_system_remove_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  Object *ob = blender::ed::object::context_object(C);
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus new_particle_settings_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  ParticleSystem *psys;
...
static OperatorStatus new_particle_target_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  PointerRNA ptr = CTX_data_pointer_get_type(C, "particle_system", &RNA_ParticleSystem);
...
static OperatorStatus remove_particle_target_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  PointerRNA ptr = CTX_data_pointer_get_type(C, "particle_system", &RNA_ParticleSystem);
  ParticleSystem *psys = static_cast<ParticleSystem *>(ptr.data);
...
static OperatorStatus target_move_up_exec(bContext *C, wmOperator * /*op*/)
{
  PointerRNA ptr = CTX_data_pointer_get_type(C, "particle_system", &RNA_ParticleSystem);
  ParticleSystem *psys = static_cast<ParticleSystem *>(ptr.data);
  Object *ob = (Object *)ptr.owner_id;
...
static OperatorStatus target_move_down_exec(bContext *C, wmOperator * /*op*/)
{
  PointerRNA ptr = CTX_data_pointer_get_type(C, "particle_system", &RNA_ParticleSystem);
  ParticleSystem *psys = static_cast<ParticleSystem *>(ptr.data);
  Object *ob = (Object *)ptr.owner_id;
...
static OperatorStatus dupliob_refresh_exec(bContext *C, wmOperator * /*op*/)
{
  PointerRNA ptr = CTX_data_pointer_get_type(C, "particle_system", &RNA_ParticleSystem);
  ParticleSystem *psys = static_cast<ParticleSystem *>(ptr.data);
...
static OperatorStatus dupliob_move_up_exec(bContext *C, wmOperator * /*op*/)
{
  PointerRNA ptr = CTX_data_pointer_get_type(C, "particle_system", &RNA_ParticleSystem);
  ParticleSystem *psys = static_cast<ParticleSystem *>(ptr.data);
...
static OperatorStatus copy_particle_dupliob_exec(bContext *C, wmOperator * /*op*/)
{
  PointerRNA ptr = CTX_data_pointer_get_type(C, "particle_system", &RNA_ParticleSystem);
  ParticleSystem *psys = static_cast<ParticleSystem *>(ptr.data);
  ParticleSettings *part;
...
static OperatorStatus remove_particle_dupliob_exec(bContext *C, wmOperator * /*op*/)
{
  PointerRNA ptr = CTX_data_pointer_get_type(C, "particle_system", &RNA_ParticleSystem);
  ParticleSystem *psys = static_cast<ParticleSystem *>(ptr.data);
  ParticleSettings *part;
...
static OperatorStatus dupliob_move_down_exec(bContext *C, wmOperator * /*op*/)
{
  PointerRNA ptr = CTX_data_pointer_get_type(C, "particle_system", &RNA_ParticleSystem);
  ParticleSystem *psys = static_cast<ParticleSystem *>(ptr.data);
  ParticleSettings *part;
...
static OperatorStatus disconnect_hair_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus connect_hair_exec(bContext *C, wmOperator *op)
{
  Depsgraph *depsgraph = CTX_data_ensure_evaluated_depsgraph(C);
  Scene *scene = CTX_data_scene(C);
  Object *ob = blender::ed::object::context_object(C);
...
static OperatorStatus copy_particle_systems_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus duplicate_particle_systems_exec(bContext *C, wmOperator *op)
{

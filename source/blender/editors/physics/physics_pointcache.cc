...
static OperatorStatus ptcache_bake_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus ptcache_bake_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
  bool all = STREQ(op->type->idname, "PTCACHE_OT_bake_all");
...
static OperatorStatus ptcache_bake_modal(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
...
static OperatorStatus ptcache_free_bake_all_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus ptcache_free_bake_exec(bContext *C, wmOperator * /*op*/)
{
  PointerRNA ptr = CTX_data_pointer_get_type(C, "point_cache", &RNA_PointCache);
  PointCache *cache = static_cast<PointCache *>(ptr.data);
...
static OperatorStatus ptcache_bake_from_cache_exec(bContext *C, wmOperator * /*op*/)
{
  PointerRNA ptr = CTX_data_pointer_get_type(C, "point_cache", &RNA_PointCache);
  PointCache *cache = static_cast<PointCache *>(ptr.data);
  Object *ob = (Object *)ptr.owner_id;
...
static OperatorStatus ptcache_add_new_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
  PointerRNA ptr = CTX_data_pointer_get_type(C, "point_cache", &RNA_PointCache);
  Object *ob = (Object *)ptr.owner_id;
...
static OperatorStatus ptcache_remove_exec(bContext *C, wmOperator * /*op*/)
{
  PointerRNA ptr = CTX_data_pointer_get_type(C, "point_cache", &RNA_PointCache);
  Scene *scene = CTX_data_scene(C);
  Object *ob = (Object *)ptr.owner_id;

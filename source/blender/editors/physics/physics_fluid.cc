...
static OperatorStatus fluid_bake_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus fluid_bake_invoke(bContext *C, wmOperator *op, const wmEvent * /*_event*/)
{
...
static OperatorStatus fluid_bake_modal(bContext *C, wmOperator * /*op*/, const wmEvent *event)
{
...
static OperatorStatus fluid_free_exec(bContext *C, wmOperator *op)
{
  FluidModifierData *fmd = nullptr;
  FluidDomainSettings *fds;
  Object *ob = blender::ed::object::context_active_object(C);
...
static OperatorStatus fluid_pause_exec(bContext *C, wmOperator *op)
{
  FluidModifierData *fmd = nullptr;
  FluidDomainSettings *fds;
  Object *ob = blender::ed::object::context_active_object(C);

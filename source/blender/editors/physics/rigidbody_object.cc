...
static OperatorStatus rigidbody_object_add_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus rigidbody_object_remove_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Scene *scene = CTX_data_scene(C);
  Object *ob = blender::ed::object::context_active_object(C);
...
static OperatorStatus rigidbody_objects_add_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Scene *scene = CTX_data_scene(C);
  int type = RNA_enum_get(op->ptr, "type");
...
static OperatorStatus rigidbody_objects_remove_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  Scene *scene = CTX_data_scene(C);
  bool changed = false;
...
static OperatorStatus rigidbody_objects_shape_change_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus rigidbody_objects_calc_mass_exec(bContext *C, wmOperator *op)
{

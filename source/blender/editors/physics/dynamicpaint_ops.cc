...
static OperatorStatus surface_slot_add_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus surface_slot_remove_exec(bContext *C, wmOperator * /*op*/)
{
  DynamicPaintModifierData *pmd = nullptr;
...
static OperatorStatus type_toggle_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus output_toggle_exec(bContext *C, wmOperator *op)
{
 ...
 */
static OperatorStatus dynamicpaint_bake_exec(bContext *C, wmOperator *op)
{

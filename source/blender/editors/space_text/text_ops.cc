...
static OperatorStatus text_new_exec(bContext *C, wmOperator * /*op*/)
{
  SpaceText *st = CTX_wm_space_text(C);
...
static OperatorStatus text_open_exec(bContext *C, wmOperator *op)
{
  SpaceText *st = CTX_wm_space_text(C);
  Main *bmain = CTX_data_main(C);
  Text *text;
...
static OperatorStatus text_open_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
  Main *bmain = CTX_data_main(C);
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_reload_exec(bContext *C, wmOperator *op)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus text_reload_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
...
static OperatorStatus text_unlink_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_unlink_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
  return WM_operator_confirm_ex(C,
                                op,
...
static OperatorStatus text_make_internal_exec(bContext *C, wmOperator * /*op*/)
{
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_save_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_save_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_save_as_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Text *text = CTX_data_edit_text(C);
  char filepath[FILE_MAX];
...
static OperatorStatus text_save_as_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
  Main *bmain = CTX_data_main(C);
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_run_script(bContext *C, ReportList *reports)
{
#ifdef WITH_PYTHON
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_run_script_exec(bContext *C, wmOperator *op)
{
#ifndef WITH_PYTHON
  (void)C; /* unused */
...
static OperatorStatus text_refresh_pyconstraints_exec(bContext * /*C*/, wmOperator * /*op*/)
{
#ifdef WITH_PYTHON
#  if 0
  Main *bmain = CTX_data_main(C);
...
static OperatorStatus text_paste_exec(bContext *C, wmOperator *op)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_duplicate_line_exec(bContext *C, wmOperator * /*op*/)
{
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_copy_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus text_cut_exec(bContext *C, wmOperator * /*op*/)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_indent_or_autocomplete_exec(bContext *C, wmOperator * /*op*/)
{
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_indent_exec(bContext *C, wmOperator * /*op*/)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_unindent_exec(bContext *C, wmOperator * /*op*/)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_line_break_exec(bContext *C, wmOperator * /*op*/)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
  int a, curts;
...
static OperatorStatus text_comment_exec(bContext *C, wmOperator *op)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_convert_whitespace_exec(bContext *C, wmOperator *op)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
  FlattenString fs;
...
static OperatorStatus text_select_all_exec(bContext *C, wmOperator * /*op*/)
{
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_select_line_exec(bContext *C, wmOperator * /*op*/)
{
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_select_word_exec(bContext *C, wmOperator * /*op*/)
{
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus move_lines_exec(bContext *C, wmOperator *op)
{
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_move_cursor(bContext *C, int type, bool select)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus text_move_exec(bContext *C, wmOperator *op)
{
  int type = RNA_enum_get(op->ptr, "type");
...
static OperatorStatus text_move_select_exec(bContext *C, wmOperator *op)
{
  int type = RNA_enum_get(op->ptr, "type");
...
static OperatorStatus text_jump_exec(bContext *C, wmOperator *op)
{
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_jump_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
...
static OperatorStatus text_delete_exec(bContext *C, wmOperator *op)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
  int type = RNA_enum_get(op->ptr, "type");
...
static OperatorStatus text_toggle_overwrite_exec(bContext *C, wmOperator * /*op*/)
{
  SpaceText *st = CTX_wm_space_text(C);
...
static OperatorStatus text_scroll_exec(bContext *C, wmOperator *op)
{
  SpaceText *st = CTX_wm_space_text(C);
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus text_scroll_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  TextScroll *tsc = static_cast<TextScroll *>(op->customdata);
  SpaceText *st = CTX_wm_space_text(C);
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus text_scroll_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  SpaceText *st = CTX_wm_space_text(C);
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus text_scroll_bar_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  SpaceText *st = CTX_wm_space_text(C);
  ARegion *region = CTX_wm_region(C);
  TextScroll *tsc;
...
static OperatorStatus text_selection_set_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  SpaceText *st = CTX_wm_space_text(C);
  SetSelection *ssel;
...
static OperatorStatus text_selection_set_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  switch (event->type) {
    case LEFTMOUSE:
    case MIDDLEMOUSE:
...
static OperatorStatus text_cursor_set_exec(bContext *C, wmOperator *op)
{
  SpaceText *st = CTX_wm_space_text(C);
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus text_cursor_set_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  SpaceText *st = CTX_wm_space_text(C);
...
static OperatorStatus text_line_number_invoke(bContext *C,
                                              wmOperator * /*op*/,
                                              const wmEvent *event)
{
  SpaceText *st = CTX_wm_space_text(C);
...
static OperatorStatus text_insert_exec(bContext *C, wmOperator *op)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
  char *str;
...
static OperatorStatus text_insert_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  SpaceText *st = CTX_wm_space_text(C);
  OperatorStatus ret;
...
static OperatorStatus text_find_and_replace(bContext *C, wmOperator *op, short mode)
{
  Main *bmain = CTX_data_main(C);
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = st->text;
...
static OperatorStatus text_find_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus text_replace_all(bContext *C)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = st->text;
...
static OperatorStatus text_replace_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus text_find_set_selected_exec(bContext *C, wmOperator *op)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
  char *tmp;
...
static OperatorStatus text_replace_set_selected_exec(bContext *C, wmOperator * /*op*/)
{
  SpaceText *st = CTX_wm_space_text(C);
  Text *text = CTX_data_edit_text(C);
  char *tmp;
...
static OperatorStatus text_jump_to_file_at_point_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus text_resolve_conflict_exec(bContext *C, wmOperator *op)
{
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_resolve_conflict_invoke(bContext *C,
                                                   wmOperator *op,
                                                   const wmEvent * /*event*/)
{
  Text *text = CTX_data_edit_text(C);
...
static OperatorStatus text_to_3d_object_exec(bContext *C, wmOperator *op)
{
  const Text *text = CTX_data_edit_text(C);

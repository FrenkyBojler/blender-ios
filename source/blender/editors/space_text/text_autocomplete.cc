...
static OperatorStatus text_autocomplete_invoke(bContext *C,
                                               wmOperator *op,
                                               const wmEvent * /*event*/)
{
...
static OperatorStatus text_autocomplete_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  ...
  OperatorStatus retval = OPERATOR_RUNNING_MODAL;

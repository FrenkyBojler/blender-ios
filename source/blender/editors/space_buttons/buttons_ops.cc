...
static OperatorStatus buttons_start_filter_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus buttons_clear_filter_exec(bContext *C, wmOperator * /*op*/)
{
  SpaceProperties *space = CTX_wm_space_properties(C);
...
static OperatorStatus toggle_pin_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus context_menu_invoke(bContext *C,
                                          wmOperator * /*op*/,
                                          const wmEvent * /*event*/)
{
...
static OperatorStatus file_browse_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus file_browse_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  PointerRNA ptr;
  PropertyRNA *prop;
  bool is_undo;

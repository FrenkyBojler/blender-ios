...
static OperatorStatus lattice_select_random_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus lattice_select_mirror_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus lattice_select_more_less(bContext *C, const bool select)
{
  const Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
  bool changed = false;
...
static OperatorStatus lattice_select_more_exec(bContext *C, wmOperator * /*op*/)
{
  return lattice_select_more_less(C, true);
}

static OperatorStatus lattice_select_less_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus lattice_select_all_exec(bContext *C, wmOperator *op)
{
  const Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
...
static OperatorStatus lattice_select_ungrouped_exec(bContext *C, wmOperator *op)
{
  const Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);

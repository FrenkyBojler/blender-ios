 ...
 */
static OperatorStatus stroke_trim_execute(const bContext *C, const Span<int2> mcoords)
{
...
static OperatorStatus grease_pencil_stroke_trim_exec(bContext *C, wmOperator *op)
{

...
static OperatorStatus grease_pencil_layer_add_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
...
static OperatorStatus grease_pencil_layer_add_invoke(bContext *C,
                                                     wmOperator *op,
                                                     const wmEvent *event)
{
...
static OperatorStatus grease_pencil_layer_remove_exec(bContext *C, wmOperator * /*op*/)
{
  using namespace blender::bke::greasepencil;
  GreasePencil &grease_pencil = *blender::ed::greasepencil::from_context(*C);
...
static OperatorStatus grease_pencil_layer_move_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
  GreasePencil &grease_pencil = *blender::ed::greasepencil::from_context(*C);
...
static OperatorStatus grease_pencil_layer_active_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
...
static OperatorStatus grease_pencil_layer_group_add_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
  GreasePencil &grease_pencil = *blender::ed::greasepencil::from_context(*C);
...
static OperatorStatus grease_pencil_layer_group_remove_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
...
static OperatorStatus grease_pencil_layer_hide_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
  GreasePencil &grease_pencil = *blender::ed::greasepencil::from_context(*C);
...
static OperatorStatus grease_pencil_layer_reveal_exec(bContext *C, wmOperator * /*op*/)
{
  using namespace blender::bke::greasepencil;
  GreasePencil &grease_pencil = *blender::ed::greasepencil::from_context(*C);
...
static OperatorStatus grease_pencil_layer_isolate_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
  GreasePencil &grease_pencil = *blender::ed::greasepencil::from_context(*C);
...
static OperatorStatus grease_pencil_layer_lock_all_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
  GreasePencil &grease_pencil = *blender::ed::greasepencil::from_context(*C);
...
static OperatorStatus grease_pencil_layer_duplicate_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
  GreasePencil &grease_pencil = *blender::ed::greasepencil::from_context(*C);
...
static OperatorStatus grease_pencil_merge_layer_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
...
static OperatorStatus grease_pencil_layer_mask_add_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
  GreasePencil &grease_pencil = *blender::ed::greasepencil::from_context(*C);
...
static OperatorStatus grease_pencil_layer_mask_remove_exec(bContext *C, wmOperator * /*op*/)
{
  using namespace blender::bke::greasepencil;
  GreasePencil &grease_pencil = *blender::ed::greasepencil::from_context(*C);
...
static OperatorStatus grease_pencil_layer_mask_reorder_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
  GreasePencil &grease_pencil = *blender::ed::greasepencil::from_context(*C);
...
static OperatorStatus grease_pencil_layer_group_color_tag_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;
  GreasePencil &grease_pencil = *blender::ed::greasepencil::from_context(*C);
...
static OperatorStatus grease_pencil_layer_duplicate_object_exec(bContext *C, wmOperator *op)
{
  using namespace blender::bke::greasepencil;

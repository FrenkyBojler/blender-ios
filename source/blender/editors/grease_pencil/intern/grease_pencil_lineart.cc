...
static OperatorStatus lineart_bake_common(bContext *C,
                                          wmOperator *op,
...
static OperatorStatus lineart_bake_strokes_invoke(bContext *C,
                                                  wmOperator *op,
                                                  const wmEvent * /*event*/)
{
...
static OperatorStatus lineart_bake_strokes_exec(bContext *C, wmOperator *op)
{
  bool bake_all = RNA_boolean_get(op->ptr, "bake_all");
  return lineart_bake_common(C, op, bake_all, false);
}
static OperatorStatus lineart_bake_strokes_common_modal(bContext *C,
                                                        wmOperator *op,
                                                        const wmEvent * /*event*/)
{
...
static OperatorStatus lineart_gpencil_clear_strokes_exec(bContext *C, wmOperator *op)
{

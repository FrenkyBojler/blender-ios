...
static OperatorStatus grease_pencil_material_reveal_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus grease_pencil_material_hide_exec(bContext *C, wmOperator *op)
{
  Object *object = CTX_data_active_object(C);
  GreasePencil &grease_pencil = *static_cast<GreasePencil *>(object->data);
...
static OperatorStatus grease_pencil_material_lock_all_exec(bContext *C, wmOperator * /*op*/)
{
  Object *object = CTX_data_active_object(C);
  GreasePencil &grease_pencil = *static_cast<GreasePencil *>(object->data);
...
static OperatorStatus grease_pencil_material_unlock_all_exec(bContext *C, wmOperator * /*op*/)
{
  Object *object = CTX_data_active_object(C);
  GreasePencil &grease_pencil = *static_cast<GreasePencil *>(object->data);
...
static OperatorStatus grease_pencil_material_lock_unused_exec(bContext *C, wmOperator * /*op*/)
{
  Object *object = CTX_data_active_object(C);
  GreasePencil &grease_pencil = *static_cast<GreasePencil *>(object->data);
...
static OperatorStatus grease_pencil_material_lock_unselected_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus grease_pencil_material_copy_to_object_exec(bContext *C, wmOperator *op)
{
  using namespace blender;
  using namespace blender::bke;
...
static OperatorStatus material_isolate_exec(bContext *C, wmOperator *op)
{

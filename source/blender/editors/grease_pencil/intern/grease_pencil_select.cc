...
static OperatorStatus select_all_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus select_more_exec(bContext *C, wmOperator * /*op*/)
{
  Object *object = CTX_data_active_object(C);
  GreasePencil &grease_pencil = *static_cast<GreasePencil *>(object->data);
...
static OperatorStatus select_less_exec(bContext *C, wmOperator * /*op*/)
{
  Object *object = CTX_data_active_object(C);
  GreasePencil &grease_pencil = *static_cast<GreasePencil *>(object->data);
  const ViewContext vc = ED_view3d_viewcontext_init(C, CTX_data_depsgraph_pointer(C));
...
static OperatorStatus select_linked_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
  Object *object = CTX_data_active_object(C);
  GreasePencil &grease_pencil = *static_cast<GreasePencil *>(object->data);
...
static OperatorStatus select_random_exec(bContext *C, wmOperator *op)
{
  using namespace blender;
...
static OperatorStatus select_alternate_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus select_similar_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus select_ends_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus select_set_mode_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus grease_pencil_material_select_exec(bContext *C, wmOperator *op)
{

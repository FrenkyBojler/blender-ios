...
static OperatorStatus graphkeys_insertkey_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_click_insert_exec(bContext *C, wmOperator *op)
{
  using namespace blender::animrig;
  bAnimContext ac;
  bAnimListElem *ale;
...
static OperatorStatus graphkeys_click_insert_invoke(bContext *C,
                                                    wmOperator *op,
                                                    const wmEvent *event)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_copy_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_paste_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_duplicate_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_delete_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_delete_invoke(bContext *C,
                                              wmOperator *op,
                                              const wmEvent * /*event*/)
{
...
static OperatorStatus graphkeys_clean_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  float thresh;
  bool clean_chan;
...
static OperatorStatus graphkeys_keys_to_samples_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
  Scene *scene = nullptr;
  int start, end;
...
static OperatorStatus graphkeys_samples_to_keys_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
  Scene *scene = nullptr;
  int start, end;
...
static OperatorStatus graphkeys_sound_to_samples_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  ListBase anim_data = {nullptr, nullptr};
  int filter;
...
static OperatorStatus graphkeys_sound_to_samples_invoke(bContext *C,
                                                        wmOperator *op,
                                                        const wmEvent *event)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_bake_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_expo_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus graphkeys_ipo_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus graphkeys_easing_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus graphkeys_handletype_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus graphkeys_euler_filter_exec(bContext *C, wmOperator *op)
{
  /* Get editor data. */
  bAnimContext ac;
  if (ANIM_animdata_get_context(C, &ac) == 0) {
...
static OperatorStatus graphkeys_framejump_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_snap_cursor_value_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_snap_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus graphkeys_selected_control_points_invoke(bContext *C,
                                                               wmOperator *op,
                                                               const wmEvent *event)
{
...
static OperatorStatus graphkeys_equalize_handles_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_mirror_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus graphkeys_smooth_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
  ListBase anim_data = {nullptr, nullptr};
  int filter;
...
static OperatorStatus graph_fmodifier_add_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  ListBase anim_data = {nullptr, nullptr};
  int filter;
...
static OperatorStatus graph_fmodifier_copy_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  bAnimListElem *ale;
  bool ok = false;
...
static OperatorStatus graph_fmodifier_paste_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus graph_driver_vars_copy_exec(bContext *C, wmOperator *op)
{
  bool ok = false;
...
static OperatorStatus graph_driver_vars_paste_exec(bContext *C, wmOperator *op)
{
  const bool replace = RNA_boolean_get(op->ptr, "replace");
  bool ok = false;
...
static OperatorStatus graph_driver_delete_invalid_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
  ListBase anim_data = {nullptr, nullptr};
  int filter;

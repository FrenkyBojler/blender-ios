...
static OperatorStatus graphkeys_deselectall_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_box_select_invoke(bContext *C,
                                                  wmOperator *op,
                                                  const wmEvent *event)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_box_select_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  rcti rect;
  rctf rect_fl;
...
static OperatorStatus graphkeys_lassoselect_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus graph_circle_select_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_columnselect_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus graphkeys_select_linked_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_select_more_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_select_less_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_select_leftright_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_select_leftright_invoke(bContext *C,
                                                        wmOperator *op,
                                                        const wmEvent *event)
{
  bAnimContext ac;
...
static OperatorStatus mouse_graph_keys(bAnimContext *ac,
                                       const int mval[2],
                                       eEditKeyframes_Select select_mode,
...
static OperatorStatus graphkeys_mselect_column(bAnimContext *ac,
                                               const int mval[2],
                                               eEditKeyframes_Select select_mode,
                                               bool wait_to_deselect_others)
{
...
static OperatorStatus graphkeys_clickselect_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus graphkeys_select_key_handles_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;

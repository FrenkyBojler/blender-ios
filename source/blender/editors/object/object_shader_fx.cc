...
static OperatorStatus shaderfx_add_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus shaderfx_remove_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Object *ob = context_active_object(C);
...
static OperatorStatus shaderfx_remove_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus shaderfx_move_up_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
  ShaderFxData *fx = edit_shaderfx_property_get(op, ob, 0);
...
static OperatorStatus shaderfx_move_up_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  OperatorStatus retval;
  if (edit_shaderfx_invoke_properties(C, op, event, &retval)) {
...
static OperatorStatus shaderfx_move_down_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
  ShaderFxData *fx = edit_shaderfx_property_get(op, ob, 0);
...
static OperatorStatus shaderfx_move_down_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  OperatorStatus retval;
  if (edit_shaderfx_invoke_properties(C, op, event, &retval)) {
...
static OperatorStatus shaderfx_move_to_index_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
  ShaderFxData *fx = edit_shaderfx_property_get(op, ob, 0);
...
static OperatorStatus shaderfx_move_to_index_invoke(bContext *C,
                                                    wmOperator *op,
                                                    const wmEvent *event)
{
  OperatorStatus retval;
...
static OperatorStatus shaderfx_copy_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
  ShaderFxData *fx = edit_shaderfx_property_get(op, ob, 0);
  if (!fx) {
...
static OperatorStatus shaderfx_copy_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  OperatorStatus retval;
  if (edit_shaderfx_invoke_properties(C, op, event, &retval)) {

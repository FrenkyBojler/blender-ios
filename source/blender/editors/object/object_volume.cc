...
static OperatorStatus object_volume_add_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus volume_import_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus volume_import_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{

...
static OperatorStatus data_transfer_exec(bContext *C, wmOperator *op)
{
  Object *ob_src = context_active_object(C);
...
static OperatorStatus datalayout_transfer_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus datalayout_transfer_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{

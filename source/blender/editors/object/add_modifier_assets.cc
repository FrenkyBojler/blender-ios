...
static OperatorStatus modifier_add_asset_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
...
static OperatorStatus modifier_add_asset_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{

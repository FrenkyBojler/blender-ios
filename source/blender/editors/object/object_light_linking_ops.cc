...
static OperatorStatus light_linking_collection_new_exec(bContext *C, wmOperator * /*op*/)
{
...
template<LightLinkingType link_type>
static OperatorStatus light_linking_select_exec(bContext *C, wmOperator * /*op*/)
{
...
template<LightLinkingType link_type>
static OperatorStatus light_linking_link_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Scene *scene = CTX_data_scene(C);
  Object *emitter = context_active_object(C);
...
static OperatorStatus light_linking_unlink_from_collection_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);

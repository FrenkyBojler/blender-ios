...
static OperatorStatus shape_key_add_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
...
static OperatorStatus shape_key_remove_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Object *ob = context_object(C);
  bool changed = false;
...
static OperatorStatus shape_key_clear_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = context_object(C);
  Key *key = BKE_key_from_object(ob);
...
static OperatorStatus shape_key_retime_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = context_object(C);
  Key *key = BKE_key_from_object(ob);
  float cfra = 0.0f;
...
static OperatorStatus shape_key_mirror_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
  int totmirr = 0, totfail = 0;
...
static OperatorStatus shape_key_move_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
...
static OperatorStatus shape_key_lock_exec(bContext *C, wmOperator *op)
{

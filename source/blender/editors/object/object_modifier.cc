...
static OperatorStatus modifier_add_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
...
static OperatorStatus modifier_add_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus modifier_remove_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus modifier_remove_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus modifiers_clear_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus modifier_move_up_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
...
static OperatorStatus modifier_move_up_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  OperatorStatus retval;
  if (edit_modifier_invoke_properties_with_hover(C, op, event, &retval)) {
...
static OperatorStatus modifier_move_down_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
  ModifierData *md = edit_modifier_property_get(op, ob, 0);
...
static OperatorStatus modifier_move_down_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  OperatorStatus retval;
  if (edit_modifier_invoke_properties_with_hover(C, op, event, &retval)) {
...
static OperatorStatus modifier_move_to_index_exec(bContext *C, wmOperator *op)
{
  char name[MAX_NAME];
  RNA_string_get(op->ptr, "modifier", name);
...
static OperatorStatus modifier_move_to_index_invoke(bContext *C,
                                                    wmOperator *op,
                                                    const wmEvent *event)
{
  OperatorStatus retval;
...
static OperatorStatus modifier_apply_exec_ex(bContext *C,
                                             wmOperator *op,
                                             int apply_as,
                                             bool keep_modifier)
{
...
static OperatorStatus modifier_apply_exec(bContext *C, wmOperator *op)
{
  return modifier_apply_exec_ex(C, op, MODIFIER_APPLY_DATA, false);
}

static OperatorStatus modifier_apply_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  OperatorStatus retval;
  if (edit_modifier_invoke_properties_with_hover(C, op, event, &retval)) {
    PointerRNA ptr = CTX_data_pointer_get_type(C, "modifier", &RNA_Modifier);
...
static OperatorStatus modifier_apply_as_shapekey_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus modifier_apply_as_shapekey_invoke(bContext *C,
                                                        wmOperator *op,
                                                        const wmEvent *event)
{
  OperatorStatus retval;
...
static OperatorStatus modifier_convert_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Depsgraph *depsgraph = CTX_data_ensure_evaluated_depsgraph(C);
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus modifier_convert_invoke(bContext *C,
                                              wmOperator *op,
                                              const wmEvent * /*event*/)
{
...
static OperatorStatus modifier_copy_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Scene *scene = CTX_data_scene(C);
  char name[MAX_NAME];
...
static OperatorStatus modifier_copy_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  OperatorStatus retval;
  if (edit_modifier_invoke_properties_with_hover(C, op, event, &retval)) {
...
static OperatorStatus modifier_set_active_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
  ModifierData *md = edit_modifier_property_get(op, ob, 0);
...
static OperatorStatus modifier_set_active_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  OperatorStatus retval;
  if (edit_modifier_invoke_properties_with_hover(C, op, event, &retval)) {
...
static OperatorStatus modifier_copy_to_selected_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
...
static OperatorStatus modifier_copy_to_selected_invoke(bContext *C,
                                                       wmOperator *op,
                                                       const wmEvent *event)
{
  OperatorStatus retval;
...
static OperatorStatus object_modifiers_copy_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  const Scene *scene = CTX_data_scene(C);
...
static OperatorStatus skin_root_mark_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = CTX_data_edit_object(C);
...
static OperatorStatus skin_loose_mark_clear_exec(bContext *C, wmOperator *op)
{
  Object *ob = CTX_data_edit_object(C);
  BMEditMesh *em = BKE_editmesh_from_object(ob);
  BMesh *bm = em->bm;
...
static OperatorStatus skin_radii_equalize_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = CTX_data_edit_object(C);
  BMEditMesh *em = BKE_editmesh_from_object(ob);
  BMesh *bm = em->bm;
...
static OperatorStatus skin_armature_create_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Depsgraph *depsgraph = CTX_data_ensure_evaluated_depsgraph(C);
...
static OperatorStatus skin_armature_create_invoke(bContext *C,
                                                  wmOperator *op,
                                                  const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus correctivesmooth_bind_exec(bContext *C, wmOperator *op)
{
  Depsgraph *depsgraph = CTX_data_ensure_evaluated_depsgraph(C);
  Scene *scene = CTX_data_scene(C);
  Object *ob = context_active_object(C);
...
static OperatorStatus correctivesmooth_bind_invoke(bContext *C,
                                                   wmOperator *op,
                                                   const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus meshdeform_bind_exec(bContext *C, wmOperator *op)
{
  Depsgraph *depsgraph = CTX_data_ensure_evaluated_depsgraph(C);
  Object *ob = context_active_object(C);
...
static OperatorStatus meshdeform_bind_invoke(bContext *C,
                                             wmOperator *op,
                                             const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus explode_refresh_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
...
static OperatorStatus explode_refresh_invoke(bContext *C,
                                             wmOperator *op,
                                             const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus ocean_bake_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Object *ob = context_active_object(C);
...
static OperatorStatus ocean_bake_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus laplaciandeform_bind_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
  Depsgraph *depsgraph = CTX_data_ensure_evaluated_depsgraph(C);
...
static OperatorStatus laplaciandeform_bind_invoke(bContext *C,
                                                  wmOperator *op,
                                                  const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus surfacedeform_bind_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
  Depsgraph *depsgraph = CTX_data_ensure_evaluated_depsgraph(C);
...
static OperatorStatus surfacedeform_bind_invoke(bContext *C,
                                                wmOperator *op,
                                                const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus geometry_nodes_input_attribute_toggle_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
...
static OperatorStatus geometry_node_tree_copy_assign_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  Object *ob = context_active_object(C);
...
static OperatorStatus dash_modifier_segment_add_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
...
static OperatorStatus dash_modifier_segment_add_invoke(bContext *C,
                                                       wmOperator *op,
                                                       const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus dash_modifier_segment_remove_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
  auto *dmd = reinterpret_cast<GreasePencilDashModifierData *>(
      edit_modifier_property_get(op, ob, eModifierType_GreasePencilDash));
...
static OperatorStatus dash_modifier_segment_remove_invoke(bContext *C,
                                                          wmOperator *op,
                                                          const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus dash_modifier_segment_move_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
  auto *dmd = reinterpret_cast<GreasePencilDashModifierData *>(
      edit_modifier_property_get(op, ob, eModifierType_GreasePencilDash));
...
static OperatorStatus dash_modifier_segment_move_invoke(bContext *C,
                                                        wmOperator *op,
                                                        const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus time_modifier_segment_add_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
...
static OperatorStatus time_modifier_segment_add_invoke(bContext *C,
                                                       wmOperator *op,
                                                       const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus time_modifier_segment_remove_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
  auto *tmd = reinterpret_cast<GreasePencilTimeModifierData *>(
      edit_modifier_property_get(op, ob, eModifierType_GreasePencilTime));
...
static OperatorStatus time_modifier_segment_remove_invoke(bContext *C,
                                                          wmOperator *op,
                                                          const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus time_modifier_segment_move_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_active_object(C);
  auto *tmd = reinterpret_cast<GreasePencilTimeModifierData *>(
      edit_modifier_property_get(op, ob, eModifierType_GreasePencilTime));
...
static OperatorStatus time_modifier_segment_move_invoke(bContext *C,
                                                        wmOperator *op,
                                                        const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {

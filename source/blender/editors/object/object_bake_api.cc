...
static OperatorStatus bake_modal(bContext *C, wmOperator * /*op*/, const wmEvent *event)
{
...
static OperatorStatus bake(const BakeAPIRender *bkr,
                           Object *ob_low,
                           ...
                           ReportList *reports)
{
  ...
  OperatorStatus op_result = OPERATOR_CANCELLED;
  bool ok = false;
...
static OperatorStatus bake_exec(bContext *C, wmOperator *op)
{
  Render *re;
...
static OperatorStatus bake_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
  wmJob *wm_job;
  Render *re;
  Scene *scene = CTX_data_scene(C);

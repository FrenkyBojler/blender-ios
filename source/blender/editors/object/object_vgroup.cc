...
static OperatorStatus vertex_group_add_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = context_object(C);
...
static OperatorStatus vertex_group_remove_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
...
static OperatorStatus vertex_group_assign_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus vertex_group_assign_new_exec(bContext *C, wmOperator *op)
{
  /* create new group... */
  Object *ob = context_object(C);
  BKE_object_defgroup_add(ob);
...
static OperatorStatus vertex_group_remove_from_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus vertex_group_select_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus vertex_group_deselect_exec(bContext *C, wmOperator * /*op*/)
{
  const ToolSettings &tool_settings = *CTX_data_scene(C)->toolsettings;
  Object *ob = context_object(C);
  Scene &scene = *CTX_data_scene(C);
...
static OperatorStatus vertex_group_copy_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = context_object(C);
...
static OperatorStatus vertex_group_levels_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
...
static OperatorStatus vertex_group_lock_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus vertex_group_invert_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
...
static OperatorStatus vertex_group_clean_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus vertex_group_quantize_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
...
static OperatorStatus vertex_group_limit_total_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus vertex_group_mirror_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
  int totmirr = 0, totfail = 0;
...
static OperatorStatus vertex_group_copy_to_selected_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus set_active_group_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
...
static OperatorStatus vgroup_do_remap(Object *ob, const char *name_array, wmOperator *op)
{
  MDeformVert *dvert = nullptr;
...
static OperatorStatus vertex_group_sort_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
  char *name_array;
  OperatorStatus ret;
...
static OperatorStatus vgroup_move_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
  bDeformGroup *def;
  char *name_array;
...
static OperatorStatus vertex_weight_paste_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
...
static OperatorStatus vertex_weight_delete_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
  const int def_nr = RNA_int_get(op->ptr, "weight_group");
...
static OperatorStatus vertex_weight_set_active_exec(bContext *C, wmOperator *op)
{
  Object *ob = context_object(C);
...
static OperatorStatus vertex_weight_normalize_active_vertex_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = context_object(C);
  ToolSettings *ts = CTX_data_tool_settings(C);
...
static OperatorStatus vertex_weight_copy_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = context_object(C);
  ToolSettings *ts = CTX_data_tool_settings(C);
  eVGroupSelect subset_type = static_cast<eVGroupSelect>(ts->vgroupsubset);

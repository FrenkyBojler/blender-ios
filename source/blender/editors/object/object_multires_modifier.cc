...
static OperatorStatus multires_higher_levels_delete_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus multires_higher_levels_delete_invoke(bContext *C,
                                                           wmOperator *op,
                                                           const wmEvent * /*event*/)
{
...
static OperatorStatus multires_subdivide_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus multires_subdivide_invoke(bContext *C,
                                                wmOperator *op,
                                                const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus multires_reshape_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus multires_reshape_invoke(bContext *C,
                                              wmOperator *op,
                                              const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus multires_external_save_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus multires_external_save_invoke(bContext *C,
                                                    wmOperator *op,
                                                    const wmEvent * /*event*/)
{
  Object *ob = context_active_object(C);
...
static OperatorStatus multires_external_pack_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = context_active_object(C);
  Mesh *mesh = static_cast<Mesh *>(ob->data);
...
static OperatorStatus multires_base_apply_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus multires_base_apply_invoke(bContext *C,
                                                 wmOperator *op,
                                                 const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus multires_unsubdivide_exec(bContext *C, wmOperator *op)
{
  Depsgraph *depsgraph = CTX_data_depsgraph_pointer(C);
  Object *object = context_active_object(C);
  MultiresModifierData *mmd = (MultiresModifierData *)edit_modifier_property_get(
...
static OperatorStatus multires_unsubdivide_invoke(bContext *C,
                                                  wmOperator *op,
                                                  const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {
...
static OperatorStatus multires_rebuild_subdiv_exec(bContext *C, wmOperator *op)
{
  Depsgraph *depsgraph = CTX_data_depsgraph_pointer(C);
  Object *object = context_active_object(C);
  MultiresModifierData *mmd = (MultiresModifierData *)edit_modifier_property_get(
...
static OperatorStatus multires_rebuild_subdiv_invoke(bContext *C,
                                                     wmOperator *op,
                                                     const wmEvent * /*event*/)
{
  if (edit_modifier_invoke_properties(C, op)) {

...
static OperatorStatus voxel_remesh_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus voxel_size_edit_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  ARegion *region = CTX_wm_region(C);
  VoxelSizeEditCustomData *cd = static_cast<VoxelSizeEditCustomData *>(op->customdata);
...
static OperatorStatus voxel_size_edit_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus quadriflow_remesh_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus quadriflow_remesh_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{

...
static OperatorStatus object_hide_view_clear_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus object_hide_view_set_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
  ViewLayer *view_layer = CTX_data_view_layer(C);
...
static OperatorStatus object_hide_collection_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus object_hide_collection_invoke(bContext *C,
                                                    wmOperator *op,
                                                    const wmEvent *event)
{
...
static OperatorStatus editmode_toggle_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Scene *scene = CTX_data_scene(C);
  View3D *v3d = CTX_wm_view3d(C);
...
static OperatorStatus posemode_exec(bContext *C, wmOperator *op)
{
  wmMsgBus *mbus = CTX_wm_message_bus(C);
  Main *bmain = CTX_data_main(C);
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus forcefield_toggle_exec(bContext *C, wmOperator * /*op*/)
{
  Object *ob = CTX_data_active_object(C);
...
static OperatorStatus object_calculate_paths_invoke(bContext *C,
                                                    wmOperator *op,
                                                    const wmEvent * /*event*/)
{
  Object *ob = CTX_data_active_object(C);
...
static OperatorStatus object_calculate_paths_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus object_update_paths_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus object_update_all_paths_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus object_clear_paths_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus shade_smooth_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus shade_auto_smooth_exec(bContext *C, wmOperator *op)
{
  Main &bmain = *CTX_data_main(C);
  Scene &scene = *CTX_data_scene(C);
...
static OperatorStatus object_mode_set_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus move_to_collection_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus move_to_collection_invoke(bContext *C,
                                                wmOperator *op,
                                                const wmEvent * /*event*/)
{
  Scene *scene = CTX_data_scene(C);

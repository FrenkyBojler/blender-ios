...
void collection_hide_menu_draw(const bContext *C, uiLayout *layout)
{
  ...
  layout->operator_context_set(wm::OperatorCallContext::ExecRegionWin);
...
static void move_to_collection_menu_draw(Menu *menu, Collection *collection, int icon)
{
  ...
  layout.operator_context_set(wm::OperatorCallContext::InvokeDefault);
...
static void move_to_collection_menu_draw(const bContext *C, Menu *menu)
{
  uiLayout &layout = *menu->layout;
  Scene *scene = CTX_data_scene(C);
  if (layout.operator_context() == wm::OperatorCallContext::ExecRegionWin) {
    layout.operator_context_set(wm::OperatorCallContext::InvokeRegionWin);

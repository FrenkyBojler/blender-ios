...
bool mode_compat_set(bContext *C, Object *ob, eObjectMode mode, ReportList *reports)
{
  ...
  if (!ELEM(ob->mode, mode, OB_MODE_OBJECT)) {
    ...
    WM_operator_name_call(C, opstring, wm::OperatorCallContext::ExecRegionWin, nullptr, nullptr);
...
bool mode_set_ex(bContext *C, eObjectMode mode, bool use_undo, ReportList *reports)
{
  ...
  WM_operator_name_call_ptr(C, ot, wm::OperatorCallContext::ExecRegionWin, nullptr, nullptr);
  if (!use_undo) {
    wm->op_undo_depth--;
  }

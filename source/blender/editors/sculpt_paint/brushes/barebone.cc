                       ...
                       const PositionDeformData &position_data)
{
  ...
  calc_brush_radius_factors(brush, origin, cache.radius, verts, position_data.eval, factors);
                       ...
                       LocalData &tls)
{
  ...
  calc_brush_radius_factors(brush, origin, cache.radius, positions, factors);

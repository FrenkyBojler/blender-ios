...
static OperatorStatus brush_curve_preset_exec(bContext *C, wmOperator *op)
{
  Brush *br = BKE_paint_brush(BKE_paint_get_active_from_context(C));
...
static OperatorStatus brush_sculpt_curves_falloff_preset_exec(bContext *C, wmOperator *op)
{
...
/* face-select ops */
static OperatorStatus paint_select_linked_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus paint_select_linked_pick_invoke(bContext *C,
                                                      wmOperator *op,
                                                      const wmEvent *event)
{
...
static OperatorStatus face_select_all_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus paint_select_more_exec(bContext *C, wmOperator *op)
{
  Object *ob = CTX_data_active_object(C);
...
static OperatorStatus paint_select_less_exec(bContext *C, wmOperator *op)
{
  Object *ob = CTX_data_active_object(C);
  Mesh *mesh = BKE_mesh_from_object(ob);
  if (mesh == nullptr || mesh->faces_num == 0) {
...
static OperatorStatus paintface_select_loop_invoke(bContext *C,
                                                   wmOperator *op,
                                                   const wmEvent *event)
{
...
static OperatorStatus vert_select_all_exec(bContext *C, wmOperator *op)
{
  Object *ob = CTX_data_active_object(C);
...
static OperatorStatus vert_select_ungrouped_exec(bContext *C, wmOperator *op)
{
  Object *ob = CTX_data_active_object(C);
...
static OperatorStatus paintvert_select_linked_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus paintvert_select_linked_pick_invoke(bContext *C,
                                                          wmOperator *op,
                                                          const wmEvent *event)
{
  const bool select = RNA_boolean_get(op->ptr, "select");
...
static OperatorStatus paintvert_select_more_exec(bContext *C, wmOperator *op)
{
  Object *ob = CTX_data_active_object(C);
  Mesh *mesh = BKE_mesh_from_object(ob);
  if (mesh == nullptr || mesh->faces_num == 0) {
...
static OperatorStatus paintvert_select_less_exec(bContext *C, wmOperator *op)
{
  Object *ob = CTX_data_active_object(C);
  Mesh *mesh = BKE_mesh_from_object(ob);
  if (mesh == nullptr || mesh->faces_num == 0) {
...
static OperatorStatus face_select_hide_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus vert_select_hide_exec(bContext *C, wmOperator *op)
{
  const bool unselected = RNA_boolean_get(op->ptr, "unselected");
  Object *ob = CTX_data_active_object(C);
...
static OperatorStatus face_vert_reveal_exec(bContext *C, wmOperator *op)
{
  const bool select = RNA_boolean_get(op->ptr, "select");
  Object *ob = CTX_data_active_object(C);

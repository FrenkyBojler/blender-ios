                                        ...
                                        const float pressure)
{
  ...
  const float pressure_factor = stroke->brush->flag & BRUSH_SPACE &&
                                        stroke->brush->flag & BRUSH_SPACING_PRESSURE ?
                                    BKE_curvemapping_evaluateF(
                                        stroke->brush->curve_spacing, 0, pressure) :
                                    1.0;
  float spacing = stroke->brush->spacing * pressure_factor;

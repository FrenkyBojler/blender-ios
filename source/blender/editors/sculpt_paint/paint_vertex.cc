 ...
 */
static OperatorStatus vpaint_mode_toggle_exec(bContext *C, wmOperator *op)
{
  Main &bmain = *CTX_data_main(C);
...
static OperatorStatus vpaint_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  int retval;
...
static OperatorStatus vpaint_exec(bContext *C, wmOperator *op)
{
  op->customdata = paint_stroke_new(C,
                                    op,
                                    SCULPT_stroke_get_location,
...
static OperatorStatus vpaint_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus vertex_color_set_exec(bContext *C, wmOperator *op)
{

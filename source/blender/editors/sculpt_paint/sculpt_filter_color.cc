...
static OperatorStatus sculpt_color_filter_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus sculpt_color_filter_exec(bContext *C, wmOperator *op)
{
  Object &ob = *CTX_data_active_object(C);
...
static OperatorStatus sculpt_color_filter_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  Object &ob = *CTX_data_active_object(C);
  View3D *v3d = CTX_wm_view3d(C);

 ...
 */
static OperatorStatus wpaint_mode_toggle_exec(bContext *C, wmOperator *op)
{
  Main &bmain = *CTX_data_main(C);
...
static OperatorStatus wpaint_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  int retval;
...
static OperatorStatus wpaint_exec(bContext *C, wmOperator *op)
{
  op->customdata = paint_stroke_new(C,
                                    op,
                                    SCULPT_stroke_get_location,
...
static OperatorStatus wpaint_modal(bContext *C, wmOperator *op, const wmEvent *event)
{

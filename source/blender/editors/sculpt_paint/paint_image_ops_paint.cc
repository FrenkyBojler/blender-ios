...
static OperatorStatus paint_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  int retval;
...
static OperatorStatus paint_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus paint_modal(bContext *C, wmOperator *op, const wmEvent *event)
{

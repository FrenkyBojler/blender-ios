...
static OperatorStatus sculpt_detail_flood_fill_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus sample_detail(bContext *C,
...
static OperatorStatus sculpt_sample_detail_size_exec(bContext *C, wmOperator *op)
{
  int ss_co[2];
...
static OperatorStatus sculpt_sample_detail_size_invoke(bContext *C,
                                                       wmOperator *op,
                                                       const wmEvent * /*event*/)
{
...
static OperatorStatus sculpt_sample_detail_size_modal(bContext *C,
                                                      wmOperator *op,
                                                      const wmEvent *event)
{
  switch (event->type) {
...
static OperatorStatus dyntopo_detail_size_edit_modal(bContext *C,
                                                     wmOperator *op,
                                                     const wmEvent *event)
{
  Object &active_object = *CTX_data_active_object(C);
...
static OperatorStatus dyntopo_detail_size_edit_invoke(bContext *C,
                                                      wmOperator *op,
                                                      const wmEvent *event)
{

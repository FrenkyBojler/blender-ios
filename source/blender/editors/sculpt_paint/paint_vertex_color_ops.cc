...
static OperatorStatus vertex_paint_from_weight_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus vertex_color_smooth_exec(bContext *C, wmOperator * /*op*/)
{
  Object *obact = CTX_data_active_object(C);
...
static OperatorStatus vertex_color_brightness_contrast_exec(bContext *C, wmOperator *op)
{
  Object *obact = CTX_data_active_object(C);
...
static OperatorStatus vertex_color_hsv_exec(bContext *C, wmOperator *op)
{
  Object *obact = CTX_data_active_object(C);
...
static OperatorStatus vertex_color_invert_exec(bContext *C, wmOperator *op)
{
  Object *obact = CTX_data_active_object(C);
...
static OperatorStatus vertex_color_levels_exec(bContext *C, wmOperator *op)
{
  Object *obact = CTX_data_active_object(C);

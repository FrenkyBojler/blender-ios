...
static OperatorStatus sculpt_expand_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  Object &ob = *CTX_data_active_object(C);
  SculptSession &ss = *ob.sculpt;
...
static OperatorStatus sculpt_expand_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{

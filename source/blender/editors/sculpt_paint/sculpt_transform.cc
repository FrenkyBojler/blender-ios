...
static OperatorStatus set_pivot_position_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus set_pivot_position_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{

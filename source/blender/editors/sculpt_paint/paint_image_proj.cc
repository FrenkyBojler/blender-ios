...
static OperatorStatus texture_paint_camera_project_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus texture_paint_image_from_view_exec(bContext *C, wmOperator *op)
{
  using namespace blender;
  Image *image;
  ImBuf *ibuf;
...
static OperatorStatus texture_paint_add_texture_paint_slot_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus texture_paint_add_texture_paint_slot_invoke(bContext *C,
                                                                  wmOperator *op,
                                                                  const wmEvent * /*event*/)
{
  Object *ob = blender::ed::object::context_active_object(C);
...
static OperatorStatus add_simple_uvs_exec(bContext *C, wmOperator * /*op*/)
{

...
static OperatorStatus set_persistent_base_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus optimize_exec(bContext *C, wmOperator * /*op*/)
{
  Object &ob = *CTX_data_active_object(C);
...
static OperatorStatus symmetrize_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus sculpt_mode_toggle_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus sample_color_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
...
static OperatorStatus mask_by_color(bContext *C, wmOperator *op, const float2 region_location)
{
  const Scene &scene = *CTX_data_scene(C);
  Depsgraph *depsgraph = CTX_data_depsgraph_pointer(C);
  Object &ob = *CTX_data_active_object(C);
...
static OperatorStatus mask_by_color_exec(bContext *C, wmOperator *op)
{
  int2 mval;
...
static OperatorStatus mask_by_color_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus mask_from_cavity_exec(bContext *C, wmOperator *op)
{
  const Scene &scene = *CTX_data_scene(C);
  Depsgraph *depsgraph = CTX_data_depsgraph_pointer(C);
  Object &ob = *CTX_data_active_object(C);
...
static OperatorStatus mask_from_boundary_exec(bContext *C, wmOperator *op)
{
  Depsgraph *depsgraph = CTX_data_depsgraph_pointer(C);
  Object &ob = *CTX_data_active_object(C);
  const Sculpt &sd = *CTX_data_tool_settings(C)->sculpt;

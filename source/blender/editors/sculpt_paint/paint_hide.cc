...
static OperatorStatus hide_show_all_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus hide_show_masked_exec(bContext *C, wmOperator *op)
{
  const Scene &scene = *CTX_data_scene(C);
  Object &ob = *CTX_data_active_object(C);
  Depsgraph *depsgraph = CTX_data_ensure_evaluated_depsgraph(C);
...
static OperatorStatus visibility_invert_exec(bContext *C, wmOperator *op)
{
  const Scene &scene = *CTX_data_scene(C);
...
static OperatorStatus visibility_filter_exec(bContext *C, wmOperator *op)
{
  const Scene &scene = *CTX_data_scene(C);
  Object &object = *CTX_data_active_object(C);
  Depsgraph &depsgraph = *CTX_data_ensure_evaluated_depsgraph(C);
...
static OperatorStatus hide_show_gesture_box_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus hide_show_gesture_lasso_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus hide_show_gesture_line_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus hide_show_gesture_polyline_exec(bContext *C, wmOperator *op)
{

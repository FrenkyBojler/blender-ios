...
void operatortypes_sculpt()
{
  ...
  WM_operatortype_append(trim::SCULPT_OT_join_box_gesture);
  WM_operatortype_append(trim::SCULPT_OT_join_lasso_gesture);
  WM_operatortype_append(trim::SCULPT_OT_join_polyline_gesture);

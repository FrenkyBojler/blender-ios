...
static wmOperatorStatus mask_from_cavity_exec(bContext *C, wmOperator *op)
{
  ...
  switch (src) {
    case MaskSettingsSource::Operator:
      ...
      scene_copy.mesh_automasking_settings.cavity_curve = paint.mesh_automasking_settings.cavity_curve_op;
      break;
    case MaskSettingsSource::Brush:
      if (brush) {
        ...
        scene_copy.mesh_automasking_settings.cavity_blur_steps = brush->automasking_cavity_blur_steps;

...
static bool weight_paint_set(Object *ob, float paintweight)
{
  ...
  const VArraySpan select_vert = *attributes.lookup<bool>(".select_vert"_ustr,
                                                          bke::AttrDomain::Point);
  const VArraySpan select_poly = *attributes.lookup<bool>(".select_poly"_ustr,
                                                          bke::AttrDomain::Face);
...
static wmOperatorStatus paint_weight_gradient_exec(bContext *C, wmOperator *op)
{
  ...
  data.mesh = mesh;
  data.dvert = dverts;
  data.select_vert = *attributes.lookup<bool>(".select_vert"_ustr, bke::AttrDomain::Point);

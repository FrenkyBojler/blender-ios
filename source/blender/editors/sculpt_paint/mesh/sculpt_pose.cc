                                                             ...
                                                             const float radius)
{
  ...
  SegmentData current_data = {std::get<int>(ss.active_vert()), face_set_none};
  ...
  for (const int i : ik_chain->segments.index_range()) {
    ...
    flood_fill.execute(object, vert_to_face_map, [&](int /*from_v*/, int to_v) {
      ...
      if (current_data.face_set == face_set_none) {
                                                              ...
                                                              const float radius)
{
  ...
  SegmentData current_data = {ss.active_vert_index(), face_set_none};
                                                              ...
                                                              const float radius)
{
  ...
  SegmentData current_data = {std::get<BMVert *>(ss.active_vert()), face_set_none};
                                                                ...
                                                                const float3 &initial_location)
{
  ...
  int masked_face_set = face_set_none;
  int target_face_set = face_set_none;
  ...
  step_floodfill.execute(object, vert_to_face_map, [&](int from_v, int to_v) {
    ...
    if (!visited_face_sets.contains(to_face_set)) {
          ...
          face_set::vert_has_face_set(vert_to_face_map, face_sets, from_v, to_face_set))
      {
        ...
        if (target_face_set == face_set_none) {

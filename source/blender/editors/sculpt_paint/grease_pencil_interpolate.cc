...
static OperatorStatus grease_pencil_interpolate_invoke(bContext *C,
                                                       wmOperator *op,
                                                       const wmEvent * /*event*/)
{
...
static OperatorStatus grease_pencil_interpolate_modal(bContext *C,
                                                      wmOperator *op,
                                                      const wmEvent *event)
{
  wmWindow &win = *CTX_wm_window(C);
...
static OperatorStatus grease_pencil_interpolate_sequence_exec(bContext *C, wmOperator *op)
{
  using bke::greasepencil::Drawing;
  using bke::greasepencil::Layer;

...
static OperatorStatus select_orientation_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus select_orientation_invoke(bContext *C,
                                                wmOperator * /*op*/,
                                                const wmEvent * /*event*/)
{
  uiPopupMenu *pup;
...
static OperatorStatus delete_orientation_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus delete_orientation_invoke(bContext *C,
                                                wmOperator *op,
                                                const wmEvent * /*event*/)
{
...
static OperatorStatus create_orientation_exec(bContext *C, wmOperator *op)
{
  char name[MAX_NAME];
...
static OperatorStatus transform_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  OperatorStatus exit_code = OPERATOR_PASS_THROUGH;
...
static OperatorStatus transform_exec(bContext *C, wmOperator *op)
{
  TransInfo *t;
...
static OperatorStatus transform_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus transform_from_gizmo_invoke(bContext *C,
                                                  wmOperator * /*op*/,
                                                  const wmEvent *event)
{

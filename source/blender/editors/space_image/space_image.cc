...
#include "BLI_math_matrix.h"    // todo(habib): remove header, move code elsewhere
#include "BLI_math_rotation.h"  // todo(habib): same
#include "BLI_math_vector.h"    // todo(habib): same
#include "BLI_string.h"         // todo(habib): same
...
#include "BKE_node.hh"  // todo(habib): try to avoid dependency
...
#include "RNA_prototypes.hh"  // todo(habib): same

#include "IMB_imbuf_types.hh"

#include "ED_asset_shelf.hh"
#include "ED_gizmo_library.hh"  // todo(habib): remove header, move necessary code elsehwere
#include "ED_image.hh"
#include "ED_mask.hh"
#include "ED_node.hh"
...
static void WIDGETGROUP_bbox_draw_prepare(const bContext *C, wmGizmoGroup *gzgroup)
{
  ...
  // todo(habib): find relevant snode
  const SpaceNode *snode = find_node_editor(C);
...
void IMAGE_GGT_compositor_box_mask(wmGizmoGroupType *gzgt)
{
...
// general bugs:
//    - Refresh correctly when changing node
//    - wrong zoom level

...
static OperatorStatus workspace_new_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  wmWindow *win = CTX_wm_window(C);
...
static OperatorStatus workspace_delete_exec(bContext *C, wmOperator * /*op*/)
{
  WorkSpace *workspace = workspace_context_get(C);
...
static OperatorStatus workspace_append_activate_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
...
static OperatorStatus workspace_add_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
...
static OperatorStatus workspace_reorder_to_back_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  WorkSpace *workspace = workspace_context_get(C);
...
static OperatorStatus workspace_reorder_to_front_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  WorkSpace *workspace = workspace_context_get(C);
...
static OperatorStatus workspace_scene_pin_toggle_exec(bContext *C, wmOperator * /*op*/)
{
  WorkSpace *workspace = workspace_context_get(C);

                                ...
                                const char *category_override)
{
  ...
  /* TODO a better check: Region type flag? */
...
void ED_region_panels_draw(const bContext *C, ARegion *region)
{
  ...
  const bool has_category_tabs = UI_panel_category_tabs_is_visible(region);
  ...
  if (has_category_tabs && region->runtime->category) {
    UI_panel_category_tabs_draw_all(region, region->runtime->category);
  }

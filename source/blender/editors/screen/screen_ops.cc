...
void ED_screens_region_flip_menu_create(bContext *C, uiLayout *layout, void * /*arg*/)
{
  ...
  /* default is blender::wm::OperatorCallContext::InvokeRegionWin, which we don't want here. */
                                                   ...
                                                   const wmEvent * /*event*/)
{
  ...
  if (area && area->spacetype == SPACE_STATUSBAR) {
    ...
    if (ELEM(region->regiontype, RGN_TYPE_HEADER, RGN_TYPE_TOOL_HEADER)) {
      ...
      /* We need blender::wm::OperatorCallContext::InvokeDefault in case menu item is over another
       * area. */
      layout->operator_context_set(blender::wm::OperatorCallContext::InvokeDefault);

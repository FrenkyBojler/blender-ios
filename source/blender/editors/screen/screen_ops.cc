...
/* Checks which screen has an active animation timer, extracts its playback flags as a
 * #PreScrubbingState, and always sets `screen.scrubbing` before returning, regardless of whether
 * playback was active. */

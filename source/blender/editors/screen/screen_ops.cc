...
static OperatorStatus actionzone_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  bScreen *screen = CTX_wm_screen(C);
...
static OperatorStatus actionzone_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  bScreen *screen = CTX_wm_screen(C);
...
static OperatorStatus area_swap_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus area_swap_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  sActionzoneData *sad = static_cast<sActionzoneData *>(op->customdata);
...
static OperatorStatus area_swap_exec(bContext *C, wmOperator *op)
{
  ScrArea *sa1, *sa2;
  int cursor[2];
...
static OperatorStatus area_dupli_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
 ...
 */
static OperatorStatus area_close_exec(bContext *C, wmOperator *op)
{
  bScreen *screen = CTX_wm_screen(C);
  ScrArea *area = CTX_wm_area(C);
...
static OperatorStatus area_move_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus area_move_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus area_move_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  sAreaMoveData *md = static_cast<sAreaMoveData *>(op->customdata);
...
static OperatorStatus area_split_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  wmWindow *win = CTX_wm_window(C);
  bScreen *screen = CTX_wm_screen(C);
...
static OperatorStatus area_split_exec(bContext *C, wmOperator *op)
{
  if (!area_split_init(C, op)) {
    return OPERATOR_CANCELLED;
  }
...
static OperatorStatus area_split_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  sAreaSplitData *sd = (sAreaSplitData *)op->customdata;
  PropertyRNA *prop_dir = RNA_struct_find_property(op->ptr, "direction");
...
static OperatorStatus region_scale_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  sActionzoneData *sad = static_cast<sActionzoneData *>(event->customdata);
...
static OperatorStatus region_scale_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
...
/* function to be called outside UI context, or for redo */
static OperatorStatus frame_offset_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
...
/* function to be called outside UI context, or for redo */
static OperatorStatus frame_jump_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
...
/* function to be called outside UI context, or for redo */
static OperatorStatus keyframe_jump_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
...
/* function to be called outside UI context, or for redo */
static OperatorStatus marker_jump_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
...
/* function to be called outside UI context, or for redo */
static OperatorStatus screen_set_exec(bContext *C, wmOperator *op)
{
...
/* function to be called outside UI context, or for redo */
static OperatorStatus screen_maximize_area_exec(bContext *C, wmOperator *op)
{
  bScreen *screen = CTX_wm_screen(C);
...
static OperatorStatus area_join_exec(bContext *C, wmOperator *op)
{
...
/* interaction callback */
static OperatorStatus area_join_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  if (event->type == EVT_ACTIONZONE_AREA) {
    sActionzoneData *sad = static_cast<sActionzoneData *>(event->customdata);
...
static OperatorStatus area_join_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus screen_area_options_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  ScrArea *sa1, *sa2;
...
static OperatorStatus spacedata_cleanup_exec(bContext *C, wmOperator *op)
{
  Main *bmain = CTX_data_main(C);
  int tot = 0;
...
static OperatorStatus repeat_last_exec(bContext *C, wmOperator * /*op*/)
{
  wmWindowManager *wm = CTX_wm_manager(C);
...
static OperatorStatus repeat_history_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
  wmWindowManager *wm = CTX_wm_manager(C);
...
static OperatorStatus repeat_history_exec(bContext *C, wmOperator *op)
{
  wmWindowManager *wm = CTX_wm_manager(C);
...
static OperatorStatus redo_last_invoke(bContext *C, wmOperator * /*op*/, const wmEvent * /*event*/)
{
...
static OperatorStatus region_quadview_exec(bContext *C, wmOperator *op)
{
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus region_toggle_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus region_flip_exec(bContext *C, wmOperator * /*op*/)
{
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus header_toggle_menus_exec(bContext *C, wmOperator * /*op*/)
{
  ScrArea *area = CTX_wm_area(C);
...
static OperatorStatus screen_context_menu_invoke(bContext *C,
                                                 wmOperator * /*op*/,
                                                 const wmEvent * /*event*/)
{
  const ScrArea *area = CTX_wm_area(C);
...
static OperatorStatus screen_animation_step_invoke(bContext *C,
                                                   wmOperator * /*op*/,
                                                   const wmEvent *event)
{
  bScreen *screen = CTX_wm_screen(C);
...
static OperatorStatus screen_animation_play_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus screen_animation_cancel_exec(bContext *C, wmOperator *op)
{
  bScreen *screen = ED_screen_animation_playing(CTX_wm_manager(C));
...
static OperatorStatus fullscreen_back_exec(bContext *C, wmOperator *op)
{
  bScreen *screen = CTX_wm_screen(C);
  ScrArea *area = nullptr;
...
static OperatorStatus userpref_show_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus drivers_editor_show_exec(bContext *C, wmOperator *op)
{
  wmWindow *win_cur = CTX_wm_window(C);
  /* Use eventstate, not event from _invoke, so this can be called through exec(). */
  const wmEvent *event = win_cur->eventstate;
...
static OperatorStatus info_log_show_exec(bContext *C, wmOperator *op)
{
  wmWindow *win_cur = CTX_wm_window(C);
  /* Use eventstate, not event from _invoke, so this can be called through exec(). */
  const wmEvent *event = win_cur->eventstate;
...
static OperatorStatus screen_new_exec(bContext *C, wmOperator * /*op*/)
{
  Main *bmain = CTX_data_main(C);
  wmWindow *win = CTX_wm_window(C);
...
static OperatorStatus screen_delete_exec(bContext *C, wmOperator * /*op*/)
{
  bScreen *screen = CTX_wm_screen(C);
  WorkSpace *workspace = CTX_wm_workspace(C);
...
static OperatorStatus region_blend_invoke(bContext *C, wmOperator * /*op*/, const wmEvent *event)
{
...
static OperatorStatus space_type_set_or_cycle_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus space_context_cycle_invoke(bContext *C,
                                                 wmOperator *op,
                                                 const wmEvent * /*event*/)
{
...
static OperatorStatus space_workspace_cycle_invoke(bContext *C,
                                                   wmOperator *op,
                                                   const wmEvent * /*event*/)
{
  wmWindow *win = CTX_wm_window(C);

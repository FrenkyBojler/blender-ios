...
static OperatorStatus act_markers_make_local_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus actkeys_previewrange_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
  Scene *scene;
  float min, max;
...
static OperatorStatus actkeys_viewall(bContext *C, const bool only_sel)
{
  bAnimContext ac;
  View2D *v2d;
  float min, max;
...
static OperatorStatus actkeys_viewall_exec(bContext *C, wmOperator * /*op*/)
{
  /* whole range */
  return actkeys_viewall(C, false);
}

static OperatorStatus actkeys_viewsel_exec(bContext *C, wmOperator * /*op*/)
{
  /* only selected */
...
static OperatorStatus actkeys_view_frame_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus actkeys_copy_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus actkeys_paste_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus actkeys_insertkey_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus actkeys_duplicate_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus actkeys_delete_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
...
static OperatorStatus actkeys_delete_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
...
static OperatorStatus actkeys_clean_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  float thresh;
  bool clean_chan;
...
static OperatorStatus actkeys_bake_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus actkeys_expo_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus actkeys_ipo_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus actkeys_easing_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus actkeys_handletype_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus actkeys_keytype_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
...
static OperatorStatus actkeys_framejump_exec(bContext *C, wmOperator * /*op*/)
{
  bAnimContext ac;
  ListBase anim_data = {nullptr, nullptr};
  eAnimFilter_Flags filter;
...
static OperatorStatus actkeys_snap_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;
...
static OperatorStatus actkeys_mirror_exec(bContext *C, wmOperator *op)
{
  bAnimContext ac;
  short mode;

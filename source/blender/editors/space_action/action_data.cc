...
static OperatorStatus action_new_exec(bContext *C, wmOperator * /*op*/)
{
  PointerRNA ptr;
  PropertyRNA *prop;
...
static OperatorStatus action_pushdown_exec(bContext *C, wmOperator *op)
{
  SpaceAction *saction = (SpaceAction *)CTX_wm_space_data(C);
  ID *adt_id_owner = nullptr;
...
static OperatorStatus action_stash_exec(bContext *C, wmOperator *op)
{
  SpaceAction *saction = (SpaceAction *)CTX_wm_space_data(C);
  ID *adt_id_owner = nullptr;
  AnimData *adt = ED_actedit_animdata_from_context(C, &adt_id_owner);
...
static OperatorStatus action_stash_create_exec(bContext *C, wmOperator *op)
{
  SpaceAction *saction = (SpaceAction *)CTX_wm_space_data(C);
  ID *adt_id_owner = nullptr;
  AnimData *adt = ED_actedit_animdata_from_context(C, &adt_id_owner);
...
static OperatorStatus action_unlink_exec(bContext *C, wmOperator *op)
{
  ID *animated_id = nullptr;
  AnimData *adt = ED_actedit_animdata_from_context(C, &animated_id);
...
static OperatorStatus action_unlink_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus action_layer_next_exec(bContext *C, wmOperator *op)
{
  ID *animated_id = nullptr;
  AnimData *adt = ED_actedit_animdata_from_context(C, &animated_id);
...
static OperatorStatus action_layer_prev_exec(bContext *C, wmOperator *op)
{
  ID *animated_id = nullptr;
  AnimData *adt = ED_actedit_animdata_from_context(C, &animated_id);
  NlaTrack *act_track;

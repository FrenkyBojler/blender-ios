                                         ...
                                         FileExternalOperation operation)
{
  ...
  PointerRNA props_ptr = layout->op(
      ot, IFACE_(title), ICON_NONE, blender::wm::OperatorCallContext::InvokeDefault, UI_ITEM_NONE);
                                                 ...
                                                 const wmEvent *event)
{
  ...
  WM_operator_name_call(
      C, "VIEW2D_OT_pan", blender::wm::OperatorCallContext::ExecDefault, &op_ptr, event);
  ...
  if (filelist_is_dir(sfile->files, params->dir)) {
    ...
    if (lastdir && BKE_blendfile_library_path_explode(lastdir, tdir, nullptr, nullptr)) {
      ...
      WM_operator_name_call_ptr(
          C, ot, blender::wm::OperatorCallContext::InvokeDefault, &ptr, nullptr);

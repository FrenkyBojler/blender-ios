...
static OperatorStatus solve_camera_exec(bContext *C, wmOperator *op)
{
  SolveCameraJob *scj;
...
static OperatorStatus solve_camera_invoke(bContext *C, wmOperator *op, const wmEvent * /*event*/)
{
  SolveCameraJob *scj;
  SpaceClip *sc = CTX_wm_space_clip(C);
  MovieClip *clip = ED_space_clip_get_clip(sc);
...
static OperatorStatus solve_camera_modal(bContext *C, wmOperator * /*op*/, const wmEvent *event)
{
...
static OperatorStatus clear_solution_exec(bContext *C, wmOperator * /*op*/)
{
  SpaceClip *sc = CTX_wm_space_clip(C);
  MovieClip *clip = ED_space_clip_get_clip(sc);

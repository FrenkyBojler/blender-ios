...
static OperatorStatus open_exec(bContext *C, wmOperator *op)
{
  SpaceClip *sc = CTX_wm_space_clip(C);
...
static OperatorStatus reload_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus view_zoom_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus view_zoom_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus view_zoom_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  ViewZoomData *vpd = static_cast<ViewZoomData *>(op->customdata);
...
static OperatorStatus view_zoom_in_exec(bContext *C, wmOperator *op)
{
  float location[2];
...
static OperatorStatus view_zoom_in_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  SpaceClip *sc = CTX_wm_space_clip(C);
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus view_zoom_out_exec(bContext *C, wmOperator *op)
{
  float location[2];
...
static OperatorStatus view_zoom_out_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  SpaceClip *sc = CTX_wm_space_clip(C);
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus view_zoom_ratio_exec(bContext *C, wmOperator *op)
{
  SpaceClip *sc = CTX_wm_space_clip(C);
...
static OperatorStatus view_all_exec(bContext *C, wmOperator *op)
{
  SpaceClip *sc;
  ARegion *region;
...
static OperatorStatus view_selected_exec(bContext *C, wmOperator * /*op*/)
{
  SpaceClip *sc = CTX_wm_space_clip(C);
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus clip_rebuild_proxy_exec(bContext *C, wmOperator * /*op*/)
{
  wmJob *wm_job;
  ProxyJob *pj;
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus mode_set_exec(bContext *C, wmOperator *op)
{
  SpaceClip *sc = CTX_wm_space_clip(C);
...
static OperatorStatus clip_view_ndof_invoke(bContext *C, wmOperator * /*op*/, const wmEvent *event)
{
...
static OperatorStatus clip_prefetch_modal(bContext *C, wmOperator * /*op*/, const wmEvent *event)
{
...
static OperatorStatus clip_prefetch_invoke(bContext *C, wmOperator *op, const wmEvent * /*_event*/)
{
...
static OperatorStatus clip_set_scene_frames_exec(bContext *C, wmOperator * /*op*/)
{
  MovieClip *clip = CTX_data_edit_movieclip(C);
  Scene *scene = CTX_data_scene(C);
  int clip_length;
...
static OperatorStatus clip_set_2d_cursor_exec(bContext *C, wmOperator *op)
{
  SpaceClip *sclip = CTX_wm_space_clip(C);
...
static OperatorStatus clip_set_2d_cursor_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  ARegion *region = CTX_wm_region(C);
  SpaceClip *sclip = CTX_wm_space_clip(C);
  float location[2];
...
static OperatorStatus lock_selection_toggle_exec(bContext *C, wmOperator * /*op*/)
{
  SpaceClip *space_clip = CTX_wm_space_clip(C);

...
static OperatorStatus create_plane_track_tracks_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus slide_plane_marker_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
...
static OperatorStatus slide_plane_marker_modal(bContext *C, wmOperator *op, const wmEvent *event)
{
  SpaceClip *sc = CTX_wm_space_clip(C);
  MovieClip *clip = ED_space_clip_get_clip(sc);

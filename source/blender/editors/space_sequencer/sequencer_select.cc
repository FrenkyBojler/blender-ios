...
static OperatorStatus sequencer_de_select_all_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus sequencer_select_inverse_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus sequencer_select_invoke(bContext *C, wmOperator *op, const wmEvent *event)
{
  const OperatorStatus retval = WM_generic_select_invoke(C, op, event);
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus sequencer_select_handle_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus sequencer_select_handle_invoke(bContext *C,
                                                     wmOperator *op,
                                                     const wmEvent *event)
{
  ARegion *region = CTX_wm_region(C);
...
static OperatorStatus sequencer_select_more_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus sequencer_select_less_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus sequencer_select_linked_pick_invoke(bContext *C,
                                                          wmOperator *op,
                                                          const wmEvent *event)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus sequencer_select_linked_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
  bool selected;
...
static OperatorStatus sequencer_select_handles_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
  Editing *ed = seq::editing_get(scene);
...
static OperatorStatus sequencer_select_side_of_frame_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
  Editing *ed = seq::editing_get(scene);
...
static OperatorStatus sequencer_select_side_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
  Editing *ed = seq::editing_get(scene);
...
static OperatorStatus sequencer_box_select_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
  View2D *v2d = UI_view2d_fromcontext(C);
  Editing *ed = seq::editing_get(scene);
...
static OperatorStatus sequencer_box_select_invoke(bContext *C,
                                                  wmOperator *op,
                                                  const wmEvent *event)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus sequencer_select_grouped_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);

...
static OperatorStatus sequencer_retiming_data_show_exec(bContext *C, wmOperator * /*op*/)
{
...
static OperatorStatus sequencer_retiming_reset_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus retiming_key_add_from_selection(bContext *C,
                                                      wmOperator *op,
...
static OperatorStatus retiming_key_add_to_editable_strips(bContext *C,
                                                          wmOperator *op,
                                                          const int timeline_frame)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus sequencer_retiming_key_add_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus sequencer_retiming_freeze_frame_add_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
  bool success = false;
...
static OperatorStatus sequencer_retiming_transition_add_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
  bool success = false;
...
static OperatorStatus sequencer_retiming_key_delete_exec(bContext *C, wmOperator * /*op*/)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus sequencer_retiming_key_delete_invoke(bContext *C,
                                                           wmOperator *op,
                                                           const wmEvent *event)
{
  Scene *scene = CTX_data_scene(C);
...
static OperatorStatus strip_speed_set_exec(bContext *C, const wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
  blender::VectorSet<Strip *> strips = selected_strips_from_context(C);
  strips.remove_if([&](Strip *strip) { return !seq::retiming_is_allowed(strip); });
...
static OperatorStatus segment_speed_set_exec(const bContext *C,
                                             const wmOperator *op,
...
static OperatorStatus sequencer_retiming_segment_speed_set_exec(bContext *C, wmOperator *op)
{
...
static OperatorStatus sequencer_retiming_segment_speed_set_invoke(bContext *C,
                                                                  wmOperator *op,
                                                                  const wmEvent *event)
{

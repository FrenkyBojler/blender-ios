...
OperatorStatus sequencer_retiming_key_select_exec(bContext *C,
                                                  wmOperator *op,
                                                  SeqRetimingKey *key,
                                                  const Strip *key_owner);
/* Select a key and all following keys. */
OperatorStatus sequencer_retiming_select_linked_time(bContext *C,
                                                     wmOperator *op,
                                                     SeqRetimingKey *key,
                                                     const Strip *key_owner);
OperatorStatus sequencer_select_exec(bContext *C, wmOperator *op);
OperatorStatus sequencer_retiming_select_all_exec(bContext *C, wmOperator *op);
OperatorStatus sequencer_retiming_box_select_exec(bContext *C, wmOperator *op);
...
OperatorStatus sequencer_clipboard_copy_exec(bContext *C, wmOperator *op);
OperatorStatus sequencer_clipboard_paste_exec(bContext *C, wmOperator *op);

...
/**
 *  Returns float-valued box bounds of a strip in view-space.
 *
 ...
 * Transitions have a smaller height than normal strips.
 * For a strip's channel and frame extents (rather than the size), see
 * #strip_int_bounds_get.
 */

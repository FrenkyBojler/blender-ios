...
static OperatorStatus sequencer_rebuild_proxy_invoke(bContext *C,
                                                     wmOperator *op,
                                                     const wmEvent * /*event*/)
{
...
static OperatorStatus sequencer_rebuild_proxy_exec(bContext *C, wmOperator * /*o*/)
{
...
static OperatorStatus sequencer_enable_proxies_invoke(bContext *C,
                                                      wmOperator *op,
                                                      const wmEvent * /*event*/)
{
...
static OperatorStatus sequencer_enable_proxies_exec(bContext *C, wmOperator *op)
{
  Scene *scene = CTX_data_scene(C);
  Editing *ed = seq::editing_get(scene);

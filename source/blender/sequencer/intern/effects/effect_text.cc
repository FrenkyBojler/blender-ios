                             ...
                             ImBuf * /*ibuf2*/)
{
  ...
  text_effect_update_runtime(*data, *data->runtime, font, {out->x, out->y});

  rcti outline_rect = draw_text_outline(context, data, out);
  BLF_buffer(
  ...
  if (data->flag & SEQ_TEXT_SHADOW) {
    draw_text_shadow(context, data, data->runtime->line_height, outline_rect, out);
  }

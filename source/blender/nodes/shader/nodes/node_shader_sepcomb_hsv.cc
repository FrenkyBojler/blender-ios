...
void register_node_type_sh_sephsv()
{
  ...
  sh_node_type_base(&ntype, SH_NODE_SEPHSV_LEGACY, "Separate HSV (Legacy)", blender::bke::NodeClass::Converter);
...
void register_node_type_sh_combhsv()
{
  ...
  sh_node_type_base(&ntype, SH_NODE_COMBHSV_LEGACY, "Combine HSV (Legacy)", blender::bke::NodeClass::Converter);

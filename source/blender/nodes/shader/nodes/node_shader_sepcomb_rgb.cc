...
void register_node_type_sh_seprgb()
{
  ...
  sh_fn_node_type_base(&ntype, "ShaderNodeSeparateRGB", SH_NODE_SEPRGB_LEGACY, NODE_CLASS_CONVERTER);
...
void register_node_type_sh_combrgb()
{
  ...
  sh_fn_node_type_base(&ntype, "ShaderNodeCombineRGB", SH_NODE_COMBRGB_LEGACY, NODE_CLASS_CONVERTER);

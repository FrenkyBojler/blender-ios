...
namespace blender::nodes::node_geo_grid_activate_cc {
...
static void node_gather_link_search_ops(GatherLinkSearchOpParams &params)
{
  ...
  params.add_item(IFACE_("Grid"), [data_type](LinkSearchOpParams &params) {
    bNode &node = params.add_node("GeometryNodeGridActivate");
...
static void node_geo_exec(GeoNodeExecParams params)
{
  ...
  //   bke::volume_grid::to_typed_grid(vdb_grid, [&](auto &grid) { grid.activateActiveTiles(); });
...
static void node_register()
{
  ...
  geo_node_type_base(&ntype, "GeometryNodeGridActivate");
  ntype.ui_name = "Activate Voxels";
  ntype.ui_description = "Activate voxels and tiles";

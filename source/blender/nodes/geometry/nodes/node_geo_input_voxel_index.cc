...
static void node_declare(NodeDeclarationBuilder &b)
{
  ...
  b.add_output<decl::Int>("X").field_source();
  b.add_output<decl::Int>("Y").field_source();
  b.add_output<decl::Int>("Z").field_source();
  auto &panel = b.add_panel("Tile").default_closed(true);
  panel.add_output<decl::Bool>("Is Tile").field_source();
  panel.add_output<decl::Int>("Extent X").field_source();
  panel.add_output<decl::Int>("Extent Y").field_source();
  panel.add_output<decl::Int>("Extent Z").field_source();
}

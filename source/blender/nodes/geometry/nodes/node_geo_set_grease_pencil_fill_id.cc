...
namespace blender::nodes::node_geo_set_grease_pencil_fill_id {
...
static void node_geo_exec(GeoNodeExecParams params)
{
  ...
  const Field<int> fill_id = params.extract_input<Field<int>>("Fill ID");
...
static void node_register()
{
  ...
  geo_node_type_base(&ntype, "GeometryNodeSetGreasePencilFillID");
  ntype.ui_name = "Set Grease Pencil Fill ID";
  ntype.ui_description = "Set fill ID attribute on Grease Pencil geometry";

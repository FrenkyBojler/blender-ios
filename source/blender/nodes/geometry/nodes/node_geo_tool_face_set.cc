...
static void node_geo_exec(GeoNodeExecParams params)
{
  ...
  params.set_output("Face Set", bke::AttributeFieldInput::from<int>(".sculpt_face_set"_ustr));
  params.set_output("Exists", bke::AttributeExistsFieldInput::from(".sculpt_face_set"_ustr));
}

...
static void node_rna(StructRNA *srna)
{
  static const EnumPropertyItem operation_items[] = {
      {.value = int(Operation::Intersect),
       .identifier = "INTERSECT",
       .icon = 0,
       .name = "Intersect",
       .description = "Keep the part of the grids that is common between all operands"},
      {.value = int(Operation::Union),
       .identifier = "UNION",
       .icon = 0,
       .name = "Union",
       .description = "Combine grids in an additive way"},
      {.value = int(Operation::Difference),
       .identifier = "DIFFERENCE",
       .icon = 0,
       .name = "Difference",
       .description = "Combine grids in a subtractive way"},

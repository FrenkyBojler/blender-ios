...
static void node_rna(StructRNA *srna)
{
  static EnumPropertyItem items[] = {
      {.value = CD_PROP_FLOAT,
       ...
       .name = "Float",
       .description = "Add floating point values"},
      {.value = CD_PROP_INT32,
       .identifier = "INT",
       .icon = ICON_NODE_SOCKET_INT,
       .name = "Integer",
       .description = "Add integer values"},
      {.value = CD_PROP_FLOAT3,
       .identifier = "FLOAT_VECTOR",
       .icon = ICON_NODE_SOCKET_VECTOR,
       .name = "Vector",
       .description = "Add 3D vector values"},
      {.value = CD_PROP_FLOAT4X4,
       .identifier = "TRANSFORM",
       .icon = ICON_NODE_SOCKET_MATRIX,
       .name = "Transform",
       .description = "Multiply transformation matrices"},

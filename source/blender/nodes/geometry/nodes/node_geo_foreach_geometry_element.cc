...
static void node_register()
{
  ...
  geo_node_type_base(&ntype, "GeometryNodeForeachGeometryElementInput", GEO_NODE_FOREACH_GEOMETRY_ELEMENT_INPUT, NODE_CLASS_INTERFACE);
...
{
  static blender::bke::bNodeType ntype;
  geo_node_type_base(&ntype, "GeometryNodeForeachGeometryElementOutput", GEO_NODE_FOREACH_GEOMETRY_ELEMENT_OUTPUT, NODE_CLASS_INTERFACE);

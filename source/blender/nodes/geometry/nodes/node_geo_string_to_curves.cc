...
static const EnumPropertyItem rna_node_geometry_string_to_curves_overflow_items[] = {
    {.value = GEO_NODE_STRING_TO_CURVES_MODE_OVERFLOW,
     .identifier = "OVERFLOW",
     .icon = ICON_NONE,
     .name = "Overflow",
     .description = "Let the text use more space than the specified height"},
    {.value = GEO_NODE_STRING_TO_CURVES_MODE_SCALE_TO_FIT,
     .identifier = "SCALE_TO_FIT",
     .icon = ICON_NONE,
     .name = "Scale To Fit",
     .description = "Scale the text size to fit inside the width and height"},
    {.value = GEO_NODE_STRING_TO_CURVES_MODE_TRUNCATE,
     .identifier = "TRUNCATE",
     .icon = ICON_NONE,
     .name = "Truncate",
     .description =
...
static const EnumPropertyItem rna_node_geometry_string_to_curves_align_x_items[] = {
    {.value = GEO_NODE_STRING_TO_CURVES_ALIGN_X_LEFT,
     .identifier = "LEFT",
     .icon = ICON_ALIGN_LEFT,
     .name = "Left",
     .description = "Align text to the left"},
    {.value = GEO_NODE_STRING_TO_CURVES_ALIGN_X_CENTER,
     .identifier = "CENTER",
     .icon = ICON_ALIGN_CENTER,
     .name = "Center",
     .description = "Align text to the center"},
    {.value = GEO_NODE_STRING_TO_CURVES_ALIGN_X_RIGHT,
     .identifier = "RIGHT",
     .icon = ICON_ALIGN_RIGHT,
     .name = "Right",
     .description = "Align text to the right"},
    {.value = GEO_NODE_STRING_TO_CURVES_ALIGN_X_JUSTIFY,
     .identifier = "JUSTIFY",
     .icon = ICON_ALIGN_JUSTIFY,
     .name = "Justify",
     .description = "Align text to the left and the right"},
    {.value = GEO_NODE_STRING_TO_CURVES_ALIGN_X_FLUSH,
     .identifier = "FLUSH",
     .icon = ICON_ALIGN_FLUSH,
     .name = "Flush",
     .description = "Align text to the left and the right, with equal character spacing"},
    {.value = 0, .identifier = nullptr, .icon = 0, .name = nullptr, .description = nullptr},
};

static const EnumPropertyItem rna_node_geometry_string_to_curves_align_y_items[] = {
    {.value = GEO_NODE_STRING_TO_CURVES_ALIGN_Y_TOP,
     .identifier = "TOP",
     .icon = ICON_ALIGN_TOP,
     .name = "Top",
     .description = "Align text to the top"},
    {.value = GEO_NODE_STRING_TO_CURVES_ALIGN_Y_TOP_BASELINE,
     .identifier = "TOP_BASELINE",
     .icon = ICON_ALIGN_TOP,
     .name = "Top Baseline",
     .description = "Align text to the top line's baseline"},
    {.value = GEO_NODE_STRING_TO_CURVES_ALIGN_Y_MIDDLE,
     .identifier = "MIDDLE",
     .icon = ICON_ALIGN_MIDDLE,
     .name = "Middle",
     .description = "Align text to the middle"},
    {.value = GEO_NODE_STRING_TO_CURVES_ALIGN_Y_BOTTOM_BASELINE,
     .identifier = "BOTTOM_BASELINE",
     .icon = ICON_ALIGN_BOTTOM,
     .name = "Bottom Baseline",
     .description = "Align text to the bottom line's baseline"},
    {.value = GEO_NODE_STRING_TO_CURVES_ALIGN_Y_BOTTOM,
     .identifier = "BOTTOM",
     .icon = ICON_ALIGN_BOTTOM,
     .name = "Bottom",
     .description = "Align text to the bottom"},
    {.value = 0, .identifier = nullptr, .icon = 0, .name = nullptr, .description = nullptr},
};

static const EnumPropertyItem rna_node_geometry_string_to_curves_pivot_mode[] = {
    {.value = GEO_NODE_STRING_TO_CURVES_PIVOT_MODE_MIDPOINT,
     .identifier = "MIDPOINT",
     .icon = 0,
     .name = "Midpoint",
     .description = "Midpoint"},
    {.value = GEO_NODE_STRING_TO_CURVES_PIVOT_MODE_TOP_LEFT,
     .identifier = "TOP_LEFT",
     .icon = 0,
     .name = "Top Left",
     .description = "Top Left"},
    {.value = GEO_NODE_STRING_TO_CURVES_PIVOT_MODE_TOP_CENTER,
     .identifier = "TOP_CENTER",
     .icon = 0,
     .name = "Top Center",
     .description = "Top Center"},
    {.value = GEO_NODE_STRING_TO_CURVES_PIVOT_MODE_TOP_RIGHT,
     .identifier = "TOP_RIGHT",
     .icon = 0,
     .name = "Top Right",
     .description = "Top Right"},
    {.value = GEO_NODE_STRING_TO_CURVES_PIVOT_MODE_BOTTOM_LEFT,
     .identifier = "BOTTOM_LEFT",
     .icon = 0,
     .name = "Bottom Left",
     .description = "Bottom Left"},
    {.value = GEO_NODE_STRING_TO_CURVES_PIVOT_MODE_BOTTOM_CENTER,
     .identifier = "BOTTOM_CENTER",
     .icon = 0,
     .name = "Bottom Center",
     .description = "Bottom Center"},
    {.value = GEO_NODE_STRING_TO_CURVES_PIVOT_MODE_BOTTOM_RIGHT,

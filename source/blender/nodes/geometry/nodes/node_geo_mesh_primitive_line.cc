...
static void node_rna(StructRNA *srna)
{
  static EnumPropertyItem mode_items[] = {
      {.value = GEO_NODE_MESH_LINE_MODE_OFFSET,
       .identifier = "OFFSET",
       .icon = 0,
       .name = "Offset",
       .description = "Specify the offset from one vertex to the next"},
      {.value = GEO_NODE_MESH_LINE_MODE_END_POINTS,
       .identifier = "END_POINTS",
       .icon = 0,
       .name = "End Points",
       .description = "Specify the line's start and end points"},
      {.value = 0, .identifier = nullptr, .icon = 0, .name = nullptr, .description = nullptr},
  };

  static EnumPropertyItem count_mode_items[] = {
      {.value = GEO_NODE_MESH_LINE_COUNT_TOTAL,
       .identifier = "TOTAL",
       .icon = 0,
       .name = "Count",
       .description = "Specify the total number of vertices"},
      {.value = GEO_NODE_MESH_LINE_COUNT_RESOLUTION,
       .identifier = "RESOLUTION",
       .icon = 0,
       .name = "Resolution",
       .description = "Specify the distance between vertices"},
      {.value = 0, .identifier = nullptr, .icon = 0, .name = nullptr, .description = nullptr},
  };

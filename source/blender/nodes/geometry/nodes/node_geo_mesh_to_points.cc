...
static void node_rna(StructRNA *srna)
{
  static EnumPropertyItem mode_items[] = {
      {.value = GEO_NODE_MESH_TO_POINTS_VERTICES,
       .identifier = "VERTICES",
       .icon = 0,
       .name = "Vertices",
       .description = "Create a point in the point cloud for each selected vertex"},
      {.value = GEO_NODE_MESH_TO_POINTS_EDGES,
       .identifier = "EDGES",
       .icon = 0,
       .name = "Edges",
       .description = "Create a point in the point cloud for each selected edge"},
      {.value = GEO_NODE_MESH_TO_POINTS_FACES,
       .identifier = "FACES",
       .icon = 0,
       .name = "Faces",
       .description = "Create a point in the point cloud for each selected face"},
      {.value = GEO_NODE_MESH_TO_POINTS_CORNERS,
       .identifier = "CORNERS",
       .icon = 0,
       .name = "Corners",
       .description = "Create a point in the point cloud for each selected face corner"},

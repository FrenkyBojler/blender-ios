...
static void set_instance_geometry_from_instances(const bke::Instances &src_instances,
                                  ...
                                  bke::Instances &dst_instances)
{
  if (geometry_set.has_instances()) {
    ...
    set_instance_geometry_from_instances(
        src_instances, selection_field, instance_index_field, dst_instances);
  }
  else {
...
static void node_geo_exec(GeoNodeExecParams params)
{
  ...
  if (bke::Instances *instances = geometry_set.get_instances_for_write()) {
    set_instance_geometry(instance_geometry,
                          ...
                          params.get_input<Field<int>>("Instance Index"),
                          *instances);
  }

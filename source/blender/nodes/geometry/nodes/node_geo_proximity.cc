...
static void node_rna(StructRNA *srna)
{
  static const EnumPropertyItem target_element_items[] = {
      {.value = GEO_NODE_PROX_TARGET_POINTS,
       .identifier = "POINTS",
       .icon = ICON_NONE,
       .name = "Points",
       .description =
           "Calculate the proximity to the target's points (faster than the other modes)"},
      {.value = GEO_NODE_PROX_TARGET_EDGES,
       .identifier = "EDGES",
       .icon = ICON_NONE,
       .name = "Edges",
       .description = "Calculate the proximity to the target's edges"},
      {.value = GEO_NODE_PROX_TARGET_FACES,
       .identifier = "FACES",
       .icon = ICON_NONE,
       .name = "Faces",
       .description = "Calculate the proximity to the target's faces"},

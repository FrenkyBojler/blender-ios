...
static void node_register()
{
  ...
  geo_node_type_base(&ntype, "GeometryNodeSimulationInput", GEO_NODE_SIMULATION_INPUT, NODE_CLASS_INTERFACE);
...
static void node_register()
{
  ...
  geo_node_type_base(&ntype, "GeometryNodeSimulationOutput", GEO_NODE_SIMULATION_OUTPUT, NODE_CLASS_INTERFACE);

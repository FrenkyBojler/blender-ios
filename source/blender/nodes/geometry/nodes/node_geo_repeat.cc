...
static void node_register()
{
  ...
  geo_node_type_base(&ntype, "GeometryNodeRepeatInput", GEO_NODE_REPEAT_INPUT, NODE_CLASS_INTERFACE);
...
{
  static blender::bke::bNodeType ntype;
  geo_node_type_base(&ntype, "GeometryNodeRepeatOutput", GEO_NODE_REPEAT_OUTPUT, NODE_CLASS_INTERFACE);

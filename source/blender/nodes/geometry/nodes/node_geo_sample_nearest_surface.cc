...
static void node_geo_exec(GeoNodeExecParams params)
{
  ...
  bke::SocketValueVariant sample_position = params.extract_input<bke::SocketValueVariant>(
      "Sample Position");
  bke::SocketValueVariant sample_group_id = params.extract_input<bke::SocketValueVariant>(
      "Sample Group ID");
  ...
  {
    auto fn_ptr = std::make_shared<SampleNearestSurfaceFunction>(geometry, group_id_field);
  ...
  {
    auto fn_ptr = std::make_shared<bke::mesh_surface_sample::BaryWeightFromPositionFn>(geometry);
    const mf::MultiFunction &fn = *fn_ptr;
    std::string error_message;
    const bool success = execute_multi_function_on_value_variant(
        fn,

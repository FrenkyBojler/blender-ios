...
DefNode(GeometryNode, GEO_NODE_EVALUATE_IN_SPACE, 0, FieldInSpace, "Evaluate in Space", "")
...
DefNode(GeometryNode, GEO_NODE_SAMPLE_IN_SPACE, 0, SampleInSpace, "Sample in Space", "")

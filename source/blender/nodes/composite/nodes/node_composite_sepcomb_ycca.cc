...
void register_node_type_cmp_sepycca()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeSepYCCA", CMP_NODE_SEPYCCA_LEGACY, NODE_CLASS_CONVERTER);
...
void register_node_type_cmp_combycca()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeCombYCCA", CMP_NODE_COMBYCCA_LEGACY, NODE_CLASS_CONVERTER);

...
void register_node_type_cmp_separate_xyz()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeSeparateXYZ", CMP_NODE_SEPARATE_XYZ, NODE_CLASS_CONVERTER);
...
void register_node_type_cmp_combine_xyz()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeCombineXYZ", CMP_NODE_COMBINE_XYZ, NODE_CLASS_CONVERTER);

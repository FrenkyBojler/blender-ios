...
void register_node_type_cmp_separate_xyz()
{
  ...
  cmp_node_type_base(&ntype, CMP_NODE_SEPARATE_XYZ, "Separate XYZ", blender::bke::NodeClass::Converter);
...
void register_node_type_cmp_combine_xyz()
{
  ...
  cmp_node_type_base(&ntype, CMP_NODE_COMBINE_XYZ, "Combine XYZ", blender::bke::NodeClass::Converter);

...
void register_node_type_cmp_separate_color()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeSeparateColor", CMP_NODE_SEPARATE_COLOR, NODE_CLASS_CONVERTER);
...
void register_node_type_cmp_combine_color()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeCombineColor", CMP_NODE_COMBINE_COLOR, NODE_CLASS_CONVERTER);

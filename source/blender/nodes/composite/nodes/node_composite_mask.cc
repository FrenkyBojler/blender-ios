...
static const EnumPropertyItem size_source_items[] = {
    {.value = 0, .identifier = "SCENE", .icon = 0, .name = "Scene Size", .description = ""},
    {.value = CMP_NODE_MASK_FLAG_SIZE_FIXED,
     .identifier = "FIXED",
     .icon = 0,
     .name = N_("Fixed"),
     .description = N_("Use pixel size for the buffer")},
    {.value = CMP_NODE_MASK_FLAG_SIZE_FIXED_SCENE,
     .identifier = "FIXED_SCENE",
     .icon = 0,
     .name = N_("Fixed/Scene"),
     .description = N_("Pixel size scaled by scene percentage")},

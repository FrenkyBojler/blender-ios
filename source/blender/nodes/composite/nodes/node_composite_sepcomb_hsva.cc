...
void register_node_type_cmp_sephsva()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeSepHSVA", CMP_NODE_SEPHSVA_LEGACY, NODE_CLASS_CONVERTER);
...
void register_node_type_cmp_combhsva()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeCombHSVA", CMP_NODE_COMBHSVA_LEGACY, NODE_CLASS_CONVERTER);

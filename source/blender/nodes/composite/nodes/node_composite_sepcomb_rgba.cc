...
void register_node_type_cmp_seprgba()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeSepRGBA", CMP_NODE_SEPRGBA_LEGACY, NODE_CLASS_CONVERTER);
...
void register_node_type_cmp_combrgba()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeCombRGBA", CMP_NODE_COMBRGBA_LEGACY, NODE_CLASS_CONVERTER);

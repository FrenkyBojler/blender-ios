...
static void node_draw(uiLayout *layout, bContext *context, PointerRNA *node_pointer)
{
  uiTemplateID(layout, context, node_pointer, "scene", nullptr, nullptr, nullptr);
  ...
  row->prop(node_pointer, "layer", UI_ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE);

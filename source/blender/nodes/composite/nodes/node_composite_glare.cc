...
static const EnumPropertyItem type_items[] = {
    {.value = CMP_NODE_GLARE_BLOOM,
     .identifier = "BLOOM",
     .icon = 0,
     .name = N_("Bloom"),
     .description = ""},
    {.value = CMP_NODE_GLARE_GHOST,
     .identifier = "GHOSTS",
     .icon = 0,
     .name = N_("Ghosts"),
     .description = ""},
    {.value = CMP_NODE_GLARE_STREAKS,
     .identifier = "STREAKS",
     .icon = 0,
     .name = N_("Streaks"),
     .description = ""},
    {.value = CMP_NODE_GLARE_FOG_GLOW,
     .identifier = "FOG_GLOW",
     .icon = 0,
     .name = N_("Fog Glow"),
     .description = ""},
    {.value = CMP_NODE_GLARE_SIMPLE_STAR,
     .identifier = "SIMPLE_STAR",
     .icon = 0,
     .name = N_("Simple Star"),
     .description = ""},
    {.value = CMP_NODE_GLARE_SUN_BEAMS,
     .identifier = "SUN_BEAMS",
     .icon = 0,
     .name = N_("Sun Beams"),
     .description = ""},
    {.value = CMP_NODE_GLARE_KERNEL,
     .identifier = "KERNEL",
     .icon = 0,
     .name = N_("Kernel"),
     .description = ""},
...
static const EnumPropertyItem quality_items[] = {
    {.value = CMP_NODE_GLARE_QUALITY_HIGH,
     .identifier = "HIGH",
     .icon = 0,
     .name = N_("High"),
     .description = ""},
    {.value = CMP_NODE_GLARE_QUALITY_MEDIUM,
     .identifier = "MEDIUM",
     .icon = 0,
     .name = N_("Medium"),
     .description = ""},
    {.value = CMP_NODE_GLARE_QUALITY_LOW,
     .identifier = "LOW",
     .icon = 0,
     .name = N_("Low"),
     .description = ""},

...
void register_node_type_cmp_cryptomatte()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeCryptomatteV2", CMP_NODE_CRYPTOMATTE, NODE_CLASS_MATTE);
...
void register_node_type_cmp_cryptomatte_legacy()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeCryptomatte", CMP_NODE_CRYPTOMATTE_LEGACY, NODE_CLASS_MATTE);

...
{
  layout.prop(
      node_pointer, "directory", ui::ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE, IFACE_("Directory"));
  layout.prop(
      node_pointer, "file_name", ui::ITEM_R_SPLIT_EMPTY_NAME, "", ICON_NONE, IFACE_("File Name"));
}

...
class FileOutputOperation : public NodeOperation {
 public:
  ...
  {
    path_templates::VariableMap template_variables = BKE_build_template_variables_for_render_path(
        &this->bnode().owner_tree().id, &context().get_scene());
                                      ...
                                      char *r_image_path)
  {
    ...
    path_templates::VariableMap template_variables = BKE_build_template_variables_for_render_path(
        &this->bnode().owner_tree().id, scene);
    BKE_add_template_variables_for_node(template_variables, this->bnode());

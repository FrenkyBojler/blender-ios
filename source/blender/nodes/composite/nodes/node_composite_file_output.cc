...
static void node_composit_buts_file_output_ex(uiLayout *layout, bContext *C, PointerRNA *ptr)
{
  ...
  op_ptr = col->op(ot, "", ICON_TRIA_UP, wm::OperatorCallContext::InvokeDefault, UI_ITEM_NONE);
  RNA_enum_set(&op_ptr, "direction", 1);
  op_ptr = col->op(ot, "", ICON_TRIA_DOWN, wm::OperatorCallContext::InvokeDefault, UI_ITEM_NONE);

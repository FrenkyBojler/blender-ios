...
void register_node_type_cmp_sepyuva()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeSepYUVA", CMP_NODE_SEPYUVA_LEGACY, NODE_CLASS_CONVERTER);
...
void register_node_type_cmp_combyuva()
{
  ...
  cmp_node_type_base(&ntype, "CompositorNodeCombYUVA", CMP_NODE_COMBYUVA_LEGACY, NODE_CLASS_CONVERTER);

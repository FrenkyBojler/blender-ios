...
static const EnumPropertyItem type_items[] = {
    {.value = CMP_NODE_BLUR_TYPE_BOX,
     .identifier = "FLAT",
     .icon = 0,
     .name = N_("Flat"),
     .description = ""},
    {.value = CMP_NODE_BLUR_TYPE_TENT,
     .identifier = "TENT",
     .icon = 0,
     .name = N_("Tent"),
     .description = ""},
    {.value = CMP_NODE_BLUR_TYPE_QUAD,
     .identifier = "QUAD",
     .icon = 0,
     .name = N_("Quadratic"),
     .description = ""},
    {.value = CMP_NODE_BLUR_TYPE_CUBIC,
     .identifier = "CUBIC",
     .icon = 0,
     .name = N_("Cubic"),
     .description = ""},
    {.value = CMP_NODE_BLUR_TYPE_GAUSS,
     .identifier = "GAUSS",
     .icon = 0,
     .name = N_("Gaussian"),
     .description = ""},
    {.value = CMP_NODE_BLUR_TYPE_FAST_GAUSS,
     .identifier = "FAST_GAUSS",
     .icon = 0,
     .name = N_("Fast Gaussian"),
     .description = ""},
    {.value = CMP_NODE_BLUR_TYPE_CATROM,
     .identifier = "CATROM",
     .icon = 0,
     .name = N_("Catrom"),
     .description = ""},
    {.value = CMP_NODE_BLUR_TYPE_MITCH,
     .identifier = "MITCH",
     .icon = 0,
     .name = N_("Mitch"),
     .description = ""},

...
static const EnumPropertyItem type_items[] = {
    ...
    {CMP_NODE_BLUR_TYPE_FAST_GAUSS, "FAST_GAUSS", 0, N_("Fast Gaussian"), "Applies a recursive Gaussian blur that can be faster and more accurate in some cases, but less accurate in other cases"},

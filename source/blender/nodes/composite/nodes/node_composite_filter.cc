...
static const EnumPropertyItem type_items[] = {
    {.value = CMP_NODE_FILTER_SOFT,
     .identifier = "SOFTEN",
     .icon = 0,
     .name = N_("Soften"),
     .description = ""},
    {.value = CMP_NODE_FILTER_SHARP_BOX,
     .identifier = "SHARPEN",
     .icon = 0,
     .name = N_("Box Sharpen"),
     .description = N_("An aggressive sharpening filter")},
    {.value = CMP_NODE_FILTER_SHARP_DIAMOND,
     .identifier = "SHARPEN_DIAMOND",
     .icon = 0,
     .name = N_("Diamond Sharpen"),
     .description = N_("A moderate sharpening filter")},
    {.value = CMP_NODE_FILTER_LAPLACE,
     .identifier = "LAPLACE",
     .icon = 0,
     .name = N_("Laplace"),
     .description = ""},
    {.value = CMP_NODE_FILTER_SOBEL,
     .identifier = "SOBEL",
     .icon = 0,
     .name = N_("Sobel"),
     .description = ""},
    {.value = CMP_NODE_FILTER_PREWITT,
     .identifier = "PREWITT",
     .icon = 0,
     .name = N_("Prewitt"),
     .description = ""},
    {.value = CMP_NODE_FILTER_KIRSCH,
     .identifier = "KIRSCH",
     .icon = 0,
     .name = N_("Kirsch"),
     .description = ""},
    {.value = CMP_NODE_FILTER_SHADOW,
     .identifier = "SHADOW",
     .icon = 0,
     .name = N_("Shadow"),
     .description = ""},

...
static void node_rna(StructRNA *srna)
{
  static const EnumPropertyItem data_type_items[] = {
      {.value = CMP_NODE_RELATIVE_TO_PIXEL_DATA_TYPE_FLOAT,
       .identifier = "FLOAT",
       .icon = ICON_NONE,
       .name = "Float",
       .description = "Float value"},
      {.value = CMP_NODE_RELATIVE_TO_PIXEL_DATA_TYPE_VECTOR,
       .identifier = "VECTOR",
       .icon = ICON_NONE,
       .name = "Vector",
  ...
  static const EnumPropertyItem reference_dimension_items[] = {
      {.value = CMP_NODE_RELATIVE_TO_PIXEL_REFERENCE_DIMENSION_PER_DIMENSION,
       .identifier = "PER_DIMENSION",
       .icon = ICON_NONE,
       .name = "Per Dimension",
       .description =
           "The value is relative to each of the dimensions of the image independently"},
      {.value = CMP_NODE_RELATIVE_TO_PIXEL_REFERENCE_DIMENSION_X,
       .identifier = "X",
       .icon = ICON_NONE,
       .name = "X",
       .description = "The value is relative to the X dimension of the image"},
      {.value = CMP_NODE_RELATIVE_TO_PIXEL_REFERENCE_DIMENSION_Y,
       .identifier = "Y",
       .icon = ICON_NONE,
       .name = "Y",
       .description = "The value is relative to the Y dimension of the image"},
      {.value = CMP_NODE_RELATIVE_TO_PIXEL_REFERENCE_DIMENSION_GREATER,
       .identifier = "Greater",
       .icon = ICON_NONE,
       .name = "Greater",
       .description = "The value is relative to the greater dimension of the image"},
      {.value = CMP_NODE_RELATIVE_TO_PIXEL_REFERENCE_DIMENSION_SMALLER,
       .identifier = "Smaller",
       .icon = ICON_NONE,
       .name = "Smaller",
       .description = "The value is relative to the smaller dimension of the image"},
      {.value = CMP_NODE_RELATIVE_TO_PIXEL_REFERENCE_DIMENSION_DIAGONAL,
       .identifier = "Diagonal",
       .icon = ICON_NONE,
       .name = "Diagonal",
       .description = "The value is relative to the diagonal of the image"},
      {.value = 0, .identifier = nullptr, .icon = 0, .name = nullptr, .description = nullptr},
  };

...
static int gpu_shader_euler_to_rotation(GPUMaterial *mat,
                    bNode *node,
...
static void node_register()
{
  ...
  fn_cmp_node_type_base(&ntype, "FunctionNodeEulerToRotation", FN_NODE_EULER_TO_ROTATION);
  ...
  ntype.gpu_fn = gpu_shader_euler_to_rotation;

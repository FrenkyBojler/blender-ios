...
void uv_parametrizer_lscm_begin(ParamHandle *handle, bool live, bool abf, const bool fixed_bounds);
...
void uv_parametrizer_fixed_bounds(ParamHandle *phandle);
/* -------------------------------------------------------------------- */

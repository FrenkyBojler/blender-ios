...
static void rna_def_idproperty_ui(BlenderRNA *brna)
{
  ...
  RNA_def_property_update(prop, 0, "rna_idproperty_ui_float_limits_update");
  RNA_def_property_float_default(prop, -FLT_MAX);
  ...
  prop = RNA_def_property(srna, "soft_min", PROP_FLOAT, PROP_NONE);
  RNA_def_property_ui_text(prop, "Soft Min", "Soft minimum value in the UI");
  RNA_def_property_update(prop, 0, "rna_idproperty_ui_float_limits_update");
  RNA_def_property_float_default(prop, -FLT_MAX);

  prop = RNA_def_property(srna, "soft_max", PROP_FLOAT, PROP_NONE);
  ...
  prop = RNA_def_property(srna, "step", PROP_FLOAT, PROP_NONE);
  ...
  RNA_def_property_ui_text(prop, "Min", "Minimum value");
  RNA_def_property_update(prop, 0, "rna_idproperty_ui_int_limits_update");
  RNA_def_property_int_default(prop, INT_MIN);

  prop = RNA_def_property(srna, "max", PROP_INT, PROP_NONE);
  RNA_def_property_ui_text(prop, "Max", "Maximum value");
  RNA_def_property_update(prop, 0, "rna_idproperty_ui_int_limits_update");
  RNA_def_property_int_default(prop, INT_MAX);

  prop = RNA_def_property(srna, "soft_min", PROP_INT, PROP_NONE);
  RNA_def_property_ui_text(prop, "Soft Min", "Soft minimum value in the UI");
  RNA_def_property_update(prop, 0, "rna_idproperty_ui_int_limits_update");
  RNA_def_property_int_default(prop, INT_MIN);

  prop = RNA_def_property(srna, "soft_max", PROP_INT, PROP_NONE);
  RNA_def_property_ui_text(prop, "Soft Max", "Soft maximum value in the UI");
  RNA_def_property_update(prop, 0, "rna_idproperty_ui_int_limits_update");
  RNA_def_property_int_default(prop, INT_MAX);

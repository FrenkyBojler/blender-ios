...
static void rna_def_brush(BlenderRNA *brna)
{
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag2", BRUSH_USE_UNIFIED_PAINT_SIZE);
  RNA_def_property_ui_text(prop, "Use Unified Size", "Use unified paint size for this brush");
  RNA_def_property_update(prop, 0, "rna_Brush_update");

  prop = RNA_def_property(srna, "use_unified_strength", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag2", BRUSH_USE_UNIFIED_PAINT_ALPHA);
  RNA_def_property_ui_text(prop,
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag2", BRUSH_USE_UNIFIED_PAINT_WEIGHT);
  RNA_def_property_ui_text(prop,
                           "Use Unified Weight",
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag2", BRUSH_USE_UNIFIED_PAINT_COLOR);
  RNA_def_property_ui_text(
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "flag2", BRUSH_USE_UNIFIED_PAINT_INPUT_SAMPLES);
  RNA_def_property_ui_text(
      prop,

...
static void rna_def_space_view3d_overlay(BlenderRNA *brna)
{
  ...
  prop = RNA_def_property(srna, "show_wireframe_bone", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "overlay.flag", V3D_OVERLAY_BONE_WIREFRAME);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_ui_text(
      prop, "Wireframe Bone Display", "Display bones as transparent wireframe for selection");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, nullptr);

...
static PointerRNA rna_SpaceView3D_region_3d_get(PointerRNA *ptr)
{
  ...
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_RegionView3D, regiondata);
}
...
static PointerRNA rna_SpaceView3D_region_quadviews_get(CollectionPropertyIterator *iter)
{
  ...
  return RNA_pointer_create_with_ancestors(iter->parent, &RNA_RegionView3D, regiondata);
}
...
static PointerRNA rna_View3DShading_selected_studio_light_get(PointerRNA *ptr)
{
  ...
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_StudioLight, sl);
}
...
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_View3DOverlay, ptr->data);
}
...
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_SpaceImageOverlay, ptr->data);
}
...
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_SpaceUVEditor, ptr->data);
}
...
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_SequencerPreviewOverlay, ptr->data);
}
...
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_SequencerTimelineOverlay, ptr->data);
}
...
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_SequencerCacheOverlay, ptr->data);
}
...
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_SpaceNodeOverlay, ptr->data);
}
...
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_FileSelectIDFilter, ptr->data);
}
...
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_FileAssetSelectIDFilter, ptr->data);
}
...
static PointerRNA rna_FileBrowser_params_get(PointerRNA *ptr)
{
  ...
  if (params && params_struct) {
    return RNA_pointer_create_with_ancestors(*ptr, params_struct, params);
  }
...
{
  ListBaseIterator *internal = &iter->internal.listbase;
  PointerRNA r_ptr = RNA_pointer_create_with_ancestors(

...
static void rna_def_space_view3d_shading(BlenderRNA *brna)
{
  ...
  prop = RNA_def_property(srna, "xray_auto_toggle", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "flag", V3D_SHADING_XRAY_AUTO_TOGGLE);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_ui_text(prop, "Auto X-Ray Toggle", "Automatically toggle X-Ray mode during selection");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D | NS_VIEW3D_SHADING, nullptr);

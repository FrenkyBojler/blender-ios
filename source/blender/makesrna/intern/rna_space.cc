...
static void rna_def_space_sequencer_preview_overlay(BlenderRNA *brna)
{
  ...
  prop = RNA_def_property(srna, "show_origins", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "preview_overlay.flag", SEQ_PREVIEW_SHOW_ORIGINS);
  RNA_def_property_ui_text(prop, "Origins", "");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_SEQUENCER, nullptr);

  prop = RNA_def_property(srna, "show_origins_all", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(
      prop, nullptr, "preview_overlay.flag", SEQ_PREVIEW_SHOW_ORIGINS_ALL);
  RNA_def_property_ui_text(prop, "Origins(all)", "");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_SEQUENCER, nullptr);
}

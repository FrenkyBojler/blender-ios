...
static void rna_def_space_view3d_shading(BlenderRNA *brna)
{
  ...
  RNA_def_property_ui_text(prop, "X-Ray Opacity", "Opacity used for X-Ray selection");
  RNA_def_property_range(prop, 0.0f, 1.0f);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D | NS_VIEW3D_SHADING, nullptr);
  ...
  RNA_def_property_ui_text(
      prop, "Wireframe X-Ray Opacity", "Opacity used for wireframe X-Ray selection");
  RNA_def_property_range(prop, 0.0f, 1.0f);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D | NS_VIEW3D_SHADING, nullptr);
...
static void rna_def_space_view3d_overlay(BlenderRNA *brna)
{
  ...
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_ui_text(prop, "Show Bone X-Ray", "Display bones in front of everything");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, nullptr);
  ...
  RNA_def_property_ui_text(
      prop, "Bone X-Ray Fade", "Geometry fade strength for bone X-Ray selection");
  RNA_def_property_range(prop, 0.0f, 1.0f);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, nullptr);

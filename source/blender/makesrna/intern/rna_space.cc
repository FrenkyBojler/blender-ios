...
static void rna_def_space_sequencer_preview_overlay(BlenderRNA *brna)
{
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "preview_overlay.composition_guide_flags", COMPOSITION_GUIDES_ENABLED);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "preview_overlay.composition_guide_flags", COMPOSITION_GUIDES_CENTER);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "preview_overlay.composition_guide_flags", COMPOSITION_GUIDES_CENTER_DIAG);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "preview_overlay.composition_guide_flags", COMPOSITION_GUIDES_THIRDS);
  ...
  RNA_def_property_boolean_sdna(prop, nullptr, "preview_overlay.composition_guide_flags", COMPOSITION_GUIDES_GOLDEN);

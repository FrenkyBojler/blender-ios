...
static void rna_def_userdef_theme_space_node(BlenderRNA *brna)
{
  ...
  prop = RNA_def_property(srna, "perf_low", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "node_perf_low");
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(prop, "Low Performance", "");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

  prop = RNA_def_property(srna, "perf_high", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "node_perf_high");
  RNA_def_property_array(prop, 4);
  RNA_def_property_ui_text(prop, "High Performance", "");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");
}

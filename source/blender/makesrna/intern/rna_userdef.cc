...
#  ifdef WITH_INPUT_NDOF
  ...
  prop = RNA_def_property(srna, "ndof_dynamic_fly_speed", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "ndof_flag", NDOF_DYNAMIC_FLY_SPEED);
  RNA_def_property_ui_text(prop,
                           "Auto Fly Speed",
                           "Automatically adjusts fly navigation speed "
                           "based on the distance of objects near the center "
                           "of the viewport, making it easier to navigate "
                           "complex scenes. Speed is recalculated each time "
                           "movement starts.");

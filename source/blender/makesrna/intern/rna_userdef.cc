                                                        ...
                                                        const char *directory)
{
  ...
  new_library = ED_userpref_asset_library_new(
      C, name ? name : "", directory ? directory : "", bUserAssetLibraryAddType::Local, false);
...
static void rna_def_userdef_filepaths_asset_library(BlenderRNA *brna)
{
  ...
  RNA_def_property_ui_text(
      prop, "Project Defined", "Signifies if the asset library is defined by a project or not");
  RNA_def_property_clear_flag(prop, PROP_EDITABLE);
}

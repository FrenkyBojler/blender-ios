...
static void rna_def_userdef_theme_space_seq(BlenderRNA *brna)
{
  ...
  prop = RNA_def_property(srna, "image_id_strip", PROP_FLOAT, PROP_COLOR_GAMMA);
  RNA_def_property_float_sdna(prop, nullptr, "image_id");
  RNA_def_property_array(prop, 3);
  RNA_def_property_ui_text(prop, "Image ID Strip", "");
  RNA_def_property_update(prop, 0, "rna_userdef_theme_update");

...
static void rna_def_image_paint(BlenderRNA *brna)
{
  ...
  RNA_def_property_pointer_sdna(prop, nullptr, "clone_brush_image");
  RNA_def_property_flag(prop, PROP_EDITABLE);
  ...
  RNA_def_property_float_sdna(prop, nullptr, "clone_brush_alpha");
  RNA_def_property_range(prop, 0.0f, 1.0f);
  ...
  RNA_def_property_float_sdna(prop, nullptr, "clone_brush_offset");

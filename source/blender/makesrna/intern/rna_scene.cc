...
static void rna_def_tool_settings(BlenderRNA *brna)
{
  ...
  RNA_def_property_enum_bitflag_sdna(prop, nullptr, "snap_selection_exclude.active_edit_mode");
  RNA_def_property_flag(prop, PROP_ENUM_FLAG | PROP_DEG_SYNC_ONLY);
  RNA_def_property_enum_items(prop, rna_enum_snap_element_items);
  RNA_def_property_ui_text(prop,
  ...
  RNA_def_property_enum_bitflag_sdna(prop, nullptr, "snap_selection_exclude.edited_edit_mode");
  RNA_def_property_flag(prop, PROP_ENUM_FLAG | PROP_DEG_SYNC_ONLY);
  RNA_def_property_enum_items(prop, rna_enum_snap_element_items);
  RNA_def_property_ui_text(prop,
  ...
  RNA_def_property_enum_bitflag_sdna(prop, nullptr, "snap_selection_exclude.non_edited_edit_mode");
  RNA_def_property_flag(prop, PROP_ENUM_FLAG | PROP_DEG_SYNC_ONLY);
  RNA_def_property_enum_items(prop, rna_enum_snap_element_items);
  RNA_def_property_ui_text(prop,
  ...
  RNA_def_property_enum_bitflag_sdna(prop, nullptr, "snap_selection_exclude.non_selectable");
  RNA_def_property_flag(prop, PROP_ENUM_FLAG | PROP_DEG_SYNC_ONLY);
  RNA_def_property_enum_items(prop, rna_enum_snap_element_items);
  RNA_def_property_ui_text(
      prop, "Exclude Non-Selectable", "Snap only to objects that are selectable");
  RNA_def_property_update(prop, NC_SCENE | ND_TOOLSETTINGS, nullptr); /* header redraw */

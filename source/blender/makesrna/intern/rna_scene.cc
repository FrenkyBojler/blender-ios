...
static void rna_def_tool_settings(BlenderRNA *brna)
{
  ...
  prop = RNA_def_property(srna, "clear_user_region", PROP_BOOLEAN, PROP_NONE);
  RNA_def_property_boolean_sdna(prop, nullptr, "uv_flag", UV_SHOW_USER_REGION);
  RNA_def_property_flag(prop, PROP_SKIP_SAVE);
  RNA_def_property_ui_text(prop, "Clear User Region", "Clear user region");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_IMAGE, nullptr);

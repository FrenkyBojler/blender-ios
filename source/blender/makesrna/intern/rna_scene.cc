...
static void rna_def_tool_settings(BlenderRNA *brna)
{
  ...
  RNA_def_property_ui_text(prop, "Use Location for Camera Fix", "Create location keys when fixing to the scene camera");
  ...
  RNA_def_property_ui_text(prop, "Use Rotation for Camera Fix", "Create rotation keys when fixing to the scene camera");
  ...
  RNA_def_property_ui_text(prop, "Use Scale for Camera Fix", "Create scale keys when fixing to the scene camera");

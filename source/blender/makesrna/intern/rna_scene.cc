...
static void rna_def_tool_settings(BlenderRNA *brna)
{
  ...
  RNA_def_property_ui_icon(prop, ICON_GP_SELECT_POINTS);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_flag(prop, PROP_CONTEXT_UPDATE);
  ...
  RNA_def_property_ui_icon(prop, ICON_GP_SELECT_BETWEEN_STROKES);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_flag(prop, PROP_CONTEXT_UPDATE);
  ...
  RNA_def_property_ui_icon(prop, ICON_GP_MULTIFRAME_EDITING);
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  /* FIXME: We shouldn't have to tag all the Grease Pencil IDs for an update! */
  RNA_def_property_flag(prop, PROP_CONTEXT_UPDATE);
  ...
  RNA_def_property_ui_icon(prop, ICON_KEYINGSET);
  ...
  RNA_def_property_ui_icon(prop, ICON_UV_SYNC_SELECT);
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_IMAGE, nullptr);
...
static void rna_def_curve_paint_settings(BlenderRNA *brna)
{
  ...
  RNA_def_property_ui_icon(prop, ICON_STYLUS_PRESSURE);
...
void rna_def_freestyle_settings(BlenderRNA *brna)
{
  ...
  RNA_def_property_ui_icon(prop, ICON_X);
  RNA_def_property_update(prop, NC_SCENE | ND_RENDER_OPTIONS, "rna_Scene_freestyle_update");
...
void RNA_def_scene(BlenderRNA *brna)
{
  ...
  RNA_def_property_update(prop, NC_SCENE | ND_FRAME, nullptr);
  RNA_def_property_ui_icon(prop, ICON_PREVIEW_RANGE);

...
#define IMAGE_TYPE_ITEMS_IMAGE \
  ...
  R_IMF_ENUM_PNG \
  R_IMF_ENUM_WEBP \
  RNA_ENUM_ITEM_SEPR, R_IMF_ENUM_BMP R_IMF_ENUM_CINEON \
                          R_IMF_ENUM_DPX /* DDS save not supported yet R_IMF_ENUM_DDS */ \
                              R_IMF_ENUM_IRIS R_IMF_ENUM_JPEG2K R_IMF_ENUM_HDR R_IMF_ENUM_TAGA \
                                  R_IMF_ENUM_TAGA_RAW R_IMF_ENUM_TIFF

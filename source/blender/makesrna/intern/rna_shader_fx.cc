...
void RNA_def_shader_fx(BlenderRNA *brna)
{
  ...
  RNA_def_property_ui_text(prop, "Layer", "Layer or layer group used to limit the effect");
  RNA_def_property_update(prop, NC_OBJECT | ND_SHADERFX, "rna_ShaderFx_update");
  ...
  RNA_def_property_ui_text(prop, "Invert Filter", "Invert layer or layer group filter");
  RNA_def_property_update(prop, NC_OBJECT | ND_SHADERFX, "rna_ShaderFx_update");
  ...
  RNA_def_property_ui_text(prop, "Layer Group", "Filter by layer group instead of layer");
  RNA_def_property_update(prop, NC_OBJECT | ND_SHADERFX, "rna_ShaderFx_update");

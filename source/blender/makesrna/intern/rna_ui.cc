...
static bool rna_Panel_unregister(Main *bmain, StructRNA *type)
{
  ...
  RNA_struct_free(&blender_rna_get(), type);
...
#  endif
  ...
  pt->rna_ext.srna = RNA_def_struct_ptr(&blender_rna_get(), pt->idname, &RNA_Panel);
                                      ...
                                      StructFreeFunc free)
{
  ...
  ult->rna_ext.srna = RNA_def_struct_ptr(&blender_rna_get(), ult->idname, &RNA_UIList);
                                      ...
                                      StructFreeFunc free)
{
  ...
  ht->rna_ext.srna = RNA_def_struct_ptr(&blender_rna_get(), ht->idname, &RNA_Header);
                                    ...
                                    StructFreeFunc free)
{
  ...
  mt->rna_ext.srna = RNA_def_struct_ptr(&blender_rna_get(), mt->idname, &RNA_Menu);
                                          ...
                                          StructFreeFunc free)
{
  ...
  shelf_type->rna_ext.srna = RNA_def_struct_ptr(
      &blender_rna_get(), shelf_type->idname, &RNA_AssetShelf);
                                           ...
                                           StructFreeFunc free)
{
  ...
  *file_handler_type = dummy_file_handler_type;
  ...
  file_handler_type->rna_ext.srna = RNA_def_struct_ptr(
      &blender_rna_get(), file_handler_type->idname, &RNA_FileHandler);

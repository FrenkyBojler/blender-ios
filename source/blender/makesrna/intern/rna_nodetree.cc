...
static void rna_def_nodes(BlenderRNA *brna)
{
  ...
  define("GeometryNode", "GeometryNodeConstraintResiduals");
  ...
  define("GeometryNode", "GeometryNodeHairConstraint");
  define("GeometryNode", "GeometryNodeHairSimulation");
  ...
  define("GeometryNode", "GeometryNodeSolveConstraints");

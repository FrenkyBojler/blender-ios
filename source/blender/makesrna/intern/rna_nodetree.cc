                                        ...
                                        StructFreeFunc free)
{
  ...
  nt->rna_ext.srna = RNA_def_struct_ptr(&blender_rna_get(), nt->idname.c_str(), &RNA_NodeTree);
                                                       ...
                                                       StructFreeFunc free)
{
  ...
  nt->rna_ext.srna = RNA_def_struct_ptr(&blender_rna_get(), nt->idname.c_str(), basetype);
  nt->rna_ext.data = data;
  nt->rna_ext.call = call;
  nt->rna_ext.free = free;
  RNA_struct_blender_type_set(nt->rna_ext.srna, nt);

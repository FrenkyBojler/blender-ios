...
static void def_cmp_combsep_color(BlenderRNA * /*brna*/, StructRNA *srna)
{
  static const EnumPropertyItem mode_items[] = {
      ...
      {CMP_NODE_COMBSEP_COLOR_HSL,
       ...
       "HSL",
       "Use HSL (Hue, Saturation, Lightness) color processing"},
      {CMP_NODE_COMBSEP_COLOR_OKLAB,
       "Oklab",
       ICON_NONE,
       "Oklab",
       "Use Oklab (Lightness, red / green axis, blue / yellow axis) color processing"},
      {CMP_NODE_COMBSEP_COLOR_OKLCH,
       "Oklch",
       ICON_NONE,
       "Oklch",
       "Use Oklch (Lightness, Chroma, Hue) color processing"},
      {CMP_NODE_COMBSEP_COLOR_OKHSV,
       "Okhsv",
       ICON_NONE,
       "Okhsv",
       "Use Okhsv (Hue, Saturation, Value) color processing"},
      {CMP_NODE_COMBSEP_COLOR_OKHSL,
       "Okhsl",
       ICON_NONE,
       "Okhsl",
       "Use Okhsl (Hue, Saturation, Lightness) color processing"},

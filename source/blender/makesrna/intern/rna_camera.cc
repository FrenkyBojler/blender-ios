...
void RNA_def_camera(BlenderRNA *brna)
{
  ...
  RNA_def_property_ui_text(
      prop, "Golden Triangle A", "Display golden triangle A composition guide inside the camera view");
  RNA_def_property_update(prop, NC_CAMERA | ND_DRAW_RENDER_VIEWPORT, nullptr);
  ...
  RNA_def_property_ui_text(
      prop, "Golden Triangle B", "Display golden triangle B composition guide inside the camera view");
  RNA_def_property_update(prop, NC_CAMERA | ND_DRAW_RENDER_VIEWPORT, nullptr);

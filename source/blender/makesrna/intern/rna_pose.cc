...
static PointerRNA rna_PoseChannel_bone_get(PointerRNA *ptr)
{
  ...
  return RNA_pointer_create_with_ancestors(tmp_ptr, &RNA_Bone, pchan->bone);
}
...
{
  bPose *pose = (bPose *)ptr->data;
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_IKParam, pose->ikparam);
}
...
static PointerRNA rna_PoseChannel_active_constraint_get(PointerRNA *ptr)
{
  ...
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_Constraint, con);
}

                                                ...
                                                RNAPropertyOverrideApplyContext &rnaapply_ctx)
{
  ...
  bConstraint *con_anchor = static_cast<bConstraint *>(
      BLI_listbase_string_ptr_or_index_find(&pchan_dst->constraints,
                                            opop->subitem_reference_name,
                                            name_ptr_offset,
                                            opop->subitem_reference_index));
  /* If `con_anchor` is nullptr, `con_src` will be inserted in first position. */

  bConstraint *con_src = static_cast<bConstraint *>(
      BLI_listbase_string_ptr_or_index_find(&pchan_src->constraints,

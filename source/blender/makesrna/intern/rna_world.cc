...
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_WorldLighting, ptr->owner_id);
}

static PointerRNA rna_World_mist_get(PointerRNA *ptr)
{
  return RNA_pointer_create_with_ancestors(*ptr, &RNA_WorldMistSettings, ptr->owner_id);
}

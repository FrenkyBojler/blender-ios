...
static const char *rna_property_subtypename(PropertySubType type)
{
  switch (type) {
    ...
    case PROP_POWER:
      return "PROP_POWER";
    case PROP_RADIOMETRIC_POWER:
      return "PROP_RADIOMETRIC_POWER";
    case PROP_RADIOMETRIC_INTENSITY:
      return "PROP_RADIOMETRIC_INTENSITY";
    case PROP_RADIOMETRIC_IRRADIANCE:
      return "PROP_RADIOMETRIC_IRRADIANCE";
    case PROP_RADIOMETRIC_RADIOSITY:
      return "PROP_RADIOMETRIC_RADIOSITY";
    case PROP_RADIOMETRIC_RADIANCE:
      return "PROP_RADIOMETRIC_RADIANCE";
    case PROP_PHOTOMETRIC_POWER:
      return "PROP_PHOTOMETRIC_POWER";
    case PROP_PHOTOMETRIC_INTENSITY:
      return "PROP_PHOTOMETRIC_INTENSITY";
    case PROP_PHOTOMETRIC_ILLUMINANCE:
      return "PROP_PHOTOMETRIC_ILLUMINANCE";
    case PROP_PHOTOMETRIC_LUMINOUS_EXITANCE:
      return "PROP_PHOTOMETRIC_LUMINOUS_EXITANCE";
    case PROP_PHOTOMETRIC_LUMINANCE:
      return "PROP_PHOTOMETRIC_LUMINANCE";
...
static const char *rna_property_subtype_unit(PropertySubType type)
{
  switch (RNA_SUBTYPE_UNIT(type)) {
    ...
    case PROP_UNIT_RADIOMETRIC_POWER:
      return "PROP_UNIT_RADIOMETRIC_POWER";
    case PROP_UNIT_RADIOMETRIC_INTENSITY:
      return "PROP_UNIT_RADIOMETRIC_INTENSITY";
    case PROP_UNIT_RADIOMETRIC_IRRADIANCE:
      return "PROP_UNIT_RADIOMETRIC_IRRADIANCE";
    case PROP_UNIT_RADIOMETRIC_RADIOSITY:
      return "PROP_UNIT_RADIOMETRIC_RADIOSITY";
    case PROP_UNIT_RADIOMETRIC_RADIANCE:
      return "PROP_UNIT_RADIOMETRIC_RADIANCE";
    case PROP_UNIT_PHOTOMETRIC_POWER:
      return "PROP_UNIT_PHOTOMETRIC_POWER";
    case PROP_UNIT_PHOTOMETRIC_INTENSITY:
      return "PROP_UNIT_PHOTOMETRIC_INTENSITY";
    case PROP_UNIT_PHOTOMETRIC_ILLUMINANCE:
      return "PROP_UNIT_PHOTOMETRIC_ILLUMINANCE";
    case PROP_UNIT_PHOTOMETRIC_LUMINOUS_EXITANCE:
      return "PROP_UNIT_PHOTOMETRIC_LUMINOUS_EXITANCE";
    case PROP_UNIT_PHOTOMETRIC_LUMINANCE:
      return "PROP_UNIT_PHOTOMETRIC_LUMINANCE";

...
/* ------ copied from the git repo lol ------ */


/**
 * Use with PyArg_ParseTuple's "O&" formatting.
 */
int PyC_ParseBool_RENAMED(PyObject *o, void *p)
{
...
static PyObject *M_Curve_fit_nd_curve_from_points(PyObject *self, PyObject *args)
{
	...
	if (!PyArg_ParseTuple(
	        ...
	        &error_threshold,
	        &corner_angle,
	        PyC_ParseBool_RENAMED, &is_cyclic) ||
...
PyMODINIT_FUNC PyInit_mathutils_curve_fit_nd(void)
{
	PyObject *submodule = PyModule_Create(&M_Curve_fit_nd_module_def);
	return submodule;
}

...
static PyObject *pyrna_struct_is_property_set(BPy_StructRNA *self, PyObject *args, PyObject *kw)
{
  ...
  return PyBool_FromLong(use_ghost ? RNA_property_is_set(&self->ptr.value(), prop) :
                                     RNA_property_is_set_or_remembered(&self->ptr.value(), prop));
}
...
static PyObject *pyrna_struct_is_property_set_or_remembered(BPy_StructRNA *self, PyObject *args)
{
  ...
  return PyBool_FromLong(RNA_property_is_set_or_remembered(&self->ptr.value(), prop));
}

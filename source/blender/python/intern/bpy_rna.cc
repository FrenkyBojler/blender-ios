...
static PyMethodDef pyrna_prop_collection_idprop_methods[] = {
    {"add", (PyCFunction)pyrna_prop_collection_idprop_add, METH_NOARGS, pyrna_prop_collection_idprop_add_doc},
    {"remove", (PyCFunction)pyrna_prop_collection_idprop_remove, METH_O, pyrna_prop_collection_idprop_remove_doc},
    {"clear", (PyCFunction)pyrna_prop_collection_idprop_clear, METH_NOARGS, pyrna_prop_collection_idprop_clear_doc},
    {"move", (PyCFunction)pyrna_prop_collection_idprop_move, METH_VARARGS, pyrna_prop_collection_idprop_move_doc},
    {nullptr, nullptr, 0, nullptr},
};

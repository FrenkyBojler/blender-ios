...
class RemoteLibraryLoadingStatus {
 ...
 public:
  ...
  /** Should be called when an asset file (the main .blend file or one of its dependencies) is done
   * downloading. */
  static void ping_asset_file_downloaded(const bContext &C, StringRef library_url);

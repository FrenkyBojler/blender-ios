...
void main()
{
  ...
  vec2 pixel_size = 1.0f / vec2(imageSize(output_img));
  ...
  vec4 upsampled = vec4(0.0f);
  upsampled += (4.0f / 16.0f) * texture(input_tx, coordinates);
  upsampled += (2.0f / 16.0f) * texture(input_tx, coordinates + pixel_size * vec2(-1.0f, 0.0f));
  upsampled += (2.0f / 16.0f) * texture(input_tx, coordinates + pixel_size * vec2(0.0f, 1.0f));
  upsampled += (2.0f / 16.0f) * texture(input_tx, coordinates + pixel_size * vec2(1.0f, 0.0f));
  upsampled += (2.0f / 16.0f) * texture(input_tx, coordinates + pixel_size * vec2(0.0f, -1.0f));
  upsampled += (1.0f / 16.0f) * texture(input_tx, coordinates + pixel_size * vec2(-1.0f, -1.0f));
  upsampled += (1.0f / 16.0f) * texture(input_tx, coordinates + pixel_size * vec2(-1.0f, 1.0f));
  upsampled += (1.0f / 16.0f) * texture(input_tx, coordinates + pixel_size * vec2(1.0f, -1.0f));
  upsampled += (1.0f / 16.0f) * texture(input_tx, coordinates + pixel_size * vec2(1.0f, 1.0f));

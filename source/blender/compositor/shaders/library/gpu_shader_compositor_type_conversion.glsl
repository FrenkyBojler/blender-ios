...
float float_from_float4(float4 vector, float3 luminance_coefficients)
{
  return color_to_float(vector, luminance_coefficients);
}

float float_from_float3(float3 vector)
{
  return dot(vector, float3(1.0f)) / 3.0f;
}

float3 float3_from_float4(float4 vector)
{
  return vector.rgb;
}
...
float4 float4_from_float3(float3 vector)
{

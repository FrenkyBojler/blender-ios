...
void node_compositor_store_output_float(constexpr float id, float value, out float out_value)
{
...
void node_compositor_store_output_int(constexpr float id, float value, out float out_value)
{
  store_int(floatBitsToUint(id), value);
  out_value = value;
}

void node_compositor_store_output_float3(constexpr float id, float3 value, out float3 out_value)
{
  store_float3(floatBitsToUint(id), value);
  out_value = value;
}

void node_compositor_store_output_color(constexpr float id, float4 value, out float4 out_value)
{
  store_color(floatBitsToUint(id), value);
  out_value = value;
}

void node_compositor_store_output_float4(constexpr float id, float4 value, out float4 out_value)
{
...
void node_compositor_store_output_float2(constexpr float id, float3 value, out float3 out_value)
{
...
void node_compositor_store_output_int2(constexpr float id, float3 value, out float3 out_value)
{
...
void node_compositor_store_output_bool(constexpr float id, float value, out float out_value)
{

...
SAMPLER(1, sampler2D, input_constant_part_size_tx)
SAMPLER(2, sampler2D, input_roundness_tx)
SAMPLER(3, sampler2D, input_size_boundary_tx)
SAMPLER(4, sampler2D, input_value_boundary_tx)
SAMPLER(5, sampler2D, input_aggressiveness_tx)
SAMPLER(6, sampler2D, input_ellipse_height_tx)
SAMPLER(7, sampler2D, input_ellipse_width_tx)
SAMPLER(8, sampler2D, input_inflection_midpoint_tx)
SAMPLER(9, sampler2D, input_rotation_tx)
SAMPLER(10, sampler2D, input_translation_tx)

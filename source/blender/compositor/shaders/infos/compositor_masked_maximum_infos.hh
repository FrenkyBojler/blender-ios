...
SAMPLER(1, sampler2D, input_mask_size_tx)
SAMPLER(2, sampler2D, input_mask_roundness_tx)
SAMPLER(3, sampler2D, input_rotation_tx)
SAMPLER(4, sampler2D, input_translation_tx)
SAMPLER(5, sampler2D, input_hardness_tx)
SAMPLER(6, sampler2D, input_value_boundary_tx)

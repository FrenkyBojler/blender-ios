...
SAMPLER(2, sampler2D, input_rotation_tx)
SAMPLER(3, sampler2D, input_translation_tx)
SAMPLER(4, sampler2D, input_roundness_tx)
SAMPLER(5, sampler2D, input_falloff_tx)

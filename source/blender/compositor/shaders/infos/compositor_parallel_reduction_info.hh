...
COMPUTE_FUNCTION("compositor_sum_log_luminance")
ADDITIONAL_INFO(compositor_sum_float_shared)
ADDITIONAL_INFO(compositor_luminance_shared)
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()
...
COMPUTE_FUNCTION("compositor_sum_color")
ADDITIONAL_INFO(compositor_parallel_reduction_shared)
...
COMPUTE_FUNCTION("compositor_sum_red_squared_difference")
...
COMPUTE_FUNCTION("compositor_sum_green_squared_difference")
ADDITIONAL_INFO(compositor_sum_squared_difference_float_shared)
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()

GPU_SHADER_CREATE_INFO(compositor_sum_blue_squared_difference)
COMPUTE_FUNCTION("compositor_sum_blue_squared_difference")
ADDITIONAL_INFO(compositor_sum_squared_difference_float_shared)
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()

GPU_SHADER_CREATE_INFO(compositor_sum_luminance_squared_difference)
COMPUTE_FUNCTION("compositor_sum_luminance_squared_difference")
ADDITIONAL_INFO(compositor_sum_squared_difference_float_shared)
ADDITIONAL_INFO(compositor_luminance_shared)
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()
...
COMPUTE_FUNCTION("compositor_maximum_luminance")
ADDITIONAL_INFO(compositor_parallel_reduction_shared)
IMAGE(0, SFLOAT_32, write, image2D, output_img)
ADDITIONAL_INFO(compositor_luminance_shared)
GROUP_SHARED(float, reduction_data[gl_WorkGroupSize.x * gl_WorkGroupSize.y])
...
COMPUTE_FUNCTION("compositor_maximum_brightness")
ADDITIONAL_INFO(compositor_parallel_reduction_shared)
IMAGE(0, SFLOAT_32, write, image2D, output_img)
GROUP_SHARED(float, reduction_data[gl_WorkGroupSize.x * gl_WorkGroupSize.y])
DO_STATIC_COMPILATION()
...
COMPUTE_FUNCTION("compositor_maximum_float")
ADDITIONAL_INFO(compositor_parallel_reduction_shared)
IMAGE(0, SFLOAT_32, write, image2D, output_img)
GROUP_SHARED(float, reduction_data[gl_WorkGroupSize.x * gl_WorkGroupSize.y])
DO_STATIC_COMPILATION()
...
COMPUTE_FUNCTION("compositor_maximum_float2")
ADDITIONAL_INFO(compositor_parallel_reduction_shared)
...
COMPUTE_FUNCTION("compositor_maximum_float_in_range")
ADDITIONAL_INFO(compositor_parallel_reduction_shared)
IMAGE(0, SFLOAT_32, write, image2D, output_img)
...
COMPUTE_FUNCTION("compositor_minimum_luminance")
ADDITIONAL_INFO(compositor_parallel_reduction_shared)
IMAGE(0, SFLOAT_32, write, image2D, output_img)
ADDITIONAL_INFO(compositor_luminance_shared)
GROUP_SHARED(float, reduction_data[gl_WorkGroupSize.x * gl_WorkGroupSize.y])
...
COMPUTE_FUNCTION("compositor_minimum_float")
ADDITIONAL_INFO(compositor_parallel_reduction_shared)
IMAGE(0, SFLOAT_32, write, image2D, output_img)
GROUP_SHARED(float, reduction_data[gl_WorkGroupSize.x * gl_WorkGroupSize.y])
DO_STATIC_COMPILATION()
...
COMPUTE_FUNCTION("compositor_minimum_float_in_range")
ADDITIONAL_INFO(compositor_parallel_reduction_shared)
IMAGE(0, SFLOAT_32, write, image2D, output_img)
PUSH_CONSTANT(float, lower_bound)
PUSH_CONSTANT(float, upper_bound)
...
COMPUTE_FUNCTION("compositor_max_velocity")

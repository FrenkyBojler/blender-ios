...
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, write, image2D, combined_ghost_img)
...
IMAGE(
    0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read_write, image2D, accumulated_ghost_img)
...
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read_write, image2D, horizontal_img)
...
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read_write, image2D, vertical_img)
...
PUSH_CONSTANT(int, iterations)
PUSH_CONSTANT(float, fade_factor)
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read_write, image2D, diagonal_img)
...
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read_write, image2D, anti_diagonal_img)
...
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, write, image2D, output_streak_img)
...
LOCAL_GROUP_SIZE(16, 16)
SAMPLER(0, sampler2D, input_tx)
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, read_write, image2D, output_img)

...
IMAGE(0, blender::gpu::TextureFormat::SINT_16_16, write, iimage2D, boundary_img)
...
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16_16_16, write, image2D, filled_region_img)
IMAGE(1, blender::gpu::TextureFormat::SFLOAT_16, write, image2D, distance_to_boundary_img)
IMAGE(2, blender::gpu::TextureFormat::SFLOAT_16, write, image2D, smoothing_radius_img)

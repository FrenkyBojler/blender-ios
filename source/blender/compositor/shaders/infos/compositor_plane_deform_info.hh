...
GPU_SHADER_CREATE_INFO(compositor_plane_deform_fast)
ADDITIONAL_INFO(compositor_plane_deform)
COMPUTE_SOURCE("compositor_plane_deform_fast.glsl")
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()

GPU_SHADER_CREATE_INFO(compositor_plane_deform_box)
ADDITIONAL_INFO(compositor_plane_deform)
...
GPU_SHADER_CREATE_INFO(compositor_plane_deform_box_masked)
ADDITIONAL_INFO(compositor_plane_deform_masked)
DEFINE_VALUE("SAMPLER_BOX", "1")
COMPUTE_SOURCE("compositor_plane_deform.glsl")
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()

GPU_SHADER_CREATE_INFO(compositor_plane_deform_bspline)
ADDITIONAL_INFO(compositor_plane_deform)
...
GPU_SHADER_CREATE_INFO(compositor_plane_deform_bspline_masked)
ADDITIONAL_INFO(compositor_plane_deform_masked)
DEFINE_VALUE("SAMPLER_BSPLINE", "1")
COMPUTE_SOURCE("compositor_plane_deform.glsl")
DO_STATIC_COMPILATION()

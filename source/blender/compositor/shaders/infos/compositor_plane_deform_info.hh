...
GPU_SHADER_CREATE_INFO(compositor_plane_deform_variable_shared)
LOCAL_GROUP_SIZE(16, 16)
PUSH_CONSTANT(MAT4, homography_matrix)
...
ADDITIONAL_INFO(compositor_plane_deform_variable_shared)
DEFINE_VALUE("SAMPLER_FUNCTION", "texture_bicubic")
COMPUTE_SOURCE("compositor_plane_deform_variable.glsl")
DO_STATIC_COMPILATION()
GPU_SHADER_CREATE_END()

...
IMAGE(0, blender::gpu::TextureFormat::SINT_16, write, iimage2D, output_img)
...
ADDITIONAL_INFO(compositor_convert_float_shared)
IMAGE(0, blender::gpu::TextureFormat::SINT_16_16, write, iimage2D, output_img)
...
ADDITIONAL_INFO(compositor_convert_float_shared)
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16_16, write, image2D, output_img)
...
ADDITIONAL_INFO(compositor_convert_float_shared)
IMAGE(0, blender::gpu::TextureFormat::SINT_8, write, iimage2D, output_img)
...
ADDITIONAL_INFO(compositor_convert_int_shared)
IMAGE(0, blender::gpu::TextureFormat::SFLOAT_16, write, image2D, output_img)

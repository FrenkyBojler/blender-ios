...
#define float_from_float2(v) v.r

#define float2_from_float4(v) float2(((v.r + v.g + v.b) * (1.0f / 3.0f)), v.a)
#define float2_from_float3(v) float2(((v.r + v.g + v.b) * (1.0f / 3.0f)), 1.0f)
#define float2_from_float(v) float2(v)

#define float3_from_float4(v) v.rgb
#define float3_from_float2(v) v.rrr
#define float3_from_float(v) float3(v)

#define float4_from_float3(v) float4(v, 1.0f)
#define float4_from_float2(v) v.rrrg

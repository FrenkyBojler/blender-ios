...
void node_displacement_object(float height, float midlevel, float scale, float3 N, out float3 result)
{
  float3 lN;
...
void node_displacement_world(float height, float midlevel, float scale, float3 N, out float3 result)
{

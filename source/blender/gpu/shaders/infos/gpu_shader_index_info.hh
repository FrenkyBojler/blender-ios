...
GPU_SHADER_CREATE_INFO(gpu_shader_index_curve_segment_points)
TYPEDEF_SOURCE("GPU_shader_shared.hh")
LOCAL_GROUP_SIZE(16, 16, 1)
PUSH_CONSTANT(INT, elements_per_curve)
PUSH_CONSTANT(INT, segments_num)
STORAGE_BUF(0, READ, CurveSegment, segments[])
STORAGE_BUF(1, WRITE, uint, out_indices[])
COMPUTE_SOURCE("gpu_shader_index_curve_segment_points.glsl")

...
#define SNORM_8_8_8_(impl)              impl(/*TODO*/,  1 * 3,  3,    SNORM_8_8_8,         R8G8B8_SNORM,         RGB8Snorm,        Char3Normalized,     RGB8_SNORM,     rgb8_snorm)
...
#define SNORM_16_16_16_(impl)           impl(/*TODO*/,  2 * 3,  3,    SNORM_16_16_16,      R16G16B16_SNORM,      RGB16Snorm,       Short3Normalized,    RGB16_SNORM,    rgb16_snorm)
...
#define UNORM_8_8_8_(impl)              impl(/*TODO*/,  1 * 3,  3,    UNORM_8_8_8,         R8G8B8_UNORM,         RGB8Unorm,        UChar3Normalized,    RGB8,           rgb8_unorm)
...
#define UNORM_16_16_16_(impl)           impl(/*TODO*/,  2 * 3,  3,    UNORM_16_16_16,      R16G16B16_UNORM,      RGB16Unorm,       UShort3Normalized,   RGB16,          rgb16_unorm)
...
#define SINT_8_8_8_(impl)               impl(char3,     1 * 3,  3,    SINT_8_8_8,          R8G8B8_SINT,          RGB8Sint,         Char3,               RGB8I,          rgb8_sint)
...
#define SINT_16_16_16_(impl)            impl(short3,    2 * 3,  3,    SINT_16_16_16,       R16G16B16_SINT,       RGB16Sint,        Short3,              RGB16I,         rgb16_sint)
...
#define SINT_32_32_32_(impl)            impl(int3,      4 * 3,  3,    SINT_32_32_32,       R32G32B32_SINT,       RGB32Sint,        Int3,                RGB32I,         rgb32_sint)
...
#define UINT_8_8_8_(impl)               impl(uhar3,     1 * 3,  3,    UINT_8_8_8,          R8G8B8_UINT,          RGB8Uint,         UChar3,              RGB8U,          rgb8_uint)
...
#define UINT_16_16_16_(impl)            impl(ushort3,   2 * 3,  3,    UINT_16_16_16,       R16G16B16_UINT,       RGB16Uint,        UShort3,             RGB16U,         rgb16_uint)
...
#define UINT_32_32_32_(impl)            impl(uint3,     4 * 3,  3,    UINT_32_32_32,       R32G32B32_UINT,       RGB32Uint,        UInt3,               RGB32U,         rgb32_uint)
...
#define SFLOAT_16_16_16_(impl)          impl(/*TODO*/,  2 * 3,  3,    SFLOAT_16_16_16,     R16G16B16_SFLOAT,     RGB16Float,       Half3,               RGB16F,         rgb16_sfloat)
...
#define SFLOAT_32_32_32_(impl)          impl(float3,    4 * 3,  3,    SFLOAT_32_32_32,     R32G32B32_SFLOAT,     RGB32Float,       Float3,              RGB32F,         rgb32_sfloat)

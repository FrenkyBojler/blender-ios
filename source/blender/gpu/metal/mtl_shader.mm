...
{
  MTLShader *shader = static_cast<MTLShader *>(compile(shader_info, true));
...
{
  MTLShader *shader = specialization->shader;
  ...
  Vector<Shader::Constants::Value> specialization_values(shader->insterface->contant_len_);

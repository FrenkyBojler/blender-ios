...
static const char *builtin_shader_create_info_name(eGPUBuiltinShader shader)
{
  switch (shader) {
    ...
    case GPU_SHADER_3D_POINTS_FLAT_COLOR:
      return "gpu_shader_3D_points_flat_color";
    case GPU_SHADER_3D_POINTS_UNIFORM_COLOR:
      return "gpu_shader_3D_points_smooth_color";

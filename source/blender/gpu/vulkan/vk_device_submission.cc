...
{
  CLOG_TRACE(LOG_GPU_VULKAN, "Submission runner has started");
  ...
  CLOG_TRACE(LOG_GPU_VULKAN, "Submission runner initialized");
  ...
  CLOG_TRACE(LOG_GPU_VULKAN, "Submission runner is being canceled");
  ...
  CLOG_TRACE(LOG_GPU_VULKAN, "Submission runner finished");
}

void VKDevice::init_submission_pool()
{
  CLOG_TRACE(LOG_GPU_VULKAN, "Create submission pool");
...
{
  CLOG_TRACE(LOG_GPU_VULKAN, "cancelling submission pool");
  BLI_task_pool_cancel(submission_pool_);
  CLOG_TRACE(LOG_GPU_VULKAN, "waiting for completion");
  BLI_task_pool_work_and_wait(submission_pool_);
  CLOG_TRACE(LOG_GPU_VULKAN, "freeing submission pool");

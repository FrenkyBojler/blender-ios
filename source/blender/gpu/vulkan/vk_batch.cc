...
void VKBatch::draw(int vertex_first, int vertex_count, int instance_first, int instance_count)
{
  ...
  if (draw_indexed) {
    ...
    context.active_framebuffer_get()->vk_viewports_append(
        draw_indexed.node_data.pipeline_data.viewport_data.viewports);
    context.active_framebuffer_get()->vk_render_areas_append(
        draw_indexed.node_data.pipeline_data.viewport_data.scissors);
    ...
    context.active_framebuffer_get()->vk_viewports_append(
        draw.node_data.pipeline_data.viewport_data.viewports);
    context.active_framebuffer_get()->vk_render_areas_append(
        draw.node_data.pipeline_data.viewport_data.scissors);
                                  ...
                                  const intptr_t stride)
{
  ...
  if (draw_indexed) {
    ...
    context.active_framebuffer_get()->vk_viewports_append(
        draw_indexed_indirect.node_data.pipeline_data.viewport_data.viewports);
    context.active_framebuffer_get()->vk_render_areas_append(
        draw_indexed_indirect.node_data.pipeline_data.viewport_data.scissors);

 ...
 */
class VKResetEventNode : public VKNodeInfo<VKNodeType::RESET_EVENT,
                                           VKResetEventData,
                                           VKResetEventData,
 ...
 public:
  ...
  {
    command_buffer.reset_event(data.vk_event);
  }
};
}  // namespace blender::gpu::render_graph

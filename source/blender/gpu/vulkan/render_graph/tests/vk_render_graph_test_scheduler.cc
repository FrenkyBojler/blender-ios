...
TEST_P(VKRenderGraphTestScheduler, begin_draw_copy_framebuffer_draw_end)
{
...

  {
    ...
    draw.node_data.pipeline_data.pipeline_data.push_constants_data = nullptr;
    draw.node_data.pipeline_data.pipeline_data.push_constants_size = 0;
    draw.node_data.pipeline_data.pipeline_data.vk_descriptor_set = VK_NULL_HANDLE;
    draw.node_data.pipeline_data.pipeline_data.vk_pipeline = pipeline_combine;
    draw.node_data.pipeline_data.pipeline_data.vk_pipeline_layout = pipeline_layout_combine;
    draw.node_data.pipeline_data.viewport_data.viewports.append(VkViewport{});
    draw.node_data.pipeline_data.viewport_data.scissors.append(VkRect2D{});
...

  {
    ...
    draw.node_data.pipeline_data.pipeline_data.push_constants_size = 0;
    draw.node_data.pipeline_data.pipeline_data.vk_descriptor_set = VK_NULL_HANDLE;
    draw.node_data.pipeline_data.pipeline_data.vk_pipeline = pipeline_background;
    draw.node_data.pipeline_data.pipeline_data.vk_pipeline_layout = pipeline_layout_background;
    draw.node_data.pipeline_data.viewport_data.viewports.append(VkViewport{});
    draw.node_data.pipeline_data.viewport_data.scissors.append(VkRect2D{});
    render_graph->add_node(draw);
  }
...
TEST_P(VKRenderGraphTestScheduler, begin_update_draw_update_draw_update_draw_end)
{
...

  {
    ...
    draw.node_data.pipeline_data.pipeline_data.push_constants_size = 0;
    draw.node_data.pipeline_data.pipeline_data.vk_descriptor_set = VK_NULL_HANDLE;
    draw.node_data.pipeline_data.pipeline_data.vk_pipeline = pipeline;
    draw.node_data.pipeline_data.pipeline_data.vk_pipeline_layout = pipeline_layout;
    draw.node_data.pipeline_data.viewport_data.viewports.append(VkViewport{});
    draw.node_data.pipeline_data.viewport_data.scissors.append(VkRect2D{});
    render_graph->add_node(draw);
  }

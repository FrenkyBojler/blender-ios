...
class vk_render_graph_test_transfer : public vk_render_graph {};

/**
 * Fill a single buffer and read it back.
 */
TEST_F(vk_render_graph_test_transfer, fill_and_read_back)
{
 ...
 */
TEST_F(vk_render_graph_test_transfer, fill_transfer_and_read_back)
{
  VkHandle<VkBuffer> buffer(1u);
 ...
 */
TEST_F(vk_render_graph_test_transfer, fill_fill_read_back)
{
  VkHandle<VkBuffer> buffer(1u);
 ...
 * Fill a single buffer, copy it to a staging buffer and read the staging buffer back.
 */
TEST_F(vk_render_graph_test_transfer, clear_clear_copy_and_read_back)
{
 ...
 */
TEST_F(vk_render_graph_test_transfer, clear_blit_copy_and_read_back)
{
  VkHandle<VkImage> src_image(1u);
  VkHandle<VkImage> dst_image(2u);
  VkHandle<VkBuffer> staging_buffer(3u);

...
#undef ADD_NODE
   ...
   */
  VKTimelineSemaphoreWaitInfo submit_for_present(VkImage vk_swapchain_image,
                                                 VkSemaphore vk_binary_semaphore);

  /**
   * Submit full graph.
   */
  void submit(bool sync);
  ...
  void wait_synchronization_event(VKTimelineSemaphoreWaitInfo wait_info);
  /**

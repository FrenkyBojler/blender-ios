...
class Preprocessor {
 ...
 private:
                                   ...
                                   report_callback &report_error)
  {
     ...
     * \code{.glsl}
     * #define eMyEnum uint
     * static constexpr uint ENUM_1 = 0u;
     * static constexpr uint ENUM_2 = 1u;
     * static constexpr uint ENUM_3 = 2u;
     *
     * \endcode
     *
    ...
    auto process_enum =
        [&](Token enum_tok, Token class_tok, Token enum_name, Token enum_type, Scope enum_scope) {
          string type_str = enum_type.str_no_whitespace();
          ...
          parser.insert_after(insert_at + 1,
                              "#define " + enum_name.str_no_whitespace() + " " +
                                  enum_type.str_no_whitespace() + "\n");

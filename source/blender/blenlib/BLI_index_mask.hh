...
class IndexMask : private IndexMaskData {
 public:
   ...
   */
  void foreach_segment(ForeachSegmentFn auto &&fn) const;
  void foreach_segment(GrainSize grain_size, ForeachSegmentFn auto &&fn) const;
   ...
   */
  void foreach_segment_optimized(ForeachSegmentOrRangePosFn auto &&fn) const;
  void foreach_segment_optimized(GrainSize grain_size, ForeachSegmentOrRangePosFn auto &&fn) const;
...
template<ForeachSegmentOrRangePosFn Fn>
inline void IndexMask::foreach_segment_optimized(Fn &&fn) const
{
  this->foreach_segment(
...
template<ForeachSegmentFn Fn> inline void IndexMask::foreach_segment(Fn &&fn) const
{

...
static const Map<uint32_t, OrderWeight> &weights = *([]() {
  return new Map<uint32_t, OrderWeight>{
      {0x0021, {0, 0}},  /* Exclamation mark ignored. */
      {0x0022, {0, 1}},  /* Double quotation mark ignored. */
      {0x0027, {0, 2}},  /* Apostrophe ignored. */
      {0x0028, {0, 3}},  /* Open parenthesis ignored. */
      {0x0029, {0, 4}},  /* Close parenthesis ignored. */
      {0x002C, {0, 5}},  /* Comma ignored. */
      {0x002E, {0, 6}},  /* Period (full stop) ignored. */
      {0x003A, {0, 7}},  /* Colon ignored. */
      {0x003B, {0, 8}},  /* Semi-colon ignored. */
      {0x003C, {0, 9}},  /* Open angle bracket ignored. */
      {0x003E, {0, 10}}, /* Close angle bracket ignored. */
      {0x003F, {0, 11}}, /* Question mark ignored. */
      {0x005B, {0, 12}}, /* Open square brackets ignored. */
      {0x005D, {0, 13}}, /* Close square brackets ignored. */
      {0x007B, {0, 14}}, /* Left curly bracket ignored. */
      {0x007D, {0, 15}}, /* Right curly bracket ignored. */
      {0x00A1, {0, 16}}, /* Inverted exclamation mark ignored. */
      {0x00AB, {0, 17}}, /* Open double-angle bracket ignored. */
      {0x00BF, {0, 18}}, /* Inverted question mark ignored. */
      {0x2018, {0, 19}}, /* Left single quotation mark ignored. */
      {0x2019, {0, 20}}, /* Right single quotation mark ignored. */
      {0x201A, {0, 21}}, /* Single low-9 quotation mark ignored. */
      {0x201B, {0, 22}}, /* Single high reversed 9 quotation mark ignored. */
      {0x201C, {0, 23}}, /* Left double quotation mark ignored. */
      {0x201D, {0, 24}}, /* Right double quotation mark ignored. */
      {0x201E, {0, 25}}, /* Double low 9 quotation mark ignored. */
      {0x2039, {0, 26}}, /* Left single angle quotation mark ignored. */
      {0x203A, {0, 27}}, /* right single angle quotation mark ignored. */
      {0xFE50, {0, 28}}, /* Small Form Variant Comma ignored. */
      {0xFE52, {0, 29}}, /* Small Form Variant Period ignored. */
      {0xFE54, {0, 30}}, /* Small Form Variant Semi-colon ignored. */
      {0xFE55, {0, 31}}, /* Small Form Variant colon ignored. */
      {0xFE56, {0, 32}}, /* Small Form Variant question mark ignored. */
      {0xFE57, {0, 33}}, /* Small Form Variant exclamation mark ignored. */
      {0xFF01, {0, 34}}, /* Half width exclamation mark ignored. */
      {0xFF02, {0, 35}}, /* Half width Double quotation mark ignored. */
      {0xFF07, {0, 36}}, /* Half width Apostrophe ignored. */
      {0xFF08, {0, 37}}, /* Half width Open parenthesis ignored. */
      {0xFF09, {0, 38}}, /* Half width Close parenthesis ignored. */
      {0xFF0C, {0, 39}}, /* Half width comma ignored. */
      {0xFF0E, {0, 40}}, /* Half width period ignored. */

      {0x0020, {U' ', 0}},  /* Space. */
      {0x002D, {U' ', 1}},  /* Hyphen treated as space. */
      {0x2002, {U' ', 2}},  /* Space En. */
      {0x2003, {U' ', 3}},  /* Space Em. */
      {0x2004, {U' ', 4}},  /* Space Thick. */
      {0x2005, {U' ', 5}},  /* Space Mid. */
      {0x2006, {U' ', 6}},  /* Space Tiny. */
      {0x2007, {U' ', 7}},  /* Space Figure. */
      {0x2008, {U' ', 8}},  /* Space Puncuation. */
      {0x2009, {U' ', 9}},  /* Space Thin. */
      {0x200A, {U' ', 10}}, /* Space Hair. */
      {0x2010, {U' ', 11}}, /* Hyphen treated as space. */
      {0x2011, {U' ', 12}}, /* Hyphen treated as space. */
      {0x2012, {U' ', 13}}, /* Hyphen treated as space. */
      {0x2013, {U' ', 14}}, /* En Dash treated as space. */
      {0x2014, {U' ', 15}}, /* Em Dash treated as space. */
      {0x2015, {U' ', 16}}, /* Horizontal Bar treated as space. */
      {0x205F, {U' ', 17}}, /* Space Math. */
      {0x2212, {U' ', 18}}, /* Minus Sign treated as space. */
      {0x3000, {U' ', 19}}, /* Space Ideographic. */

      {0x0023, {U'#', 0}}, /* Number sign. */
      {0xFE5F, {U'#', 1}}, /* Small Form Variant Number sign. */
      {0x002A, {U'*', 0}}, /* Asterisk sign. */
      {0xFE61, {U'*', 1}}, /* Small Form Variant asterisk. */
      {0xFF0A, {U'*', 2}}, /* Half width asterisk. */
      {0x002B, {U'+', 0}}, /* Plus sign. */
      {0xFF0B, {U'+', 1}}, /* Half width Plus sign. */
      ...
      {0x007C, {U'|', 0}},  /* Vertical bar sign. */
      {0x007E, {U'~', 0}},  /* Tilde sign. */

      {0x0024, {U'$', 0}},  /* Dollar sign. */
      {0x00A2, {U'$', 1}},  /* Cent. */
      {0x00A3, {U'$', 2}},  /* Pound Sign. */
      {0x00A4, {U'$', 3}},  /* Currency Sign. */
      {0x00A5, {U'$', 4}},  /* Yen Sign. */
      {0x00A9, {U'$', 5}},  /* Copyright Sign. */
      {0x00AE, {U'$', 6}},  /* Registered Sign. */
      {0x2030, {U'$', 7}},  /* Per-mille Sign. */
      {0x20A3, {U'$', 8}},  /* French Franc Sign. */
      {0x20A4, {U'$', 9}},  /* Lira Sign. */
      {0x20A7, {U'$', 10}}, /* Peseta Sign. */
      {0x2105, {U'$', 11}}, /* Care of Sign. */

      {0x0030, {U'0', 0}}, /* Digit 0. */
      {0xFF10, {U'0', 1}}, /* Full width digit 0. */
      {0x0031, {U'1', 0}}, /* Digit 1. */
      {0x00B9, {U'1', 1}}, /* Digit Superscript 1. */
      {0x00BC, {U'1', 2}}, /* 1/4 fraction. */
      {0x00BD, {U'1', 3}}, /* 1/2 fraction. */
      {0x215B, {U'1', 4}}, /* 1/8 fraction. */
      {0xFF11, {U'1', 5}}, /* Half width digit 1. */
      {0x0032, {U'2', 0}}, /* Digit 2. */
      {0x00B2, {U'2', 1}}, /* Digit Superscript 2. */
      {0xFF12, {U'2', 2}}, /* Half width digit 2. */
      {0x0033, {U'3', 0}}, /* Digit 3. */
      {0x00B3, {U'3', 1}}, /* Digit Superscript 3. */
      {0x00BE, {U'3', 2}}, /* 3/4 fraction. */
      {0x215C, {U'3', 3}}, /* 3/8 fraction. */
      {0xFF13, {U'3', 4}}, /* Half width digit 3. */
      {0x0034, {U'4', 0}}, /* Digit 4. */
      {0xFF14, {U'4', 1}}, /* Half width digit 4. */
      {0x0035, {U'5', 0}}, /* Digit 5. */
      {0x215D, {U'5', 1}}, /* 5/8 fraction. */
      {0xFF15, {U'5', 2}}, /* Half width digit 5. */
      {0x0036, {U'6', 0}}, /* Digit 6. */
      {0xFF16, {U'6', 1}}, /* Half width digit 6. */
      {0x0037, {U'7', 0}}, /* Digit 7. */
      {0x215E, {U'7', 1}}, /* 7/8 fraction */
      {0xFF17, {U'7', 2}}, /* Half width digit 7. */
      {0x0038, {U'8', 0}}, /* Digit 8. */
      {0xFF18, {U'8', 1}}, /* Half width digit 8. */
      {0x0039, {U'9', 0}}, /* Digit 9. */
      {0xFF19, {U'9', 1}}, /* Half width digit 9. */

      {0x0041, {U'a', 0, true}},   /* Capital Letter A. */
      {0x0061, {U'a', 0, false}},  /* Small Letter a. */
      {0x00C0, {U'a', 1, true}},   /* Capital Letter A Grave. */
      ...
      {0x00E2, {U'a', 5, false}},  /* Small Letter a Circumflex. */
      {0x00C3, {U'a', 6, true}},   /* Capital Letter A Tilde. */
      {0x00E3, {U'a', 6, false}},  /* Small Letter a Tilde. */
      ...
      {0x01DF, {U'a', 13, false}}, /* Small Letter a Diaeresis Macron. */
      {0x01E0, {U'a', 14, true}},  /* Capital Letter A Dot Above Macron. */
      {0x01E1, {U'a', 14, false}}, /* Small Letter a Dot Above Macron. */
      ...
      {0xFF22, {U'b', 1, true}},  /* Half width Capital Letter B. */
      {0xFF42, {U'b', 1, false}}, /* Half width Small Letter B. */

      {0x0043, {U'c', 0, true}},  /* Capital Letter C. */
      {0x0063, {U'c', 0, false}}, /* Small Letter c. */
      {0x00C7, {U'c', 1, true}},  /* Capital Letter C with Cedilla. */
      {0x00E7, {U'c', 1, false}}, /* Small Letter c with Cedilla. */
      {0x0106, {U'c', 2, true}},  /* Capital Letter C with Acute. */
      {0x0107, {U'c', 2, false}}, /* Small Letter c with Acute. */
      {0x0108, {U'c', 3, true}},  /* Capital Letter C with Circumflex. */
      {0x0109, {U'c', 3, false}}, /* Small Letter c with Circumflex. */
      {0x010A, {U'c', 4, true}},  /* Capital Letter C with Dot Above. */
      {0x010B, {U'c', 4, false}}, /* Small Letter c with Dot Above. */
      {0x010C, {U'c', 5, true}},  /* Capital Letter C with Caron. */
      {0x010D, {U'c', 5, false}}, /* Small Letter c with Caron. */
      {0xFF23, {U'c', 6, true}},  /* Half width Capital Letter C. */
      {0xFF43, {U'c', 6, false}}, /* Half width Small Letter C. */

      {0x0044, {U'd', 0, true}},  /* Capital Letter D. */
      {0x0064, {U'd', 0, false}}, /* Small Letter d. */
      {0x00D0, {U'd', 1, true}},  /* Capital Letter Eth. */
      {0x00F0, {U'd', 1, false}}, /* Small Letter Eth. */
      {0x010E, {U'd', 2, true}},  /* Capital Letter D with Caron. */
      {0x010F, {U'd', 3, false}}, /* Small Letter d with Caron. */
      ...
      {0x0192, {U'f', 1, false}}, /* Small Letter f with Hook. */
      {0xFB01, {U'f', 2, false}}, /* Small Ligature fi. */
      {0xFB02, {U'f', 3, false}}, /* Small Ligature fl. */
      {0xFF26, {U'f', 4, true}},  /* Half width Capital Letter F. */
      {0xFF46, {U'f', 4, false}}, /* Half width Small Letter F. */

      {0x0047, {U'g', 0, true}},  /* Capital Letter G. */
      {0x0067, {U'g', 0, false}}, /* Small Letter g. */
      {0x011C, {U'g', 1, true}},  /* Capital Letter G with Circumflex. */
      {0x011D, {U'g', 1, false}}, /* Small Letter g with Circumflex. */
      {0x011E, {U'g', 2, true}},  /* Capital Letter G with Breve. */
      {0x011F, {U'g', 2, false}}, /* Small Letter g with Breve. */
      {0x0120, {U'g', 3, true}},  /* Capital Letter G with Dot Above. */
      {0x0121, {U'g', 3, false}}, /* Small Letter g with Dot Above. */
      {0x0122, {U'g', 4, true}},  /* Capital Letter G with Cedilla. */
      {0x0123, {U'g', 4, false}}, /* Small Letter g with Cedilla. */
      {0x01E4, {U'g', 5, true}},  /* Capital Letter G with Stroke. */
      {0x01E5, {U'g', 5, false}}, /* Small Letter g with Stroke. */
      {0x01E6, {U'g', 6, true}},  /* Capital Letter G with Caron. */
      {0x01E7, {U'g', 6, false}}, /* Small Letter g with Caron. */
      ...
      {0x0126, {U'h', 2, true}},  /* Capital Letter H with Stroke. */
      {0x0127, {U'h', 2, false}}, /* Small Letter h with Stroke. */
      {0x021E, {U'h', 3, true}},  /* Capital Letter H with Caron. */
      {0x021F, {U'h', 3, false}}, /* Small Letter h with Caron. */
      ...
      {0x012B, {U'i', 6, false}},  /* Small Letter i with Macron. */
      {0x012C, {U'i', 7, true}},   /* Capital Letter I with Breve. */
      {0x012D, {U'i', 7, false}},  /* Small Letter i with Breve. */
      {0x012E, {U'i', 8, true}},   /* Capital Letter I with Ogonek. */
      {0x012F, {U'i', 8, false}},  /* Small Letter i with Ogonek. */
      {0x0130, {U'i', 9, true}},   /* Capital Letter I with Dot Above. */
      ...
      {0x0136, {U'k', 1, true}},  /* Capital Letter K with Cedilla. */
      {0x0137, {U'k', 1, false}}, /* Small Letter k with Cedilla. */
      {0x0138, {U'k', 2, false}}, /* Small Letter Kra. */
      {0x01E8, {U'k', 3, true}},  /* Capital Letter K with Caron. */
      {0x01E9, {U'k', 3, false}}, /* Small Letter k with Caron. */
      ...
      {0x013B, {U'l', 2, true}},  /* Capital Letter L with Cedilla. */
      {0x013C, {U'l', 2, false}}, /* Small Letter l with Cedilla. */
      {0x013D, {U'l', 3, true}},  /* Capital Letter L with Caron. */
      {0x013E, {U'l', 3, false}}, /* Small Letter l with Caron. */
      {0x013F, {U'l', 4, true}},  /* Capital Letter L with Middle Dot. */
      {0x0140, {U'l', 4, false}}, /* Small Letter l with Middle Dot. */
      {0x0141, {U'l', 5, true}},  /* Capital Letter L with Stroke. */
      {0x0142, {U'l', 5, false}}, /* Small Letter l with Stroke. */
      ...
      {0xFF2D, {U'm', 1, true}},  /* Half width Capital Letter M. */
      {0xFF4D, {U'm', 1, false}}, /* Half width Small Letter M. */

      {0x004E, {U'n', 0, true}},  /* Capital Letter N. */
      {0x006E, {U'n', 0, false}}, /* Small Letter n. */
      {0x00D1, {U'n', 1, true}},  /* Capital Letter N with Tilde. */
      {0x00F1, {U'n', 1, false}}, /* Small Letter n with Tilde. */
      {0x0143, {U'n', 2, true}},  /* Capital Letter N with Acute. */
      {0x0144, {U'n', 2, false}}, /* Small Letter n with Acute. */
      {0x0145, {U'n', 3, true}},  /* Capital Letter N with Cedilla. */
      {0x0146, {U'n', 3, false}}, /* Small Letter n with Cedilla. */
      {0x0147, {U'n', 4, true}},  /* Capital Letter N with Caron. */
      {0x0148, {U'n', 4, false}}, /* Small Letter n with Caron. */
      {0x0149, {U'n', 5, false}}, /* Small Letter n Preceded by Apostrophe. */
      {0x014A, {U'n', 6, true}},  /* Capital Letter Eng. */
      {0x014B, {U'n', 6, false}}, /* Small Letter Eng. */
      {0x2116, {U'n', 7, false}}, /* Numero Sign. */
      {0xFF2E, {U'n', 8, true}},  /* Half width Capital Letter N. */
      {0xFF4E, {U'n', 8, false}}, /* Half width Small Letter N. */
      ...
      {0x01FF, {U'o', 14, false}}, /* Small Letter o with Stroke and Acute. */
      ...
      {0xFF30, {U'p', 1, true}},  /* Half width Capital Letter P. */
      {0xFF50, {U'p', 1, false}}, /* Half width Small Letter P. */
      ...
      {0x0156, {U'r', 2, true}},  /* Capital Letter R with Cedilla. */
      {0x0157, {U'r', 2, false}}, /* Small Letter r with Cedilla. */
      {0x0158, {U'r', 3, true}},  /* Capital Letter R with Caron. */
      {0x0159, {U'r', 3, false}}, /* Small Letter r with Caron. */
      ...
      {0x00DF, {U's', 1, false}}, /* Small Letter Sharp s. */
      {0x015A, {U's', 2, true}},  /* Capital Letter S with Acute. */
      {0x015B, {U's', 2, false}}, /* Small Letter s with Acute. */
      {0x015C, {U's', 3, true}},  /* Capital Letter S with Circumflex. */
      {0x015D, {U's', 3, false}}, /* Small Letter s with Circumflex. */
      {0x015E, {U's', 4, true}},  /* Capital Letter S with Cedilla. */
      {0x015F, {U's', 4, false}}, /* Small Letter s with Cedilla. */
      {0x0160, {U's', 5, true}},  /* Capital Letter S with Caron. */
      {0x0161, {U's', 5, false}}, /* Small Letter s with Caron. */
      ...
      {0x0162, {U't', 1, true}},  /* Capital Letter T with Cedilla. */
      {0x0163, {U't', 1, false}}, /* Small Letter t with Cedilla. */
      {0x0164, {U't', 2, true}},  /* Capital Letter T with Caron. */
      {0x0165, {U't', 2, false}}, /* Small Letter t with Caron. */
      {0x0166, {U't', 3, true}},  /* Capital Letter T with Stroke. */
      {0x0167, {U't', 3, false}}, /* Small Letter t with Stroke. */
      {0x021A, {U't', 4, true}},  /* Capital Letter T with Comma Below. */
      {0x021B, {U't', 4, false}}, /* Small Letter t with Comma Below. */
      {0x2122, {U't', 5, false}}, /* Trade Mark Sign. */
      ...
      {0x016F, {U'u', 7, false}},  /* Small Letter u with Ring Above. */
      {0x0170, {U'u', 8, true}},   /* Capital Letter U with Double Acute. */
      {0x0171, {U'u', 8, false}},  /* Small Letter u with Double Acute. */
      {0x0172, {U'u', 9, true}},   /* Capital Letter U with Ogonek. */
      {0x0173, {U'u', 9, false}},  /* Small Letter u with Ogonek. */
      {0xFF35, {U'u', 10, true}},  /* Half width Capital Letter U. */
      {0xFF55, {U'u', 10, false}}, /* Half width Small Letter U. */
      ...
      {0x0174, {U'w', 1, true}},  /* Capital Letter W with Circumflex. */
      {0x0175, {U'w', 1, false}}, /* Small Letter w with Circumflex. */
      {0xFF37, {U'w', 2, true}},  /* Half width Capital Letter W. */
      {0xFF57, {U'w', 2, false}}, /* Half width Small Letter W. */
      ...
      {0x0178, {U'y', 2, true}},  /* Capital Letter Y with Diaeresis. */
      {0x00FF, {U'y', 2, false}}, /* Small Letter y with Diaeresis. */
      {0x0176, {U'y', 3, true}},  /* Capital Letter Y with Circumflex. */
      {0x0177, {U'y', 3, false}}, /* Small Letter y with Circumflex. */
      {0xFF39, {U'y', 4, true}},  /* Half width Capital Letter Y. */
      {0xFF59, {U'y', 4, false}}, /* Half width Small Letter Y. */
      ...
      {0x017B, {U'z', 2, true}},  /* Capital Letter Z with Dot Above. */
      {0x017C, {U'z', 2, false}}, /* Small Letter z with Dot Above. */
      {0x017D, {U'z', 3, true}},  /* Capital Letter Z with Caron. */
      {0x017E, {U'z', 3, false}}, /* Small Letter z with Caron. */
...
static const Map<uint32_t, Ligature> &ligatures = *([]() {
  return new Map<uint32_t, Ligature>{
      ...
      {0x0153, {U'o', U'e', 0, false}},    /* Latin small ligature OE. */
      {0x01E2, {U'a', U'e', 0, true}},     /* Latin capital letter AE with macron. */

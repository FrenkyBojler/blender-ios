...
typedef struct ParticleSpring {
  float rest_length = 0;
  unsigned int particle_index[2] = {}, delete_flag = 0;
} ParticleSpring;
...
typedef struct ParticleSettings {
  ...
  short rotfrom DNA_DEPRECATED = 0;
  short kink = 0, kink_axis = 2;

  /* billboards */
  short bb_align = 0, bb_uv_split = 1, bb_anim = 0, bb_split_offset DNA_DEPRECATED = 0;
  float bb_tilt = 0, bb_rand_tilt = 0, bb_offset[2] = {}, bb_size[2] = {1.0f, 1.0f},
        bb_vel_head = 0, bb_vel_tail DNA_DEPRECATED = 0;
  ...
  struct ListBase instance_weights = {nullptr, nullptr};
  struct Collection *force_group DNA_DEPRECATED = nullptr; /* deprecated */
...
typedef struct ParticleSystem {
  ...
  ListBase pathcachebufs = {nullptr, nullptr};
  ListBase childcachebufs = {nullptr, nullptr};
  ...
  struct ListBase targets = {nullptr, nullptr};

...
enum eCompositionGuideFlags : short {
  ...
  COMPOSITION_GUIDES_DOME_MASTER_DIRECTIONS = (1 << 8),
  COMPOSITION_GUIDES_DOME_MASTER_GRID = (1 << 9),
  COMPOSITION_GUIDES_DOME_MASTER_UNIDIRECTIONAL_SAFEAREA_FRONT = (1 << 10),
  COMPOSITION_GUIDES_DOME_MASTER_UNIDIRECTIONAL_SAFEAREA_CENTER = (1 << 11),
  COMPOSITION_GUIDES_DOME_MASTER_UNIDIRECTIONAL_SAFEAREA_BACK = (1 << 12),
  COMPOSITION_GUIDES_DOME_MASTER_UNIDIRECTIONAL_SAFEAREA_HORIZON = (1 << 13)
};

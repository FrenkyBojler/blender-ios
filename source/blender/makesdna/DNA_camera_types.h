...
/* base projection types */
enum {
  CALIBRATED_RECTILINEAR = 0,
  CALIBRATED_EQUIDISTANT = 1,
  CALIBRATED_STEREOGRAPHIC = 2,
  CALIBRATED_EQUISOLID = 3,
  CALIBRATED_FISHEYE_ORTHOGRAPHIC = 4,
};

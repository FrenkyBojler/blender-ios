...
enum eCompositionGuideFlagsFulldome : short {
  COMPOSITION_GUIDES_fulldome_DIRECTIONS = (1 << 0),
  COMPOSITION_GUIDES_fulldome_GRID = (1 << 1),
  COMPOSITION_GUIDES_fulldome_UNIDIRECTIONAL_SAFEAREA_FRONT = (1 << 2),
  COMPOSITION_GUIDES_fulldome_UNIDIRECTIONAL_SAFEAREA_CENTER = (1 << 3),
  COMPOSITION_GUIDES_fulldome_UNIDIRECTIONAL_SAFEAREA_BACK = (1 << 4),
  COMPOSITION_GUIDES_fulldome_UNIDIRECTIONAL_SAFEAREA_HORIZON = (1 << 5),
  COMPOSITION_GUIDES_fulldome_UNIDIRECTIONAL_SWEETSPOT_FRONT = (1 << 6),
  COMPOSITION_GUIDES_fulldome_UNIDIRECTIONAL_SWEETSPOT_CENTER = (1 << 7),
  COMPOSITION_GUIDES_fulldome_UNIDIRECTIONAL_SWEETSPOT_BACK = (1 << 8),
  COMPOSITION_GUIDES_fulldome_UNIDIRECTIONAL_ZENIT_FRONT = (1 << 9),
  COMPOSITION_GUIDES_fulldome_UNIDIRECTIONAL_ZENIT_CENTER = (1 << 10),
  COMPOSITION_GUIDES_fulldome_UNIDIRECTIONAL_ZENIT_BACK = (1 << 11)
};
ENUM_OPERATORS(eCompositionGuideFlagsFulldome)

...
typedef struct ThemeSpace {
  ...
  unsigned char effect[4], transition_effect[4], meta[4], text_strip[4], color_strip[4];
  unsigned char active_strip[4], selected_strip[4], text_strip_cursor[4], selected_text[4];
  unsigned char transition[4], transition_outline[4], transition_in[4], transition_out[4];

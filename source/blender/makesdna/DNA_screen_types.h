...
typedef struct bScreen {
  ...
  struct Scene *scene DNA_DEPRECATED = nullptr;
...
typedef struct uiListDyn {
  ...
  uiListFreeRuntimeDataFunc free_runtime_data_fn = 0;
  ...
  struct PointerRNA *custom_drag_opptr = nullptr;
  struct wmOperatorType *custom_activate_optype = nullptr;
  struct PointerRNA *custom_activate_opptr = nullptr;
} uiListDyn;
...
typedef struct ScrArea {
  ...
  char headertype DNA_DEPRECATED = 0;

...
typedef struct BrushGpencilSettings {
  ...
  int brush_type DNA_DEPRECATED = 0;
  /** Soft, hard or stroke. */
  int eraser_mode = 0;
...
typedef struct Brush {
  ...
  struct Brush *toggle_brush = nullptr;

  struct ImBuf *icon_imbuf = nullptr;
  ...
  /** Brush diameter. */
  int size = 35 /* radius of the brush in pixels */;
  ...
  float unprojected_radius = 0.05f; /* radius of the brush in Blender units */

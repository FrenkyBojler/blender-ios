...
enum CMPNodeCombSepColorMode : uint8_t {
  ...
  CMP_NODE_COMBSEP_COLOR_OKLAB = 3,
  CMP_NODE_COMBSEP_COLOR_OKLCH = 4,
  CMP_NODE_COMBSEP_COLOR_OKHSV = 5,
  CMP_NODE_COMBSEP_COLOR_OKHSL = 6,
  CMP_NODE_COMBSEP_COLOR_YCC = 7,
  CMP_NODE_COMBSEP_COLOR_YUV = 8,
};

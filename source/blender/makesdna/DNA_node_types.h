...
typedef enum NodeGeometryRasterizePointsItemType {
  ...
  GEO_NODE_RASTERIZE_POINTS_ITEM_TYPE_SCALAR_GRADIENT = 2,
  GEO_NODE_RASTERIZE_POINTS_ITEM_TYPE_VECTOR_DIVERGENCE = 3,
  GEO_NODE_RASTERIZE_POINTS_ITEM_TYPE_TENSOR_DIVERGENCE = 4,
  GEO_NODE_RASTERIZE_POINTS_ITEM_TYPE_AFFINE_MOMENTUM = 5,
} NodeGeometryRasterizePointsItemType;

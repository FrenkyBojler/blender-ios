...
struct Light {
  ...
  /* Type and flags. */
  short type = 0, flag = 0, unit_system = 0, photometric_unit = 0;
  ...
  float energy = 10.0f;
  float radiometric_power = 0.0f;
  float radiometric_intensity = 0.0f;
  float radiometric_irradiance = 0.0f;
  float radiometric_radiosity = 0.0f;
  float radiometric_radiance = 0.0f;
  float photometric_power = 0.0f;
  float photometric_intensity = 0.0f;
  float photometric_illuminance = 0.0f;
  float photometric_luminous_exitance = 0.0f;
  float photometric_luminance = 0.0f;
  float exposure = 0.0f;
  float efficacy = 683.0f;

...
typedef struct RegionView3D {
  ...
  float gridview DNA_DEPRECATED = 0;
...
typedef struct View3D {
  ...
  char drawtype DNA_DEPRECATED = 0;
  ...
  short persp DNA_DEPRECATED = 0;
  short view DNA_DEPRECATED = 0;
  ...
  struct bGPdata *gpd DNA_DEPRECATED = nullptr;

...
#define SCE_SNAP_ANIM_MODE_ALL (SCE_SNAP_TO_FRAME | SCE_SNAP_TO_SECOND | SCE_SNAP_TO_MARKERS)

#define SCE_SNAP_MODE_ALL \
  (SCE_SNAP_TO_POINT | SCE_SNAP_TO_EDGE_MIDPOINT | SCE_SNAP_TO_EDGE_ENDPOINT | \
   SCE_SNAP_TO_EDGE_PERPENDICULAR | SCE_SNAP_TO_EDGE | SCE_SNAP_TO_FACE | SCE_SNAP_TO_VOLUME | \
   SCE_SNAP_TO_GRID | SCE_SNAP_TO_INCREMENT)

#define SCE_SNAP_INDIVIDUAL_ALL (SCE_SNAP_INDIVIDUAL_NEAREST | SCE_SNAP_INDIVIDUAL_PROJECT)

#define SCE_SNAP_ELEMENTS_ALL (SCE_SNAP_MODE_ALL | SCE_SNAP_INDIVIDUAL_ALL)

...
struct ToolSettings {
  ...
  char _pad_snap[1] = {};
  eSnapMode snap_exclude_active_edit_mode = SCE_SNAP_TO_NONE;
  eSnapMode snap_exclude_edited_edit_mode = SCE_SNAP_TO_NONE;
  eSnapMode snap_exclude_non_edited_edit_mode = SCE_SNAP_TO_NONE;

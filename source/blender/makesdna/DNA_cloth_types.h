...
typedef struct ClothSimSettings {
  ...
  float structural DNA_DEPRECATED = 0;
  ...
  float max_struct DNA_DEPRECATED = 0;
  ...
  float vel_damping DNA_DEPRECATED = 0;
...
typedef struct ClothCollSettings {
  ...
  float repel_force DNA_DEPRECATED = 0;
  float distance_repel DNA_DEPRECATED = 0;
  ...
  short self_loop_count DNA_DEPRECATED = 0;

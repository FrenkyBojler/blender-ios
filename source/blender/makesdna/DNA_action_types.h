...
typedef struct bPoseChannel {
  ...
  char selectflag = 0;
  char drawflag = 0;
  char bboneflag DNA_DEPRECATED = 0;
  char _pad0[4] = {};
  ...
  struct ListBase iktree = {nullptr, nullptr};
  /** Spline-IK "trees" - only while evaluating pose. */
  struct ListBase siktree = {nullptr, nullptr};
  ...
  float scale_in_x DNA_DEPRECATED = 0, scale_in_z DNA_DEPRECATED = 0;
  float scale_out_x DNA_DEPRECATED = 0, scale_out_z DNA_DEPRECATED = 0;
...
typedef enum eItasc_Solver {
  ITASC_SOLVER_SDLS = 0, /* selective damped least square = 0, suitable for CopyPose constraint */
...
typedef struct bAction {
  ...
  struct ActionLayer **layer_array = nullptr; /* Array of 'layer_array_num' layers. */
  int layer_array_num = 0;
  int layer_active_index = 0; /* Index into layer_array, -1 means 'no active'. */

  struct ActionSlot **slot_array = nullptr; /* Array of 'slot_array_num` slots. */
  ...
  ListBase chanbase DNA_DEPRECATED = {nullptr, nullptr};
...
typedef struct SpaceAction {
  ...
  char autosnap DNA_DEPRECATED = 0;
...
typedef enum eSAction_Flag {
  ...
  // SACTION_NOHIDE = (1 << 3), /* Deprecated = 0, old animation systems. */
  /* don't kill overlapping keyframes after transform */
  SACTION_NOTRANSKEYCULL = (1 << 4),
  /* don't include keyframes that are out of view */
  // SACTION_HORIZOPTIMISEON = (1 << 5), /* Deprecated = 0, old irrelevant trick. */
...
typedef struct bActionChannel {
  struct bActionChannel *next = nullptr, *prev = nullptr;
  ...
  ListBase constraintChannels = {nullptr, nullptr};

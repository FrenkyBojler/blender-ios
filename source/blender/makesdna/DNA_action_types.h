...
enum eRotationModes : short {
  ...
  ROT_MODE_QUAT = 0,
  /* euler rotations - keep in sync with enum in BLI_math_rotation_capi.hh */
  /** Blender 'default' (classic) - must be as 1 to sync with BLI_math_rotation_capi.hh defines */
  ROT_MODE_EUL = 1,
  ROT_MODE_XYZ = 1,
  ROT_MODE_XZY = 2,
  ROT_MODE_YXZ = 3,

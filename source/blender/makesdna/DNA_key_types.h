...
enum KeyBlockGroupflag {
  KEY_GROUP_EXPANDED = 1,
};

struct KeyBlockGroup {
  struct KeyBlockGroup *next = nullptr, *prev = nullptr;
  ListBaseT<KeyBlock> children = {nullptr, nullptr};
  int flag = 0;
  char _pad[4] = {};
  char name[/*MAX_NAME*/ 64] = "";
};
...
struct Key {
   ...
   */
  int uidgen = 0;
  KeyBlockGroup *root_group = nullptr;
  ListBaseT<KeyBlockGroup> groups = {nullptr, nullptr};
};

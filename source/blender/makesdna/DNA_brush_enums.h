...
enum ePaintBrush_flag : int {
  ...
  BRUSH_PAINT_FLOW_PRESSURE = (1 << 1),
  BRUSH_PAINT_FLOW_PRESSURE_INVERT = (1 << 2),
  BRUSH_PAINT_WET_MIX_PRESSURE = (1 << 3),
  BRUSH_PAINT_WET_MIX_PRESSURE_INVERT = (1 << 4),
  BRUSH_PAINT_WET_PERSISTENCE_PRESSURE = (1 << 5),
  BRUSH_PAINT_WET_PERSISTENCE_PRESSURE_INVERT = (1 << 6),
  BRUSH_PAINT_DENSITY_PRESSURE = (1 << 7),
  BRUSH_PAINT_DENSITY_PRESSURE_INVERT = (1 << 8),
};

...
enum eBrushFlags2 : int {
  ...
  BRUSH_USE_UNIFIED_PAINT_SIZE = (1 << 12),
  BRUSH_USE_UNIFIED_PAINT_ALPHA = (1 << 13),
  BRUSH_USE_UNIFIED_PAINT_BRUSH_LOCK_SIZE = (1 << 14),
  BRUSH_USE_UNIFIED_PAINT_WEIGHT = (1 << 15),
  BRUSH_USE_UNIFIED_PAINT_COLOR = (1 << 16),
  BRUSH_USE_UNIFIED_PAINT_INPUT_SAMPLES = (1 << 17),
  BRUSH_USE_UNIFIED_PAINT_COLOR_JITTER = (1 << 18),
};

...
typedef struct FluidDomainSettings {
  ...
  struct GPUTexture *tex_density = nullptr;
  struct GPUTexture *tex_color = nullptr;
  struct GPUTexture *tex_wt = nullptr;
  struct GPUTexture *tex_shadow = nullptr;
  struct GPUTexture *tex_flame = nullptr;
  struct GPUTexture *tex_flame_coba = nullptr;
  struct GPUTexture *tex_coba = nullptr;
  struct GPUTexture *tex_field = nullptr;
  struct GPUTexture *tex_velocity_x = nullptr;
  struct GPUTexture *tex_velocity_y = nullptr;
  struct GPUTexture *tex_velocity_z = nullptr;
  struct GPUTexture *tex_flags = nullptr;
  struct GPUTexture *tex_range_field = nullptr;

...
#define FROM_DEFAULT_V4_UCHAR(member) copy_v4_v4_uchar(btheme->member, U_theme_default.member)
  ...
  if (!USER_VERSION_ATLEAST(502, 6)) {
    copy_v4_v4_uchar(btheme->tui.wcol_link.outline, U_theme_default.tui.wcol_link.outline);
    copy_v4_v4_uchar(btheme->tui.wcol_link.outline_sel, U_theme_default.tui.wcol_link.outline_sel);
    copy_v4_v4_uchar(btheme->tui.wcol_link.inner, U_theme_default.tui.wcol_link.inner);
    copy_v4_v4_uchar(btheme->tui.wcol_link.inner_sel, U_theme_default.tui.wcol_link.inner_sel);
    copy_v4_v4_uchar(btheme->tui.wcol_link.item, U_theme_default.tui.wcol_link.item);
    copy_v4_v4_uchar(btheme->tui.wcol_link.text, U_theme_default.tui.wcol_link.text);
    copy_v4_v4_uchar(btheme->tui.wcol_link.text_sel, U_theme_default.tui.wcol_link.text_sel);
    btheme->tui.wcol_link.shaded = U_theme_default.tui.wcol_link.shaded;
    btheme->tui.wcol_link.shadetop = U_theme_default.tui.wcol_link.shadetop;
    btheme->tui.wcol_link.shadedown = U_theme_default.tui.wcol_link.shadedown;
    btheme->tui.wcol_link.roundness = U_theme_default.tui.wcol_link.roundness;
  }

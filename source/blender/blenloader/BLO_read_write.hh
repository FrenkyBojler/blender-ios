...
#define BLO_write_struct(writer, struct_name, data_ptr) \
  BLO_write_struct_by_id(writer, blender::dna::get_sdna_type_id<struct_name>(), data_ptr)
...
#define BLO_write_struct_at_address(writer, struct_name, address, data_ptr) \
  BLO_write_struct_at_address_by_id( \
      writer, blender::dna::get_sdna_type_id<struct_name>(), address, data_ptr)
...
#define BLO_write_struct_at_address_with_filecode( \
  ...
  BLO_write_struct_at_address_by_id_with_filecode( \
      writer, filecode, blender::dna::get_sdna_type_id<struct_name>(), address, data_ptr)
...
#define BLO_write_struct_array(writer, struct_name, array_size, data_ptr) \
  BLO_write_struct_array_by_id( \
      writer, blender::dna::get_sdna_type_id<struct_name>(), array_size, data_ptr)
...
#define BLO_write_struct_array_at_address(writer, struct_name, array_size, address, data_ptr) \
  BLO_write_struct_array_at_address_by_id( \
      writer, blender::dna::get_sdna_type_id<struct_name>(), array_size, address, data_ptr)
...
#define BLO_write_struct_list(writer, struct_name, list_ptr) \
  BLO_write_struct_list_by_id(writer, blender::dna::get_sdna_type_id<struct_name>(), list_ptr)
...
#define BLO_write_id_struct(writer, struct_name, id_address, id) \
  blo_write_id_struct(writer, blender::dna::get_sdna_type_id<struct_name>(), id_address, id)

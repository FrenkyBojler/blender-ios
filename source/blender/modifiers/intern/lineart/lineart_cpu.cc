                                                ...
                                                int obindex)
{
  ...
  if (ob->type == OB_MESH) {
    ...
    if ((!use_mesh) || ((!is_render) && use_mesh->runtime->edit_mesh)) {
       ...
       * the way line art uses depsgraph.See #102612 for explanation of this workaround. However,
       * we allow loading edit mode objects into line art during render, see #135407 */
      return;
    }
  }
  else {

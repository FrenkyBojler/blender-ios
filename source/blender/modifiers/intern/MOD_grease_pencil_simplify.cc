...
{
  auto *gpmd = MEM_new<GreasePencilSimplifyModifierData>("GreasePencilSimplifyModifierData");
...
static void free_data(ModifierData *md)
{
  ...
  modifier_free_data<GreasePencilSimplifyModifierData>(md);
}
...
static void copy_data(const ModifierData *md, ModifierData *target, int flag)
{
  ...
  modifier_copy_data<GreasePencilSimplifyModifierData>(md, target, flag);

...
{
  auto *gpmd = MEM_new<GreasePencilLengthModifierData>("GreasePencilLengthModifierData");
...
static void copy_data(const ModifierData *md, ModifierData *target, int flags)
{
  ...
  modifier_copy_data<GreasePencilLengthModifierData>(md, target, flags);
...
static void free_data(ModifierData *md)
{
  ...
  modifier_free_data<GreasePencilLengthModifierData>(md);
}

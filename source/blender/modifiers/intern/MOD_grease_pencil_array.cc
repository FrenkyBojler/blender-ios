...
{
  auto *mmd = MEM_new<GreasePencilArrayModifierData>("GreasePencilArrayModifierData");
...
static void copy_data(const ModifierData *md, ModifierData *target, const int flag)
{
  ...
  modifier_copy_data<GreasePencilArrayModifierData>(md, target, flag);
...
static void free_data(ModifierData *md)
{
  ...
  modifier_free_data<GreasePencilArrayModifierData>(md);
}

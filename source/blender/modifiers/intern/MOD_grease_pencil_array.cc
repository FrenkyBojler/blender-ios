...
static void panel_draw(const bContext *C, Panel *panel)
{
  ...
  if (uiLayout *sub = uiLayoutPanelPropWithBoolHeader(
          C, layout, ptr, "open_relative_offset_panel", "use_relative_offset", IFACE_("Relative Offset")))
  {
  ...
  if (uiLayout *sub = uiLayoutPanelPropWithBoolHeader(
          C, layout, ptr, "open_constant_offset_panel", "use_constant_offset", IFACE_("Constant Offset")))
  {
    uiLayout *col = uiLayoutColumn(sub, false);
  ...
  if (uiLayout *sub = uiLayoutPanelPropWithBoolHeader(
          C, layout, ptr, "open_object_offset_panel", "use_object_offset", IFACE_("Object Offset")))
  {
    uiLayout *col = uiLayoutColumn(sub, false);

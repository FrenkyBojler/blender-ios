...
{
  auto *omd = MEM_new<GreasePencilOffsetModifierData>("GreasePencilOffsetModifierData");
...
static void copy_data(const ModifierData *md, ModifierData *target, const int flag)
{
  ...
  modifier_copy_data<GreasePencilOffsetModifierData>(md, target, flag);
...
static void free_data(ModifierData *md)
{
  ...
  modifier_free_data<GreasePencilOffsetModifierData>(md);
}
